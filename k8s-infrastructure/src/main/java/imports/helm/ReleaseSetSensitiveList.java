...
@software.amazon.jsii.Jsii(module = imports.helm.$Module.class, fqn = "hashicorp_helm.ReleaseSetSensitiveList")
public class ReleaseSetSensitiveList extends com.hashicorp.cdktf.ComplexList {

    protected ReleaseSetSensitiveList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected ReleaseSetSensitiveList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public ReleaseSetSensitiveList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.helm.ReleaseSetSensitiveOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.helm.ReleaseSetSensitiveOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.helm.ReleaseSetSensitive> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
