...
public interface CronJobSpecJobTemplateSpecTemplate extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull imports.kubernetes.CronJobSpecJobTemplateSpecTemplateMetadata getMetadata();
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.CronJobSpecJobTemplateSpecTemplateSpec getSpec() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<CronJobSpecJobTemplateSpecTemplate> {
        imports.kubernetes.CronJobSpecJobTemplateSpecTemplateMetadata metadata;
        imports.kubernetes.CronJobSpecJobTemplateSpecTemplateSpec spec;
         ...
         * @return {@code this}
         */
        public Builder metadata(imports.kubernetes.CronJobSpecJobTemplateSpecTemplateMetadata metadata) {
         ...
         * @return {@code this}
         */
        public Builder spec(imports.kubernetes.CronJobSpecJobTemplateSpecTemplateSpec spec) {
            this.spec = spec;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CronJobSpecJobTemplateSpecTemplate {
        private final imports.kubernetes.CronJobSpecJobTemplateSpecTemplateMetadata metadata;
        private final imports.kubernetes.CronJobSpecJobTemplateSpecTemplateSpec spec;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.metadata = software.amazon.jsii.Kernel.get(this, "metadata", software.amazon.jsii.NativeType.forClass(imports.kubernetes.CronJobSpecJobTemplateSpecTemplateMetadata.class));
            this.spec = software.amazon.jsii.Kernel.get(this, "spec", software.amazon.jsii.NativeType.forClass(imports.kubernetes.CronJobSpecJobTemplateSpecTemplateSpec.class));
        }
        ...
        @Override
        public final imports.kubernetes.CronJobSpecJobTemplateSpecTemplateMetadata getMetadata() {
            return this.metadata;
        }

        @Override
        public final imports.kubernetes.CronJobSpecJobTemplateSpecTemplateSpec getSpec() {
            return this.spec;
        }
