...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.RoleBindingV1SubjectOutputReference")
public class RoleBindingV1SubjectOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected RoleBindingV1SubjectOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected RoleBindingV1SubjectOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.RoleBindingV1Subject value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
