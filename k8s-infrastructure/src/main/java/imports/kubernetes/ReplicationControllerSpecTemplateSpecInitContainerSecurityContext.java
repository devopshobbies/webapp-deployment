...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:40.722Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.ReplicationControllerSpecTemplateSpecInitContainerSecurityContext")
@software.amazon.jsii.Jsii.Proxy(ReplicationControllerSpecTemplateSpecInitContainerSecurityContext.Jsii$Proxy.class)
public interface ReplicationControllerSpecTemplateSpecInitContainerSecurityContext extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerSecurityContextCapabilities getCapabilities() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerSecurityContextSeccompProfile getSeccompProfile() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerSecurityContextSeLinuxOptions getSeLinuxOptions() {
        return null;
    }

    /**
     * @return a {@link Builder} of {@link ReplicationControllerSpecTemplateSpecInitContainerSecurityContext}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ReplicationControllerSpecTemplateSpecInitContainerSecurityContext}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ReplicationControllerSpecTemplateSpecInitContainerSecurityContext> {
        java.lang.Object allowPrivilegeEscalation;
        imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerSecurityContextCapabilities capabilities;
        ...
        imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerSecurityContextSeccompProfile seccompProfile;
        imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerSecurityContextSeLinuxOptions seLinuxOptions;

        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateSpecInitContainerSecurityContext#getAllowPrivilegeEscalation}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateSpecInitContainerSecurityContext#getCapabilities}
         * @param capabilities capabilities block.
         *                     Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/replication_controller#capabilities ReplicationController#capabilities}
         * @return {@code this}
         */
        public Builder capabilities(imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerSecurityContextCapabilities capabilities) {
            this.capabilities = capabilities;
            return this;
        }

        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateSpecInitContainerSecurityContext#getPrivileged}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateSpecInitContainerSecurityContext#getReadOnlyRootFilesystem}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateSpecInitContainerSecurityContext#getRunAsGroup}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateSpecInitContainerSecurityContext#getRunAsNonRoot}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateSpecInitContainerSecurityContext#getRunAsUser}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateSpecInitContainerSecurityContext#getSeccompProfile}
         * @param seccompProfile seccomp_profile block.
         *                       Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/replication_controller#seccomp_profile ReplicationController#seccomp_profile}
         * @return {@code this}
         */
        public Builder seccompProfile(imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerSecurityContextSeccompProfile seccompProfile) {
            this.seccompProfile = seccompProfile;
            return this;
        }

        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateSpecInitContainerSecurityContext#getSeLinuxOptions}
         * @param seLinuxOptions se_linux_options block.
         *                       Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/replication_controller#se_linux_options ReplicationController#se_linux_options}
         * @return {@code this}
         */
        public Builder seLinuxOptions(imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerSecurityContextSeLinuxOptions seLinuxOptions) {
         ...
         * @return a new instance of {@link ReplicationControllerSpecTemplateSpecInitContainerSecurityContext}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ReplicationControllerSpecTemplateSpecInitContainerSecurityContext build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link ReplicationControllerSpecTemplateSpecInitContainerSecurityContext}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ReplicationControllerSpecTemplateSpecInitContainerSecurityContext {
        private final java.lang.Object allowPrivilegeEscalation;
        private final imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerSecurityContextCapabilities capabilities;
        ...
        private final imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerSecurityContextSeccompProfile seccompProfile;
        private final imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerSecurityContextSeLinuxOptions seLinuxOptions;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.capabilities = software.amazon.jsii.Kernel.get(this, "capabilities", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerSecurityContextCapabilities.class));
            ...
            this.seccompProfile = software.amazon.jsii.Kernel.get(this, "seccompProfile", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerSecurityContextSeccompProfile.class));
            this.seLinuxOptions = software.amazon.jsii.Kernel.get(this, "seLinuxOptions", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerSecurityContextSeLinuxOptions.class));
        }
        ...
        @Override
        public final imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerSecurityContextCapabilities getCapabilities() {
        ...
        @Override
        public final imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerSecurityContextSeccompProfile getSeccompProfile() {
            return this.seccompProfile;
        }

        @Override
        public final imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerSecurityContextSeLinuxOptions getSeLinuxOptions() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.ReplicationControllerSpecTemplateSpecInitContainerSecurityContext"));
        ...
        public final boolean equals(final Object o) {
            ...
            ReplicationControllerSpecTemplateSpecInitContainerSecurityContext.Jsii$Proxy that = (ReplicationControllerSpecTemplateSpecInitContainerSecurityContext.Jsii$Proxy) o;
