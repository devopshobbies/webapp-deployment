...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PersistentVolumeSpecPersistentVolumeSourceFlocker")
@software.amazon.jsii.Jsii.Proxy(PersistentVolumeSpecPersistentVolumeSourceFlocker.Jsii$Proxy.class)
public interface PersistentVolumeSpecPersistentVolumeSourceFlocker extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link PersistentVolumeSpecPersistentVolumeSourceFlocker}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link PersistentVolumeSpecPersistentVolumeSourceFlocker}
     */
    public static final class Builder implements software.amazon.jsii.Builder<PersistentVolumeSpecPersistentVolumeSourceFlocker> {
        java.lang.String datasetName;
        java.lang.String datasetUuid;

        /**
         * Sets the value of {@link PersistentVolumeSpecPersistentVolumeSourceFlocker#getDatasetName}
        ...
        /**
         * Sets the value of {@link PersistentVolumeSpecPersistentVolumeSourceFlocker#getDatasetUuid}
         ...
         * @return a new instance of {@link PersistentVolumeSpecPersistentVolumeSourceFlocker}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public PersistentVolumeSpecPersistentVolumeSourceFlocker build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link PersistentVolumeSpecPersistentVolumeSourceFlocker}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PersistentVolumeSpecPersistentVolumeSourceFlocker {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.PersistentVolumeSpecPersistentVolumeSourceFlocker"));
        ...
        public final boolean equals(final Object o) {
            ...
            PersistentVolumeSpecPersistentVolumeSourceFlocker.Jsii$Proxy that = (PersistentVolumeSpecPersistentVolumeSourceFlocker.Jsii$Proxy) o;
