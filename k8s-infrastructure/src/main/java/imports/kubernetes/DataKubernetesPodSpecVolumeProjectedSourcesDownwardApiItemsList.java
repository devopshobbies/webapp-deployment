...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DataKubernetesPodSpecVolumeProjectedSourcesDownwardApiItemsList")
public class DataKubernetesPodSpecVolumeProjectedSourcesDownwardApiItemsList extends com.hashicorp.cdktf.ComplexList {

    protected DataKubernetesPodSpecVolumeProjectedSourcesDownwardApiItemsList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecVolumeProjectedSourcesDownwardApiItemsList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.kubernetes.DataKubernetesPodSpecVolumeProjectedSourcesDownwardApiItemsOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DataKubernetesPodSpecVolumeProjectedSourcesDownwardApiItemsOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
