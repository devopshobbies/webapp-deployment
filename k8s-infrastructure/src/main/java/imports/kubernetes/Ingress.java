 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:39.908Z")
...
public class Ingress extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.kubernetes.Ingress.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
    ...
    public void putMetadata(final @org.jetbrains.annotations.NotNull imports.kubernetes.IngressMetadata value) {
    ...
    public void putSpec(final @org.jetbrains.annotations.NotNull imports.kubernetes.IngressSpec value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.kubernetes.IngressMetadataOutputReference getMetadata() {
        return software.amazon.jsii.Kernel.get(this, "metadata", software.amazon.jsii.NativeType.forClass(imports.kubernetes.IngressMetadataOutputReference.class));
    }

    public @org.jetbrains.annotations.NotNull imports.kubernetes.IngressSpecOutputReference getSpec() {
        return software.amazon.jsii.Kernel.get(this, "spec", software.amazon.jsii.NativeType.forClass(imports.kubernetes.IngressSpecOutputReference.class));
    }

    public @org.jetbrains.annotations.NotNull imports.kubernetes.IngressStatusList getStatus() {
        return software.amazon.jsii.Kernel.get(this, "status", software.amazon.jsii.NativeType.forClass(imports.kubernetes.IngressStatusList.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.kubernetes.IngressMetadata getMetadataInput() {
        return software.amazon.jsii.Kernel.get(this, "metadataInput", software.amazon.jsii.NativeType.forClass(imports.kubernetes.IngressMetadata.class));
    }

    public @org.jetbrains.annotations.Nullable imports.kubernetes.IngressSpec getSpecInput() {
        return software.amazon.jsii.Kernel.get(this, "specInput", software.amazon.jsii.NativeType.forClass(imports.kubernetes.IngressSpec.class));
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<imports.kubernetes.Ingress> {
         ...
         */
        public Builder metadata(final imports.kubernetes.IngressMetadata metadata) {
         ...
         */
        public Builder spec(final imports.kubernetes.IngressSpec spec) {
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/r/ingress#id Ingress#id}. This parameter is required.
         */
