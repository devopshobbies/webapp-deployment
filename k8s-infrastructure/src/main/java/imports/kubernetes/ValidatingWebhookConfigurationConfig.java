...
public interface ValidatingWebhookConfigurationConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
     ...
     */
    @org.jetbrains.annotations.NotNull imports.kubernetes.ValidatingWebhookConfigurationMetadata getMetadata();
    ...
    public static final class Builder implements software.amazon.jsii.Builder<ValidatingWebhookConfigurationConfig> {
        imports.kubernetes.ValidatingWebhookConfigurationMetadata metadata;
         ...
         * @return {@code this}
         */
        public Builder metadata(imports.kubernetes.ValidatingWebhookConfigurationMetadata metadata) {
        ...
        /**
         * Sets the value of {@link ValidatingWebhookConfigurationConfig#getId}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/r/validating_webhook_configuration#id ValidatingWebhookConfiguration#id}.
         *           Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2.
         *           If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link ValidatingWebhookConfigurationConfig#getConnection}
        ...
        /**
         * Sets the value of {@link ValidatingWebhookConfigurationConfig#getForEach}
        ...
        /**
         * Sets the value of {@link ValidatingWebhookConfigurationConfig#getProvisioners}
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ValidatingWebhookConfigurationConfig {
        private final imports.kubernetes.ValidatingWebhookConfigurationMetadata metadata;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.metadata = software.amazon.jsii.Kernel.get(this, "metadata", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ValidatingWebhookConfigurationMetadata.class));
        ...
        @Override
        public final imports.kubernetes.ValidatingWebhookConfigurationMetadata getMetadata() {
