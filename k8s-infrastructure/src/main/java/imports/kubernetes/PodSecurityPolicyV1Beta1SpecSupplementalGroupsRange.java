...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PodSecurityPolicyV1Beta1SpecSupplementalGroupsRange")
@software.amazon.jsii.Jsii.Proxy(PodSecurityPolicyV1Beta1SpecSupplementalGroupsRange.Jsii$Proxy.class)
public interface PodSecurityPolicyV1Beta1SpecSupplementalGroupsRange extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link PodSecurityPolicyV1Beta1SpecSupplementalGroupsRange}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link PodSecurityPolicyV1Beta1SpecSupplementalGroupsRange}
     */
    public static final class Builder implements software.amazon.jsii.Builder<PodSecurityPolicyV1Beta1SpecSupplementalGroupsRange> {
        java.lang.Number max;
        java.lang.Number min;

        /**
         * Sets the value of {@link PodSecurityPolicyV1Beta1SpecSupplementalGroupsRange#getMax}
        ...
        /**
         * Sets the value of {@link PodSecurityPolicyV1Beta1SpecSupplementalGroupsRange#getMin}
         ...
         * @return a new instance of {@link PodSecurityPolicyV1Beta1SpecSupplementalGroupsRange}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public PodSecurityPolicyV1Beta1SpecSupplementalGroupsRange build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link PodSecurityPolicyV1Beta1SpecSupplementalGroupsRange}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodSecurityPolicyV1Beta1SpecSupplementalGroupsRange {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.PodSecurityPolicyV1Beta1SpecSupplementalGroupsRange"));
        ...
        public final boolean equals(final Object o) {
            ...
            PodSecurityPolicyV1Beta1SpecSupplementalGroupsRange.Jsii$Proxy that = (PodSecurityPolicyV1Beta1SpecSupplementalGroupsRange.Jsii$Proxy) o;
