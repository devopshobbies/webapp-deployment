...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.StatefulSetSpecTemplateSpecHostAliases")
@software.amazon.jsii.Jsii.Proxy(StatefulSetSpecTemplateSpecHostAliases.Jsii$Proxy.class)
public interface StatefulSetSpecTemplateSpecHostAliases extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link StatefulSetSpecTemplateSpecHostAliases}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link StatefulSetSpecTemplateSpecHostAliases}
     */
    public static final class Builder implements software.amazon.jsii.Builder<StatefulSetSpecTemplateSpecHostAliases> {
        java.util.List<java.lang.String> hostnames;
        java.lang.String ip;

        /**
         * Sets the value of {@link StatefulSetSpecTemplateSpecHostAliases#getHostnames}
        ...
        /**
         * Sets the value of {@link StatefulSetSpecTemplateSpecHostAliases#getIp}
         ...
         * @return a new instance of {@link StatefulSetSpecTemplateSpecHostAliases}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public StatefulSetSpecTemplateSpecHostAliases build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link StatefulSetSpecTemplateSpecHostAliases}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements StatefulSetSpecTemplateSpecHostAliases {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.StatefulSetSpecTemplateSpecHostAliases"));
        ...
        public final boolean equals(final Object o) {
            ...
            StatefulSetSpecTemplateSpecHostAliases.Jsii$Proxy that = (StatefulSetSpecTemplateSpecHostAliases.Jsii$Proxy) o;
