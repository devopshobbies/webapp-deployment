...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.ServiceV1SpecOutputReference")
public class ServiceV1SpecOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected ServiceV1SpecOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected ServiceV1SpecOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public ServiceV1SpecOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public void putSessionAffinityConfig(final @org.jetbrains.annotations.NotNull imports.kubernetes.ServiceV1SpecSessionAffinityConfig value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.kubernetes.ServiceV1SpecPortList getPort() {
        return software.amazon.jsii.Kernel.get(this, "port", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ServiceV1SpecPortList.class));
    }

    public @org.jetbrains.annotations.NotNull imports.kubernetes.ServiceV1SpecSessionAffinityConfigOutputReference getSessionAffinityConfig() {
        return software.amazon.jsii.Kernel.get(this, "sessionAffinityConfig", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ServiceV1SpecSessionAffinityConfigOutputReference.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.kubernetes.ServiceV1SpecSessionAffinityConfig getSessionAffinityConfigInput() {
        return software.amazon.jsii.Kernel.get(this, "sessionAffinityConfigInput", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ServiceV1SpecSessionAffinityConfig.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.kubernetes.ServiceV1Spec getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ServiceV1Spec.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.ServiceV1Spec value) {
