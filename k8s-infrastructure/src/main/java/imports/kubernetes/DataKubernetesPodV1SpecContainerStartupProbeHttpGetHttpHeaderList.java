...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DataKubernetesPodV1SpecContainerStartupProbeHttpGetHttpHeaderList")
public class DataKubernetesPodV1SpecContainerStartupProbeHttpGetHttpHeaderList extends com.hashicorp.cdktf.ComplexList {

    protected DataKubernetesPodV1SpecContainerStartupProbeHttpGetHttpHeaderList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodV1SpecContainerStartupProbeHttpGetHttpHeaderList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.kubernetes.DataKubernetesPodV1SpecContainerStartupProbeHttpGetHttpHeaderOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DataKubernetesPodV1SpecContainerStartupProbeHttpGetHttpHeaderOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
