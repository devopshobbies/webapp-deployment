...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DeploymentSpecTemplateSpecVolumeGlusterfs")
@software.amazon.jsii.Jsii.Proxy(DeploymentSpecTemplateSpecVolumeGlusterfs.Jsii$Proxy.class)
public interface DeploymentSpecTemplateSpecVolumeGlusterfs extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DeploymentSpecTemplateSpecVolumeGlusterfs}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DeploymentSpecTemplateSpecVolumeGlusterfs}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DeploymentSpecTemplateSpecVolumeGlusterfs> {
        java.lang.String endpointsName;
        java.lang.String path;
        java.lang.Object readOnly;

        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecVolumeGlusterfs#getEndpointsName}
        ...
        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecVolumeGlusterfs#getPath}
        ...
        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecVolumeGlusterfs#getReadOnly}
         ...
         * @return a new instance of {@link DeploymentSpecTemplateSpecVolumeGlusterfs}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DeploymentSpecTemplateSpecVolumeGlusterfs build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DeploymentSpecTemplateSpecVolumeGlusterfs}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DeploymentSpecTemplateSpecVolumeGlusterfs {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DeploymentSpecTemplateSpecVolumeGlusterfs"));
        ...
        public final boolean equals(final Object o) {
            ...
            DeploymentSpecTemplateSpecVolumeGlusterfs.Jsii$Proxy that = (DeploymentSpecTemplateSpecVolumeGlusterfs.Jsii$Proxy) o;
