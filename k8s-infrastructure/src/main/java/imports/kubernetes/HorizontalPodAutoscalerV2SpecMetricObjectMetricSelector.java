...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:39.901Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.HorizontalPodAutoscalerV2SpecMetricObjectMetricSelector")
@software.amazon.jsii.Jsii.Proxy(HorizontalPodAutoscalerV2SpecMetricObjectMetricSelector.Jsii$Proxy.class)
public interface HorizontalPodAutoscalerV2SpecMetricObjectMetricSelector extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link HorizontalPodAutoscalerV2SpecMetricObjectMetricSelector}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link HorizontalPodAutoscalerV2SpecMetricObjectMetricSelector}
     */
    public static final class Builder implements software.amazon.jsii.Builder<HorizontalPodAutoscalerV2SpecMetricObjectMetricSelector> {
        java.lang.Object matchExpressions;
        java.util.Map<java.lang.String, java.lang.String> matchLabels;

        /**
         * Sets the value of {@link HorizontalPodAutoscalerV2SpecMetricObjectMetricSelector#getMatchExpressions}
         ...
         * @return {@code this}
         */
        public Builder matchExpressions(java.util.List<? extends imports.kubernetes.HorizontalPodAutoscalerV2SpecMetricObjectMetricSelectorMatchExpressions> matchExpressions) {
            this.matchExpressions = matchExpressions;
            return this;
        }

        /**
         * Sets the value of {@link HorizontalPodAutoscalerV2SpecMetricObjectMetricSelector#getMatchLabels}
         ...
         * @return a new instance of {@link HorizontalPodAutoscalerV2SpecMetricObjectMetricSelector}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public HorizontalPodAutoscalerV2SpecMetricObjectMetricSelector build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link HorizontalPodAutoscalerV2SpecMetricObjectMetricSelector}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements HorizontalPodAutoscalerV2SpecMetricObjectMetricSelector {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.HorizontalPodAutoscalerV2SpecMetricObjectMetricSelector"));
        ...
        public final boolean equals(final Object o) {
            ...
            HorizontalPodAutoscalerV2SpecMetricObjectMetricSelector.Jsii$Proxy that = (HorizontalPodAutoscalerV2SpecMetricObjectMetricSelector.Jsii$Proxy) o;
