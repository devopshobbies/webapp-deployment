...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.HorizontalPodAutoscalerV2Beta2SpecScaleTargetRef")
@software.amazon.jsii.Jsii.Proxy(HorizontalPodAutoscalerV2Beta2SpecScaleTargetRef.Jsii$Proxy.class)
public interface HorizontalPodAutoscalerV2Beta2SpecScaleTargetRef extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link HorizontalPodAutoscalerV2Beta2SpecScaleTargetRef}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link HorizontalPodAutoscalerV2Beta2SpecScaleTargetRef}
     */
    public static final class Builder implements software.amazon.jsii.Builder<HorizontalPodAutoscalerV2Beta2SpecScaleTargetRef> {
        java.lang.String kind;
        java.lang.String name;
        java.lang.String apiVersion;

        /**
         * Sets the value of {@link HorizontalPodAutoscalerV2Beta2SpecScaleTargetRef#getKind}
        ...
        /**
         * Sets the value of {@link HorizontalPodAutoscalerV2Beta2SpecScaleTargetRef#getName}
        ...
        /**
         * Sets the value of {@link HorizontalPodAutoscalerV2Beta2SpecScaleTargetRef#getApiVersion}
         ...
         * @return a new instance of {@link HorizontalPodAutoscalerV2Beta2SpecScaleTargetRef}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public HorizontalPodAutoscalerV2Beta2SpecScaleTargetRef build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link HorizontalPodAutoscalerV2Beta2SpecScaleTargetRef}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements HorizontalPodAutoscalerV2Beta2SpecScaleTargetRef {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.HorizontalPodAutoscalerV2Beta2SpecScaleTargetRef"));
        ...
        public final boolean equals(final Object o) {
            ...
            HorizontalPodAutoscalerV2Beta2SpecScaleTargetRef.Jsii$Proxy that = (HorizontalPodAutoscalerV2Beta2SpecScaleTargetRef.Jsii$Proxy) o;
