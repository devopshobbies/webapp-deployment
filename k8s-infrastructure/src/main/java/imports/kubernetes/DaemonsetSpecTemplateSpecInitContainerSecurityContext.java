...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:39.359Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DaemonsetSpecTemplateSpecInitContainerSecurityContext")
@software.amazon.jsii.Jsii.Proxy(DaemonsetSpecTemplateSpecInitContainerSecurityContext.Jsii$Proxy.class)
public interface DaemonsetSpecTemplateSpecInitContainerSecurityContext extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerSecurityContextCapabilities getCapabilities() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerSecurityContextSeccompProfile getSeccompProfile() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerSecurityContextSeLinuxOptions getSeLinuxOptions() {
        return null;
    }

    /**
     * @return a {@link Builder} of {@link DaemonsetSpecTemplateSpecInitContainerSecurityContext}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DaemonsetSpecTemplateSpecInitContainerSecurityContext}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DaemonsetSpecTemplateSpecInitContainerSecurityContext> {
        java.lang.Object allowPrivilegeEscalation;
        imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerSecurityContextCapabilities capabilities;
        ...
        imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerSecurityContextSeccompProfile seccompProfile;
        imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerSecurityContextSeLinuxOptions seLinuxOptions;

        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerSecurityContext#getAllowPrivilegeEscalation}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerSecurityContext#getCapabilities}
         * @param capabilities capabilities block.
         *                     Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/daemonset#capabilities Daemonset#capabilities}
         * @return {@code this}
         */
        public Builder capabilities(imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerSecurityContextCapabilities capabilities) {
            this.capabilities = capabilities;
            return this;
        }

        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerSecurityContext#getPrivileged}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerSecurityContext#getReadOnlyRootFilesystem}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerSecurityContext#getRunAsGroup}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerSecurityContext#getRunAsNonRoot}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerSecurityContext#getRunAsUser}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerSecurityContext#getSeccompProfile}
         * @param seccompProfile seccomp_profile block.
         *                       Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/daemonset#seccomp_profile Daemonset#seccomp_profile}
         * @return {@code this}
         */
        public Builder seccompProfile(imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerSecurityContextSeccompProfile seccompProfile) {
            this.seccompProfile = seccompProfile;
            return this;
        }

        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerSecurityContext#getSeLinuxOptions}
         * @param seLinuxOptions se_linux_options block.
         *                       Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/daemonset#se_linux_options Daemonset#se_linux_options}
         * @return {@code this}
         */
        public Builder seLinuxOptions(imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerSecurityContextSeLinuxOptions seLinuxOptions) {
         ...
         * @return a new instance of {@link DaemonsetSpecTemplateSpecInitContainerSecurityContext}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DaemonsetSpecTemplateSpecInitContainerSecurityContext build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DaemonsetSpecTemplateSpecInitContainerSecurityContext}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DaemonsetSpecTemplateSpecInitContainerSecurityContext {
        private final java.lang.Object allowPrivilegeEscalation;
        private final imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerSecurityContextCapabilities capabilities;
        ...
        private final imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerSecurityContextSeccompProfile seccompProfile;
        private final imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerSecurityContextSeLinuxOptions seLinuxOptions;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.capabilities = software.amazon.jsii.Kernel.get(this, "capabilities", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerSecurityContextCapabilities.class));
            ...
            this.seccompProfile = software.amazon.jsii.Kernel.get(this, "seccompProfile", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerSecurityContextSeccompProfile.class));
            this.seLinuxOptions = software.amazon.jsii.Kernel.get(this, "seLinuxOptions", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerSecurityContextSeLinuxOptions.class));
        }
        ...
        @Override
        public final imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerSecurityContextCapabilities getCapabilities() {
        ...
        @Override
        public final imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerSecurityContextSeccompProfile getSeccompProfile() {
            return this.seccompProfile;
        }

        @Override
        public final imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerSecurityContextSeLinuxOptions getSeLinuxOptions() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DaemonsetSpecTemplateSpecInitContainerSecurityContext"));
        ...
        public final boolean equals(final Object o) {
            ...
            DaemonsetSpecTemplateSpecInitContainerSecurityContext.Jsii$Proxy that = (DaemonsetSpecTemplateSpecInitContainerSecurityContext.Jsii$Proxy) o;
