...
public interface HorizontalPodAutoscalerSpecMetricExternal extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull imports.kubernetes.HorizontalPodAutoscalerSpecMetricExternalMetric getMetric();
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.HorizontalPodAutoscalerSpecMetricExternalTarget getTarget() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<HorizontalPodAutoscalerSpecMetricExternal> {
        imports.kubernetes.HorizontalPodAutoscalerSpecMetricExternalMetric metric;
        imports.kubernetes.HorizontalPodAutoscalerSpecMetricExternalTarget target;
         ...
         * @return {@code this}
         */
        public Builder metric(imports.kubernetes.HorizontalPodAutoscalerSpecMetricExternalMetric metric) {
            this.metric = metric;
            return this;
        }
         ...
         * @return {@code this}
         */
        public Builder target(imports.kubernetes.HorizontalPodAutoscalerSpecMetricExternalTarget target) {
            this.target = target;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements HorizontalPodAutoscalerSpecMetricExternal {
        private final imports.kubernetes.HorizontalPodAutoscalerSpecMetricExternalMetric metric;
        private final imports.kubernetes.HorizontalPodAutoscalerSpecMetricExternalTarget target;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.metric = software.amazon.jsii.Kernel.get(this, "metric", software.amazon.jsii.NativeType.forClass(imports.kubernetes.HorizontalPodAutoscalerSpecMetricExternalMetric.class));
            this.target = software.amazon.jsii.Kernel.get(this, "target", software.amazon.jsii.NativeType.forClass(imports.kubernetes.HorizontalPodAutoscalerSpecMetricExternalTarget.class));
        }
        ...
        @Override
        public final imports.kubernetes.HorizontalPodAutoscalerSpecMetricExternalMetric getMetric() {
            return this.metric;
        }

        @Override
        public final imports.kubernetes.HorizontalPodAutoscalerSpecMetricExternalTarget getTarget() {
            return this.target;
        }
