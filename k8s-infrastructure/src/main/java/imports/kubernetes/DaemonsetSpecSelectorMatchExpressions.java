...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DaemonsetSpecSelectorMatchExpressions")
@software.amazon.jsii.Jsii.Proxy(DaemonsetSpecSelectorMatchExpressions.Jsii$Proxy.class)
public interface DaemonsetSpecSelectorMatchExpressions extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DaemonsetSpecSelectorMatchExpressions}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DaemonsetSpecSelectorMatchExpressions}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DaemonsetSpecSelectorMatchExpressions> {
        java.lang.String key;
        java.lang.String operator;
        java.util.List<java.lang.String> values;

        /**
         * Sets the value of {@link DaemonsetSpecSelectorMatchExpressions#getKey}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecSelectorMatchExpressions#getOperator}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecSelectorMatchExpressions#getValues}
         ...
         * @return a new instance of {@link DaemonsetSpecSelectorMatchExpressions}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DaemonsetSpecSelectorMatchExpressions build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DaemonsetSpecSelectorMatchExpressions}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DaemonsetSpecSelectorMatchExpressions {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DaemonsetSpecSelectorMatchExpressions"));
        ...
        public final boolean equals(final Object o) {
            ...
            DaemonsetSpecSelectorMatchExpressions.Jsii$Proxy that = (DaemonsetSpecSelectorMatchExpressions.Jsii$Proxy) o;
