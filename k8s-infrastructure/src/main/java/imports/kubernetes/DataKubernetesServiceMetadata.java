...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DataKubernetesServiceMetadata")
@software.amazon.jsii.Jsii.Proxy(DataKubernetesServiceMetadata.Jsii$Proxy.class)
public interface DataKubernetesServiceMetadata extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DataKubernetesServiceMetadata}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DataKubernetesServiceMetadata}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DataKubernetesServiceMetadata> {
        ...
        /**
         * Sets the value of {@link DataKubernetesServiceMetadata#getAnnotations}
         * @param annotations An unstructured key value map stored with the service that may be used to store arbitrary metadata.
         *                    More info: http://kubernetes.io/docs/user-guide/annotations
         *                    <p>
         *                    Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/d/service#annotations DataKubernetesService#annotations}
         * @return {@code this}
        ...
        /**
         * Sets the value of {@link DataKubernetesServiceMetadata#getLabels}
         * @param labels Map of string keys and values that can be used to organize and categorize (scope and select) the service.
         *               May match selectors of replication controllers and services. More info: http://kubernetes.io/docs/user-guide/labels
         *               <p>
         *               Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/d/service#labels DataKubernetesService#labels}
         * @return {@code this}
        ...
        /**
         * Sets the value of {@link DataKubernetesServiceMetadata#getName}
         * @param name Name of the service, must be unique. Cannot be updated. More info: http://kubernetes.io/docs/user-guide/identifiers#names.
         *             Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/d/service#name DataKubernetesService#name}
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link DataKubernetesServiceMetadata#getNamespace}
         * @param namespace Namespace defines the space within which name of the service must be unique.
         *                  Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/d/service#namespace DataKubernetesService#namespace}
         * @return {@code this}
         */
         ...
         * @return a new instance of {@link DataKubernetesServiceMetadata}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DataKubernetesServiceMetadata build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DataKubernetesServiceMetadata}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DataKubernetesServiceMetadata {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DataKubernetesServiceMetadata"));
        ...
        public final boolean equals(final Object o) {
            ...
            DataKubernetesServiceMetadata.Jsii$Proxy that = (DataKubernetesServiceMetadata.Jsii$Proxy) o;
