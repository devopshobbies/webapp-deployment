 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:40.878Z")
...
public class RoleBinding extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.kubernetes.RoleBinding.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
    ...
    public void putMetadata(final @org.jetbrains.annotations.NotNull imports.kubernetes.RoleBindingMetadata value) {
    ...
    public void putRoleRef(final @org.jetbrains.annotations.NotNull imports.kubernetes.RoleBindingRoleRef value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.kubernetes.RoleBindingMetadataOutputReference getMetadata() {
        return software.amazon.jsii.Kernel.get(this, "metadata", software.amazon.jsii.NativeType.forClass(imports.kubernetes.RoleBindingMetadataOutputReference.class));
    }

    public @org.jetbrains.annotations.NotNull imports.kubernetes.RoleBindingRoleRefOutputReference getRoleRef() {
        return software.amazon.jsii.Kernel.get(this, "roleRef", software.amazon.jsii.NativeType.forClass(imports.kubernetes.RoleBindingRoleRefOutputReference.class));
    }

    public @org.jetbrains.annotations.NotNull imports.kubernetes.RoleBindingSubjectList getSubject() {
        return software.amazon.jsii.Kernel.get(this, "subject", software.amazon.jsii.NativeType.forClass(imports.kubernetes.RoleBindingSubjectList.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.kubernetes.RoleBindingMetadata getMetadataInput() {
        return software.amazon.jsii.Kernel.get(this, "metadataInput", software.amazon.jsii.NativeType.forClass(imports.kubernetes.RoleBindingMetadata.class));
    }

    public @org.jetbrains.annotations.Nullable imports.kubernetes.RoleBindingRoleRef getRoleRefInput() {
        return software.amazon.jsii.Kernel.get(this, "roleRefInput", software.amazon.jsii.NativeType.forClass(imports.kubernetes.RoleBindingRoleRef.class));
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<imports.kubernetes.RoleBinding> {
         ...
         */
        public Builder metadata(final imports.kubernetes.RoleBindingMetadata metadata) {
         ...
         */
        public Builder roleRef(final imports.kubernetes.RoleBindingRoleRef roleRef) {
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/r/role_binding#id RoleBinding#id}. This parameter is required.
         */
