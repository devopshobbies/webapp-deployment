...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:40.381Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PodSpecVolumeCephFsOutputReference")
public class PodSpecVolumeCephFsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected PodSpecVolumeCephFsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected PodSpecVolumeCephFsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public PodSpecVolumeCephFsOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(terraformResource, "terraformResource is required"), java.util.Objects.requireNonNull(terraformAttribute, "terraformAttribute is required") });
    }

    public void putSecretRef(final @org.jetbrains.annotations.NotNull imports.kubernetes.PodSpecVolumeCephFsSecretRef value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.kubernetes.PodSpecVolumeCephFsSecretRefOutputReference getSecretRef() {
        return software.amazon.jsii.Kernel.get(this, "secretRef", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecVolumeCephFsSecretRefOutputReference.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.kubernetes.PodSpecVolumeCephFsSecretRef getSecretRefInput() {
        return software.amazon.jsii.Kernel.get(this, "secretRefInput", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecVolumeCephFsSecretRef.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.kubernetes.PodSpecVolumeCephFs getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecVolumeCephFs.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.PodSpecVolumeCephFs value) {
