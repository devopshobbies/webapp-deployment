...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.EndpointsV1SubsetNotReadyAddressOutputReference")
public class EndpointsV1SubsetNotReadyAddressOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected EndpointsV1SubsetNotReadyAddressOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected EndpointsV1SubsetNotReadyAddressOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.EndpointsV1SubsetNotReadyAddress value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
