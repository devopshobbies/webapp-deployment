...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DaemonsetSpecTemplateSpecInitContainerEnvValueFromResourceFieldRef")
@software.amazon.jsii.Jsii.Proxy(DaemonsetSpecTemplateSpecInitContainerEnvValueFromResourceFieldRef.Jsii$Proxy.class)
public interface DaemonsetSpecTemplateSpecInitContainerEnvValueFromResourceFieldRef extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DaemonsetSpecTemplateSpecInitContainerEnvValueFromResourceFieldRef}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DaemonsetSpecTemplateSpecInitContainerEnvValueFromResourceFieldRef}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DaemonsetSpecTemplateSpecInitContainerEnvValueFromResourceFieldRef> {
        java.lang.String resource;
        java.lang.String containerName;
        java.lang.String divisor;

        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerEnvValueFromResourceFieldRef#getResource}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerEnvValueFromResourceFieldRef#getContainerName}
         * @param containerName Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/r/daemonset#container_name Daemonset#container_name}.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerEnvValueFromResourceFieldRef#getDivisor}
         ...
         * @return a new instance of {@link DaemonsetSpecTemplateSpecInitContainerEnvValueFromResourceFieldRef}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DaemonsetSpecTemplateSpecInitContainerEnvValueFromResourceFieldRef build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DaemonsetSpecTemplateSpecInitContainerEnvValueFromResourceFieldRef}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DaemonsetSpecTemplateSpecInitContainerEnvValueFromResourceFieldRef {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DaemonsetSpecTemplateSpecInitContainerEnvValueFromResourceFieldRef"));
        ...
        public final boolean equals(final Object o) {
            ...
            DaemonsetSpecTemplateSpecInitContainerEnvValueFromResourceFieldRef.Jsii$Proxy that = (DaemonsetSpecTemplateSpecInitContainerEnvValueFromResourceFieldRef.Jsii$Proxy) o;
