 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:38.668Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.Annotations")
public class Annotations extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.kubernetes.Annotations.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public Annotations(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.kubernetes.AnnotationsConfig config) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(id, "id is required"), java.util.Objects.requireNonNull(config, "config is required") });
    }

    public void putMetadata(final @org.jetbrains.annotations.NotNull imports.kubernetes.AnnotationsMetadata value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.kubernetes.AnnotationsMetadataOutputReference getMetadata() {
        return software.amazon.jsii.Kernel.get(this, "metadata", software.amazon.jsii.NativeType.forClass(imports.kubernetes.AnnotationsMetadataOutputReference.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.kubernetes.AnnotationsMetadata getMetadataInput() {
        return software.amazon.jsii.Kernel.get(this, "metadataInput", software.amazon.jsii.NativeType.forClass(imports.kubernetes.AnnotationsMetadata.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.kubernetes.Annotations}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.kubernetes.Annotations> {
        /**
        ...
        private final imports.kubernetes.AnnotationsConfig.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.kubernetes.AnnotationsConfig.Builder();
        }
         ...
         */
        public Builder annotations(final java.util.Map<java.lang.String, java.lang.String> annotations) {
         ...
         */
        public Builder metadata(final imports.kubernetes.AnnotationsMetadata metadata) {
         ...
         * <p>
         * @return {@code this}
         * @param force Force overwriting annotations that were created or edited outside of Terraform. This parameter is required.
         */
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/r/annotations#id Annotations#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.kubernetes.Annotations}.
         */
        @Override
        public imports.kubernetes.Annotations build() {
            return new imports.kubernetes.Annotations(
                this.scope,
                this.id,
                this.config.build()
            );
