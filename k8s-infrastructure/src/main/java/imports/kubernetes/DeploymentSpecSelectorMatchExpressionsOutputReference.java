...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DeploymentSpecSelectorMatchExpressionsOutputReference")
public class DeploymentSpecSelectorMatchExpressionsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DeploymentSpecSelectorMatchExpressionsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DeploymentSpecSelectorMatchExpressionsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.DeploymentSpecSelectorMatchExpressions value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
