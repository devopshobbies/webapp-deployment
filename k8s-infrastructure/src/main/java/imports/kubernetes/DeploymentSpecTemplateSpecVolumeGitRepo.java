...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DeploymentSpecTemplateSpecVolumeGitRepo")
@software.amazon.jsii.Jsii.Proxy(DeploymentSpecTemplateSpecVolumeGitRepo.Jsii$Proxy.class)
public interface DeploymentSpecTemplateSpecVolumeGitRepo extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DeploymentSpecTemplateSpecVolumeGitRepo}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DeploymentSpecTemplateSpecVolumeGitRepo}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DeploymentSpecTemplateSpecVolumeGitRepo> {
        java.lang.String directory;
        java.lang.String repository;
        java.lang.String revision;

        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecVolumeGitRepo#getDirectory}
        ...
        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecVolumeGitRepo#getRepository}
        ...
        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecVolumeGitRepo#getRevision}
         ...
         * @return a new instance of {@link DeploymentSpecTemplateSpecVolumeGitRepo}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DeploymentSpecTemplateSpecVolumeGitRepo build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DeploymentSpecTemplateSpecVolumeGitRepo}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DeploymentSpecTemplateSpecVolumeGitRepo {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DeploymentSpecTemplateSpecVolumeGitRepo"));
        ...
        public final boolean equals(final Object o) {
            ...
            DeploymentSpecTemplateSpecVolumeGitRepo.Jsii$Proxy that = (DeploymentSpecTemplateSpecVolumeGitRepo.Jsii$Proxy) o;
