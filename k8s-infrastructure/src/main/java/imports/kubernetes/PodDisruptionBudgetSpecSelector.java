...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PodDisruptionBudgetSpecSelector")
@software.amazon.jsii.Jsii.Proxy(PodDisruptionBudgetSpecSelector.Jsii$Proxy.class)
public interface PodDisruptionBudgetSpecSelector extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link PodDisruptionBudgetSpecSelector}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link PodDisruptionBudgetSpecSelector}
     */
    public static final class Builder implements software.amazon.jsii.Builder<PodDisruptionBudgetSpecSelector> {
        java.lang.Object matchExpressions;
        java.util.Map<java.lang.String, java.lang.String> matchLabels;

        /**
         * Sets the value of {@link PodDisruptionBudgetSpecSelector#getMatchExpressions}
         ...
         * @return {@code this}
         */
        public Builder matchExpressions(java.util.List<? extends imports.kubernetes.PodDisruptionBudgetSpecSelectorMatchExpressions> matchExpressions) {
            this.matchExpressions = matchExpressions;
            return this;
        }

        /**
         * Sets the value of {@link PodDisruptionBudgetSpecSelector#getMatchLabels}
         ...
         * @return a new instance of {@link PodDisruptionBudgetSpecSelector}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public PodDisruptionBudgetSpecSelector build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link PodDisruptionBudgetSpecSelector}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodDisruptionBudgetSpecSelector {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.PodDisruptionBudgetSpecSelector"));
        ...
        public final boolean equals(final Object o) {
            ...
            PodDisruptionBudgetSpecSelector.Jsii$Proxy that = (PodDisruptionBudgetSpecSelector.Jsii$Proxy) o;
