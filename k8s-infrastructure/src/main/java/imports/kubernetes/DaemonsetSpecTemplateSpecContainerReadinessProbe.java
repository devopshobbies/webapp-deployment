...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:39.321Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DaemonsetSpecTemplateSpecContainerReadinessProbe")
@software.amazon.jsii.Jsii.Proxy(DaemonsetSpecTemplateSpecContainerReadinessProbe.Jsii$Proxy.class)
public interface DaemonsetSpecTemplateSpecContainerReadinessProbe extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.DaemonsetSpecTemplateSpecContainerReadinessProbeExec getExec() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.DaemonsetSpecTemplateSpecContainerReadinessProbeHttpGet getHttpGet() {
        return null;
    }
    ...
    /**
     * @return a {@link Builder} of {@link DaemonsetSpecTemplateSpecContainerReadinessProbe}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DaemonsetSpecTemplateSpecContainerReadinessProbe}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DaemonsetSpecTemplateSpecContainerReadinessProbe> {
        imports.kubernetes.DaemonsetSpecTemplateSpecContainerReadinessProbeExec exec;
        java.lang.Number failureThreshold;
        imports.kubernetes.DaemonsetSpecTemplateSpecContainerReadinessProbeHttpGet httpGet;
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecContainerReadinessProbe#getExec}
         * @param exec exec block.
         *             Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/daemonset#exec Daemonset#exec}
         * @return {@code this}
         */
        public Builder exec(imports.kubernetes.DaemonsetSpecTemplateSpecContainerReadinessProbeExec exec) {
            this.exec = exec;
            return this;
        }

        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecContainerReadinessProbe#getFailureThreshold}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecContainerReadinessProbe#getHttpGet}
         * @param httpGet http_get block.
         *                Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/daemonset#http_get Daemonset#http_get}
         * @return {@code this}
         */
        public Builder httpGet(imports.kubernetes.DaemonsetSpecTemplateSpecContainerReadinessProbeHttpGet httpGet) {
            this.httpGet = httpGet;
            return this;
        }

        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecContainerReadinessProbe#getInitialDelaySeconds}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecContainerReadinessProbe#getPeriodSeconds}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecContainerReadinessProbe#getSuccessThreshold}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecContainerReadinessProbe#getTcpSocket}
         ...
         * @return {@code this}
         */
        public Builder tcpSocket(java.util.List<? extends imports.kubernetes.DaemonsetSpecTemplateSpecContainerReadinessProbeTcpSocket> tcpSocket) {
            this.tcpSocket = tcpSocket;
            return this;
        }

        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecContainerReadinessProbe#getTimeoutSeconds}
         ...
         * @return a new instance of {@link DaemonsetSpecTemplateSpecContainerReadinessProbe}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DaemonsetSpecTemplateSpecContainerReadinessProbe build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DaemonsetSpecTemplateSpecContainerReadinessProbe}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DaemonsetSpecTemplateSpecContainerReadinessProbe {
        private final imports.kubernetes.DaemonsetSpecTemplateSpecContainerReadinessProbeExec exec;
        private final java.lang.Number failureThreshold;
        private final imports.kubernetes.DaemonsetSpecTemplateSpecContainerReadinessProbeHttpGet httpGet;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.exec = software.amazon.jsii.Kernel.get(this, "exec", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DaemonsetSpecTemplateSpecContainerReadinessProbeExec.class));
            ...
            this.httpGet = software.amazon.jsii.Kernel.get(this, "httpGet", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DaemonsetSpecTemplateSpecContainerReadinessProbeHttpGet.class));
        ...
        @Override
        public final imports.kubernetes.DaemonsetSpecTemplateSpecContainerReadinessProbeExec getExec() {
            return this.exec;
        }
        ...
        @Override
        public final imports.kubernetes.DaemonsetSpecTemplateSpecContainerReadinessProbeHttpGet getHttpGet() {
            return this.httpGet;
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DaemonsetSpecTemplateSpecContainerReadinessProbe"));
        ...
        public final boolean equals(final Object o) {
            ...
            DaemonsetSpecTemplateSpecContainerReadinessProbe.Jsii$Proxy that = (DaemonsetSpecTemplateSpecContainerReadinessProbe.Jsii$Proxy) o;
