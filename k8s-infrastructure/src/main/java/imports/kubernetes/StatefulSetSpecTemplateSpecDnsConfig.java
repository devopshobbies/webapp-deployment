...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.StatefulSetSpecTemplateSpecDnsConfig")
@software.amazon.jsii.Jsii.Proxy(StatefulSetSpecTemplateSpecDnsConfig.Jsii$Proxy.class)
public interface StatefulSetSpecTemplateSpecDnsConfig extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link StatefulSetSpecTemplateSpecDnsConfig}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link StatefulSetSpecTemplateSpecDnsConfig}
     */
    public static final class Builder implements software.amazon.jsii.Builder<StatefulSetSpecTemplateSpecDnsConfig> {
        java.util.List<java.lang.String> nameservers;
        java.lang.Object option;
        java.util.List<java.lang.String> searches;

        /**
         * Sets the value of {@link StatefulSetSpecTemplateSpecDnsConfig#getNameservers}
        ...
        /**
         * Sets the value of {@link StatefulSetSpecTemplateSpecDnsConfig#getOption}
         ...
         * @return {@code this}
         */
        public Builder option(java.util.List<? extends imports.kubernetes.StatefulSetSpecTemplateSpecDnsConfigOption> option) {
            this.option = option;
            return this;
        }

        /**
         * Sets the value of {@link StatefulSetSpecTemplateSpecDnsConfig#getSearches}
         ...
         * @return a new instance of {@link StatefulSetSpecTemplateSpecDnsConfig}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public StatefulSetSpecTemplateSpecDnsConfig build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link StatefulSetSpecTemplateSpecDnsConfig}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements StatefulSetSpecTemplateSpecDnsConfig {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.StatefulSetSpecTemplateSpecDnsConfig"));
        ...
        public final boolean equals(final Object o) {
            ...
            StatefulSetSpecTemplateSpecDnsConfig.Jsii$Proxy that = (StatefulSetSpecTemplateSpecDnsConfig.Jsii$Proxy) o;
