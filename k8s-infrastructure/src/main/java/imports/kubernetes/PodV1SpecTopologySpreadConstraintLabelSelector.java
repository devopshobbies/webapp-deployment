...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:40.598Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PodV1SpecTopologySpreadConstraintLabelSelector")
@software.amazon.jsii.Jsii.Proxy(PodV1SpecTopologySpreadConstraintLabelSelector.Jsii$Proxy.class)
public interface PodV1SpecTopologySpreadConstraintLabelSelector extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link PodV1SpecTopologySpreadConstraintLabelSelector}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link PodV1SpecTopologySpreadConstraintLabelSelector}
     */
    public static final class Builder implements software.amazon.jsii.Builder<PodV1SpecTopologySpreadConstraintLabelSelector> {
        java.lang.Object matchExpressions;
        java.util.Map<java.lang.String, java.lang.String> matchLabels;

        /**
         * Sets the value of {@link PodV1SpecTopologySpreadConstraintLabelSelector#getMatchExpressions}
         ...
         * @return {@code this}
         */
        public Builder matchExpressions(java.util.List<? extends imports.kubernetes.PodV1SpecTopologySpreadConstraintLabelSelectorMatchExpressions> matchExpressions) {
            this.matchExpressions = matchExpressions;
            return this;
        }

        /**
         * Sets the value of {@link PodV1SpecTopologySpreadConstraintLabelSelector#getMatchLabels}
         ...
         * @return a new instance of {@link PodV1SpecTopologySpreadConstraintLabelSelector}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public PodV1SpecTopologySpreadConstraintLabelSelector build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link PodV1SpecTopologySpreadConstraintLabelSelector}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodV1SpecTopologySpreadConstraintLabelSelector {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.PodV1SpecTopologySpreadConstraintLabelSelector"));
        ...
        public final boolean equals(final Object o) {
            ...
            PodV1SpecTopologySpreadConstraintLabelSelector.Jsii$Proxy that = (PodV1SpecTopologySpreadConstraintLabelSelector.Jsii$Proxy) o;
