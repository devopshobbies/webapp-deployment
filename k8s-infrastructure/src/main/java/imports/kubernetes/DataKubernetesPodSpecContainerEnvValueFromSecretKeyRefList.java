...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DataKubernetesPodSpecContainerEnvValueFromSecretKeyRefList")
public class DataKubernetesPodSpecContainerEnvValueFromSecretKeyRefList extends com.hashicorp.cdktf.ComplexList {

    protected DataKubernetesPodSpecContainerEnvValueFromSecretKeyRefList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecContainerEnvValueFromSecretKeyRefList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.kubernetes.DataKubernetesPodSpecContainerEnvValueFromSecretKeyRefOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DataKubernetesPodSpecContainerEnvValueFromSecretKeyRefOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
