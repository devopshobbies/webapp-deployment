...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DeploymentV1SpecTemplateSpecHostAliases")
@software.amazon.jsii.Jsii.Proxy(DeploymentV1SpecTemplateSpecHostAliases.Jsii$Proxy.class)
public interface DeploymentV1SpecTemplateSpecHostAliases extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DeploymentV1SpecTemplateSpecHostAliases}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DeploymentV1SpecTemplateSpecHostAliases}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DeploymentV1SpecTemplateSpecHostAliases> {
        java.util.List<java.lang.String> hostnames;
        java.lang.String ip;

        /**
         * Sets the value of {@link DeploymentV1SpecTemplateSpecHostAliases#getHostnames}
        ...
        /**
         * Sets the value of {@link DeploymentV1SpecTemplateSpecHostAliases#getIp}
         ...
         * @return a new instance of {@link DeploymentV1SpecTemplateSpecHostAliases}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DeploymentV1SpecTemplateSpecHostAliases build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DeploymentV1SpecTemplateSpecHostAliases}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DeploymentV1SpecTemplateSpecHostAliases {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DeploymentV1SpecTemplateSpecHostAliases"));
        ...
        public final boolean equals(final Object o) {
            ...
            DeploymentV1SpecTemplateSpecHostAliases.Jsii$Proxy that = (DeploymentV1SpecTemplateSpecHostAliases.Jsii$Proxy) o;
