...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.CronJobSpecJobTemplateSpecTemplateSpecVolumeEmptyDir")
@software.amazon.jsii.Jsii.Proxy(CronJobSpecJobTemplateSpecTemplateSpecVolumeEmptyDir.Jsii$Proxy.class)
public interface CronJobSpecJobTemplateSpecTemplateSpecVolumeEmptyDir extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link CronJobSpecJobTemplateSpecTemplateSpecVolumeEmptyDir}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link CronJobSpecJobTemplateSpecTemplateSpecVolumeEmptyDir}
     */
    public static final class Builder implements software.amazon.jsii.Builder<CronJobSpecJobTemplateSpecTemplateSpecVolumeEmptyDir> {
        java.lang.String medium;
        java.lang.String sizeLimit;

        /**
         * Sets the value of {@link CronJobSpecJobTemplateSpecTemplateSpecVolumeEmptyDir#getMedium}
        ...
        /**
         * Sets the value of {@link CronJobSpecJobTemplateSpecTemplateSpecVolumeEmptyDir#getSizeLimit}
         ...
         * @return a new instance of {@link CronJobSpecJobTemplateSpecTemplateSpecVolumeEmptyDir}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public CronJobSpecJobTemplateSpecTemplateSpecVolumeEmptyDir build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link CronJobSpecJobTemplateSpecTemplateSpecVolumeEmptyDir}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CronJobSpecJobTemplateSpecTemplateSpecVolumeEmptyDir {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.CronJobSpecJobTemplateSpecTemplateSpecVolumeEmptyDir"));
        ...
        public final boolean equals(final Object o) {
            ...
            CronJobSpecJobTemplateSpecTemplateSpecVolumeEmptyDir.Jsii$Proxy that = (CronJobSpecJobTemplateSpecTemplateSpecVolumeEmptyDir.Jsii$Proxy) o;
