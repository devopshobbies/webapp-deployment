...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PersistentVolumeSpecPersistentVolumeSourceGlusterfs")
@software.amazon.jsii.Jsii.Proxy(PersistentVolumeSpecPersistentVolumeSourceGlusterfs.Jsii$Proxy.class)
public interface PersistentVolumeSpecPersistentVolumeSourceGlusterfs extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link PersistentVolumeSpecPersistentVolumeSourceGlusterfs}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link PersistentVolumeSpecPersistentVolumeSourceGlusterfs}
     */
    public static final class Builder implements software.amazon.jsii.Builder<PersistentVolumeSpecPersistentVolumeSourceGlusterfs> {
        java.lang.String endpointsName;
        java.lang.String path;
        java.lang.Object readOnly;

        /**
         * Sets the value of {@link PersistentVolumeSpecPersistentVolumeSourceGlusterfs#getEndpointsName}
        ...
        /**
         * Sets the value of {@link PersistentVolumeSpecPersistentVolumeSourceGlusterfs#getPath}
        ...
        /**
         * Sets the value of {@link PersistentVolumeSpecPersistentVolumeSourceGlusterfs#getReadOnly}
         ...
         * @return a new instance of {@link PersistentVolumeSpecPersistentVolumeSourceGlusterfs}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public PersistentVolumeSpecPersistentVolumeSourceGlusterfs build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link PersistentVolumeSpecPersistentVolumeSourceGlusterfs}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PersistentVolumeSpecPersistentVolumeSourceGlusterfs {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.PersistentVolumeSpecPersistentVolumeSourceGlusterfs"));
        ...
        public final boolean equals(final Object o) {
            ...
            PersistentVolumeSpecPersistentVolumeSourceGlusterfs.Jsii$Proxy that = (PersistentVolumeSpecPersistentVolumeSourceGlusterfs.Jsii$Proxy) o;
