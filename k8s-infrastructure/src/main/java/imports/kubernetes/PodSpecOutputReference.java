...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:40.372Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PodSpecOutputReference")
public class PodSpecOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected PodSpecOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected PodSpecOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public PodSpecOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(terraformResource, "terraformResource is required"), java.util.Objects.requireNonNull(terraformAttribute, "terraformAttribute is required") });
    }

    public void putAffinity(final @org.jetbrains.annotations.NotNull imports.kubernetes.PodSpecAffinity value) {
    ...
    public void putDnsConfig(final @org.jetbrains.annotations.NotNull imports.kubernetes.PodSpecDnsConfig value) {
    ...
    public void putSecurityContext(final @org.jetbrains.annotations.NotNull imports.kubernetes.PodSpecSecurityContext value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.kubernetes.PodSpecAffinityOutputReference getAffinity() {
        return software.amazon.jsii.Kernel.get(this, "affinity", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecAffinityOutputReference.class));
    }

    public @org.jetbrains.annotations.NotNull imports.kubernetes.PodSpecContainerList getContainer() {
        return software.amazon.jsii.Kernel.get(this, "container", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecContainerList.class));
    }

    public @org.jetbrains.annotations.NotNull imports.kubernetes.PodSpecDnsConfigOutputReference getDnsConfig() {
        return software.amazon.jsii.Kernel.get(this, "dnsConfig", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecDnsConfigOutputReference.class));
    }

    public @org.jetbrains.annotations.NotNull imports.kubernetes.PodSpecHostAliasesList getHostAliases() {
        return software.amazon.jsii.Kernel.get(this, "hostAliases", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecHostAliasesList.class));
    }

    public @org.jetbrains.annotations.NotNull imports.kubernetes.PodSpecImagePullSecretsList getImagePullSecrets() {
        return software.amazon.jsii.Kernel.get(this, "imagePullSecrets", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecImagePullSecretsList.class));
    }

    public @org.jetbrains.annotations.NotNull imports.kubernetes.PodSpecInitContainerList getInitContainer() {
        return software.amazon.jsii.Kernel.get(this, "initContainer", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecInitContainerList.class));
    }

    public @org.jetbrains.annotations.NotNull imports.kubernetes.PodSpecReadinessGateList getReadinessGate() {
        return software.amazon.jsii.Kernel.get(this, "readinessGate", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecReadinessGateList.class));
    }

    public @org.jetbrains.annotations.NotNull imports.kubernetes.PodSpecSecurityContextOutputReference getSecurityContext() {
        return software.amazon.jsii.Kernel.get(this, "securityContext", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecSecurityContextOutputReference.class));
    }

    public @org.jetbrains.annotations.NotNull imports.kubernetes.PodSpecTolerationList getToleration() {
        return software.amazon.jsii.Kernel.get(this, "toleration", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecTolerationList.class));
    }

    public @org.jetbrains.annotations.NotNull imports.kubernetes.PodSpecTopologySpreadConstraintList getTopologySpreadConstraint() {
        return software.amazon.jsii.Kernel.get(this, "topologySpreadConstraint", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecTopologySpreadConstraintList.class));
    }

    public @org.jetbrains.annotations.NotNull imports.kubernetes.PodSpecVolumeList getVolume() {
        return software.amazon.jsii.Kernel.get(this, "volume", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecVolumeList.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.kubernetes.PodSpecAffinity getAffinityInput() {
        return software.amazon.jsii.Kernel.get(this, "affinityInput", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecAffinity.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.kubernetes.PodSpecDnsConfig getDnsConfigInput() {
        return software.amazon.jsii.Kernel.get(this, "dnsConfigInput", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecDnsConfig.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.kubernetes.PodSpecSecurityContext getSecurityContextInput() {
        return software.amazon.jsii.Kernel.get(this, "securityContextInput", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecSecurityContext.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.kubernetes.PodSpec getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpec.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.PodSpec value) {
