...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:40.354Z")
...
public interface PodSpecInitContainerEnvValueFrom extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.PodSpecInitContainerEnvValueFromConfigMapKeyRef getConfigMapKeyRef() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.PodSpecInitContainerEnvValueFromFieldRef getFieldRef() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.PodSpecInitContainerEnvValueFromResourceFieldRef getResourceFieldRef() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.PodSpecInitContainerEnvValueFromSecretKeyRef getSecretKeyRef() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<PodSpecInitContainerEnvValueFrom> {
        imports.kubernetes.PodSpecInitContainerEnvValueFromConfigMapKeyRef configMapKeyRef;
        imports.kubernetes.PodSpecInitContainerEnvValueFromFieldRef fieldRef;
        imports.kubernetes.PodSpecInitContainerEnvValueFromResourceFieldRef resourceFieldRef;
         ...
         * @return {@code this}
         */
        public Builder configMapKeyRef(imports.kubernetes.PodSpecInitContainerEnvValueFromConfigMapKeyRef configMapKeyRef) {
         ...
         * @return {@code this}
         */
        public Builder fieldRef(imports.kubernetes.PodSpecInitContainerEnvValueFromFieldRef fieldRef) {
         ...
         * @return {@code this}
         */
        public Builder resourceFieldRef(imports.kubernetes.PodSpecInitContainerEnvValueFromResourceFieldRef resourceFieldRef) {
         ...
         * @return {@code this}
         */
        public Builder secretKeyRef(imports.kubernetes.PodSpecInitContainerEnvValueFromSecretKeyRef secretKeyRef) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodSpecInitContainerEnvValueFrom {
        private final imports.kubernetes.PodSpecInitContainerEnvValueFromConfigMapKeyRef configMapKeyRef;
        private final imports.kubernetes.PodSpecInitContainerEnvValueFromFieldRef fieldRef;
        private final imports.kubernetes.PodSpecInitContainerEnvValueFromResourceFieldRef resourceFieldRef;
        private final imports.kubernetes.PodSpecInitContainerEnvValueFromSecretKeyRef secretKeyRef;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.configMapKeyRef = software.amazon.jsii.Kernel.get(this, "configMapKeyRef", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecInitContainerEnvValueFromConfigMapKeyRef.class));
            this.fieldRef = software.amazon.jsii.Kernel.get(this, "fieldRef", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecInitContainerEnvValueFromFieldRef.class));
            this.resourceFieldRef = software.amazon.jsii.Kernel.get(this, "resourceFieldRef", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecInitContainerEnvValueFromResourceFieldRef.class));
            this.secretKeyRef = software.amazon.jsii.Kernel.get(this, "secretKeyRef", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecInitContainerEnvValueFromSecretKeyRef.class));
        }
        ...
        @Override
        public final imports.kubernetes.PodSpecInitContainerEnvValueFromConfigMapKeyRef getConfigMapKeyRef() {
            return this.configMapKeyRef;
        }

        @Override
        public final imports.kubernetes.PodSpecInitContainerEnvValueFromFieldRef getFieldRef() {
            return this.fieldRef;
        }

        @Override
        public final imports.kubernetes.PodSpecInitContainerEnvValueFromResourceFieldRef getResourceFieldRef() {
            return this.resourceFieldRef;
        }

        @Override
        public final imports.kubernetes.PodSpecInitContainerEnvValueFromSecretKeyRef getSecretKeyRef() {
