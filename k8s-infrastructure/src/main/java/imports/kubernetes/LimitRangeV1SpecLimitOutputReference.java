...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.LimitRangeV1SpecLimitOutputReference")
public class LimitRangeV1SpecLimitOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected LimitRangeV1SpecLimitOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected LimitRangeV1SpecLimitOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.LimitRangeV1SpecLimit value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
