...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DeploymentSpecSelectorMatchExpressions")
@software.amazon.jsii.Jsii.Proxy(DeploymentSpecSelectorMatchExpressions.Jsii$Proxy.class)
public interface DeploymentSpecSelectorMatchExpressions extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DeploymentSpecSelectorMatchExpressions}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DeploymentSpecSelectorMatchExpressions}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DeploymentSpecSelectorMatchExpressions> {
        java.lang.String key;
        java.lang.String operator;
        java.util.List<java.lang.String> values;

        /**
         * Sets the value of {@link DeploymentSpecSelectorMatchExpressions#getKey}
        ...
        /**
         * Sets the value of {@link DeploymentSpecSelectorMatchExpressions#getOperator}
        ...
        /**
         * Sets the value of {@link DeploymentSpecSelectorMatchExpressions#getValues}
         ...
         * @return a new instance of {@link DeploymentSpecSelectorMatchExpressions}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DeploymentSpecSelectorMatchExpressions build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DeploymentSpecSelectorMatchExpressions}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DeploymentSpecSelectorMatchExpressions {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DeploymentSpecSelectorMatchExpressions"));
        ...
        public final boolean equals(final Object o) {
            ...
            DeploymentSpecSelectorMatchExpressions.Jsii$Proxy that = (DeploymentSpecSelectorMatchExpressions.Jsii$Proxy) o;
