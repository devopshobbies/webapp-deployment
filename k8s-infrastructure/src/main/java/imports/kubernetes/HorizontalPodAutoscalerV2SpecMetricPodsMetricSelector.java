...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:39.904Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.HorizontalPodAutoscalerV2SpecMetricPodsMetricSelector")
@software.amazon.jsii.Jsii.Proxy(HorizontalPodAutoscalerV2SpecMetricPodsMetricSelector.Jsii$Proxy.class)
public interface HorizontalPodAutoscalerV2SpecMetricPodsMetricSelector extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link HorizontalPodAutoscalerV2SpecMetricPodsMetricSelector}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link HorizontalPodAutoscalerV2SpecMetricPodsMetricSelector}
     */
    public static final class Builder implements software.amazon.jsii.Builder<HorizontalPodAutoscalerV2SpecMetricPodsMetricSelector> {
        java.lang.Object matchExpressions;
        java.util.Map<java.lang.String, java.lang.String> matchLabels;

        /**
         * Sets the value of {@link HorizontalPodAutoscalerV2SpecMetricPodsMetricSelector#getMatchExpressions}
         ...
         * @return {@code this}
         */
        public Builder matchExpressions(java.util.List<? extends imports.kubernetes.HorizontalPodAutoscalerV2SpecMetricPodsMetricSelectorMatchExpressions> matchExpressions) {
            this.matchExpressions = matchExpressions;
            return this;
        }

        /**
         * Sets the value of {@link HorizontalPodAutoscalerV2SpecMetricPodsMetricSelector#getMatchLabels}
         ...
         * @return a new instance of {@link HorizontalPodAutoscalerV2SpecMetricPodsMetricSelector}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public HorizontalPodAutoscalerV2SpecMetricPodsMetricSelector build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link HorizontalPodAutoscalerV2SpecMetricPodsMetricSelector}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements HorizontalPodAutoscalerV2SpecMetricPodsMetricSelector {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.HorizontalPodAutoscalerV2SpecMetricPodsMetricSelector"));
        ...
        public final boolean equals(final Object o) {
            ...
            HorizontalPodAutoscalerV2SpecMetricPodsMetricSelector.Jsii$Proxy that = (HorizontalPodAutoscalerV2SpecMetricPodsMetricSelector.Jsii$Proxy) o;
