...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:40.347Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PodSpecContainerSecurityContextCapabilities")
@software.amazon.jsii.Jsii.Proxy(PodSpecContainerSecurityContextCapabilities.Jsii$Proxy.class)
public interface PodSpecContainerSecurityContextCapabilities extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link PodSpecContainerSecurityContextCapabilities}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link PodSpecContainerSecurityContextCapabilities}
     */
    public static final class Builder implements software.amazon.jsii.Builder<PodSpecContainerSecurityContextCapabilities> {
        java.util.List<java.lang.String> add;
        java.util.List<java.lang.String> drop;

        /**
         * Sets the value of {@link PodSpecContainerSecurityContextCapabilities#getAdd}
        ...
        /**
         * Sets the value of {@link PodSpecContainerSecurityContextCapabilities#getDrop}
         ...
         * @return a new instance of {@link PodSpecContainerSecurityContextCapabilities}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public PodSpecContainerSecurityContextCapabilities build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link PodSpecContainerSecurityContextCapabilities}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodSpecContainerSecurityContextCapabilities {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.PodSpecContainerSecurityContextCapabilities"));
        ...
        public final boolean equals(final Object o) {
            ...
            PodSpecContainerSecurityContextCapabilities.Jsii$Proxy that = (PodSpecContainerSecurityContextCapabilities.Jsii$Proxy) o;
