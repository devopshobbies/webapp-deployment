...
public interface StatefulSetSpecTemplate extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull imports.kubernetes.StatefulSetSpecTemplateMetadata getMetadata();
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.StatefulSetSpecTemplateSpec getSpec() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<StatefulSetSpecTemplate> {
        imports.kubernetes.StatefulSetSpecTemplateMetadata metadata;
        imports.kubernetes.StatefulSetSpecTemplateSpec spec;
         ...
         * @return {@code this}
         */
        public Builder metadata(imports.kubernetes.StatefulSetSpecTemplateMetadata metadata) {
         ...
         * @return {@code this}
         */
        public Builder spec(imports.kubernetes.StatefulSetSpecTemplateSpec spec) {
            this.spec = spec;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements StatefulSetSpecTemplate {
        private final imports.kubernetes.StatefulSetSpecTemplateMetadata metadata;
        private final imports.kubernetes.StatefulSetSpecTemplateSpec spec;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.metadata = software.amazon.jsii.Kernel.get(this, "metadata", software.amazon.jsii.NativeType.forClass(imports.kubernetes.StatefulSetSpecTemplateMetadata.class));
            this.spec = software.amazon.jsii.Kernel.get(this, "spec", software.amazon.jsii.NativeType.forClass(imports.kubernetes.StatefulSetSpecTemplateSpec.class));
        }
        ...
        @Override
        public final imports.kubernetes.StatefulSetSpecTemplateMetadata getMetadata() {
            return this.metadata;
        }

        @Override
        public final imports.kubernetes.StatefulSetSpecTemplateSpec getSpec() {
            return this.spec;
        }
