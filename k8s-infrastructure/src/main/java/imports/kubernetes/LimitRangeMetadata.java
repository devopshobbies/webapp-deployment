...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.LimitRangeMetadata")
@software.amazon.jsii.Jsii.Proxy(LimitRangeMetadata.Jsii$Proxy.class)
public interface LimitRangeMetadata extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link LimitRangeMetadata}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link LimitRangeMetadata}
     */
    public static final class Builder implements software.amazon.jsii.Builder<LimitRangeMetadata> {
        ...
        /**
         * Sets the value of {@link LimitRangeMetadata#getAnnotations}
         * @param annotations An unstructured key value map stored with the limit range that may be used to store arbitrary metadata.
         *                    More info: http://kubernetes.io/docs/user-guide/annotations
         *                    <p>
         *                    Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/limit_range#annotations LimitRange#annotations}
         * @return {@code this}
        ...
        /**
         * Sets the value of {@link LimitRangeMetadata#getGenerateName}
        ...
        /**
         * Sets the value of {@link LimitRangeMetadata#getLabels}
         * @param labels Map of string keys and values that can be used to organize and categorize (scope and select) the limit range.
         *               May match selectors of replication controllers and services. More info: http://kubernetes.io/docs/user-guide/labels
         *               <p>
         *               Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/limit_range#labels LimitRange#labels}
         * @return {@code this}
        ...
        /**
         * Sets the value of {@link LimitRangeMetadata#getName}
         * @param name Name of the limit range, must be unique. Cannot be updated. More info: http://kubernetes.io/docs/user-guide/identifiers#names.
         *             Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/limit_range#name LimitRange#name}
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link LimitRangeMetadata#getNamespace}
         * @param namespace Namespace defines the space within which name of the limit range must be unique.
         *                  Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/limit_range#namespace LimitRange#namespace}
         * @return {@code this}
         */
         ...
         * @return a new instance of {@link LimitRangeMetadata}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public LimitRangeMetadata build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link LimitRangeMetadata}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements LimitRangeMetadata {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.LimitRangeMetadata"));
        ...
        public final boolean equals(final Object o) {
            ...
            LimitRangeMetadata.Jsii$Proxy that = (LimitRangeMetadata.Jsii$Proxy) o;
