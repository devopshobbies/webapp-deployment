...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.MutatingWebhookConfigurationV1WebhookRuleOutputReference")
public class MutatingWebhookConfigurationV1WebhookRuleOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected MutatingWebhookConfigurationV1WebhookRuleOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected MutatingWebhookConfigurationV1WebhookRuleOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.MutatingWebhookConfigurationV1WebhookRule value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
