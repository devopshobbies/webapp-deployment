...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.JobSpecTemplateSpecVolumeProjectedSourcesDownwardApiItemsResourceFieldRef")
@software.amazon.jsii.Jsii.Proxy(JobSpecTemplateSpecVolumeProjectedSourcesDownwardApiItemsResourceFieldRef.Jsii$Proxy.class)
public interface JobSpecTemplateSpecVolumeProjectedSourcesDownwardApiItemsResourceFieldRef extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link JobSpecTemplateSpecVolumeProjectedSourcesDownwardApiItemsResourceFieldRef}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link JobSpecTemplateSpecVolumeProjectedSourcesDownwardApiItemsResourceFieldRef}
     */
    public static final class Builder implements software.amazon.jsii.Builder<JobSpecTemplateSpecVolumeProjectedSourcesDownwardApiItemsResourceFieldRef> {
        java.lang.String containerName;
        java.lang.String resource;
        java.lang.String divisor;

        /**
         * Sets the value of {@link JobSpecTemplateSpecVolumeProjectedSourcesDownwardApiItemsResourceFieldRef#getContainerName}
         * @param containerName Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/r/job#container_name Job#container_name}. This parameter is required.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link JobSpecTemplateSpecVolumeProjectedSourcesDownwardApiItemsResourceFieldRef#getResource}
        ...
        /**
         * Sets the value of {@link JobSpecTemplateSpecVolumeProjectedSourcesDownwardApiItemsResourceFieldRef#getDivisor}
         ...
         * @return a new instance of {@link JobSpecTemplateSpecVolumeProjectedSourcesDownwardApiItemsResourceFieldRef}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public JobSpecTemplateSpecVolumeProjectedSourcesDownwardApiItemsResourceFieldRef build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link JobSpecTemplateSpecVolumeProjectedSourcesDownwardApiItemsResourceFieldRef}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements JobSpecTemplateSpecVolumeProjectedSourcesDownwardApiItemsResourceFieldRef {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.JobSpecTemplateSpecVolumeProjectedSourcesDownwardApiItemsResourceFieldRef"));
        ...
        public final boolean equals(final Object o) {
            ...
            JobSpecTemplateSpecVolumeProjectedSourcesDownwardApiItemsResourceFieldRef.Jsii$Proxy that = (JobSpecTemplateSpecVolumeProjectedSourcesDownwardApiItemsResourceFieldRef.Jsii$Proxy) o;
