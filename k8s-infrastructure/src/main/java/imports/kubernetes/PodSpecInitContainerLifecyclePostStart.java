...
public interface PodSpecInitContainerLifecyclePostStart extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.PodSpecInitContainerLifecyclePostStartExec getExec() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.PodSpecInitContainerLifecyclePostStartHttpGet getHttpGet() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<PodSpecInitContainerLifecyclePostStart> {
        imports.kubernetes.PodSpecInitContainerLifecyclePostStartExec exec;
        imports.kubernetes.PodSpecInitContainerLifecyclePostStartHttpGet httpGet;
         ...
         * @return {@code this}
         */
        public Builder exec(imports.kubernetes.PodSpecInitContainerLifecyclePostStartExec exec) {
            this.exec = exec;
            return this;
        }
         ...
         * @return {@code this}
         */
        public Builder httpGet(imports.kubernetes.PodSpecInitContainerLifecyclePostStartHttpGet httpGet) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodSpecInitContainerLifecyclePostStart {
        private final imports.kubernetes.PodSpecInitContainerLifecyclePostStartExec exec;
        private final imports.kubernetes.PodSpecInitContainerLifecyclePostStartHttpGet httpGet;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.exec = software.amazon.jsii.Kernel.get(this, "exec", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecInitContainerLifecyclePostStartExec.class));
            this.httpGet = software.amazon.jsii.Kernel.get(this, "httpGet", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecInitContainerLifecyclePostStartHttpGet.class));
        ...
        @Override
        public final imports.kubernetes.PodSpecInitContainerLifecyclePostStartExec getExec() {
            return this.exec;
        }

        @Override
        public final imports.kubernetes.PodSpecInitContainerLifecyclePostStartHttpGet getHttpGet() {
            return this.httpGet;
        }
