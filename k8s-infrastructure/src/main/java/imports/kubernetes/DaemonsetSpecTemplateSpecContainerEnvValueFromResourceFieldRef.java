...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DaemonsetSpecTemplateSpecContainerEnvValueFromResourceFieldRef")
@software.amazon.jsii.Jsii.Proxy(DaemonsetSpecTemplateSpecContainerEnvValueFromResourceFieldRef.Jsii$Proxy.class)
public interface DaemonsetSpecTemplateSpecContainerEnvValueFromResourceFieldRef extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DaemonsetSpecTemplateSpecContainerEnvValueFromResourceFieldRef}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DaemonsetSpecTemplateSpecContainerEnvValueFromResourceFieldRef}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DaemonsetSpecTemplateSpecContainerEnvValueFromResourceFieldRef> {
        java.lang.String resource;
        java.lang.String containerName;
        java.lang.String divisor;

        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecContainerEnvValueFromResourceFieldRef#getResource}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecContainerEnvValueFromResourceFieldRef#getContainerName}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecContainerEnvValueFromResourceFieldRef#getDivisor}
         ...
         * @return a new instance of {@link DaemonsetSpecTemplateSpecContainerEnvValueFromResourceFieldRef}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DaemonsetSpecTemplateSpecContainerEnvValueFromResourceFieldRef build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DaemonsetSpecTemplateSpecContainerEnvValueFromResourceFieldRef}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DaemonsetSpecTemplateSpecContainerEnvValueFromResourceFieldRef {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DaemonsetSpecTemplateSpecContainerEnvValueFromResourceFieldRef"));
        ...
        public final boolean equals(final Object o) {
            ...
            DaemonsetSpecTemplateSpecContainerEnvValueFromResourceFieldRef.Jsii$Proxy that = (DaemonsetSpecTemplateSpecContainerEnvValueFromResourceFieldRef.Jsii$Proxy) o;
