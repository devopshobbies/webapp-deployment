...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:40.375Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PodSpecTopologySpreadConstraintLabelSelector")
@software.amazon.jsii.Jsii.Proxy(PodSpecTopologySpreadConstraintLabelSelector.Jsii$Proxy.class)
public interface PodSpecTopologySpreadConstraintLabelSelector extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link PodSpecTopologySpreadConstraintLabelSelector}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link PodSpecTopologySpreadConstraintLabelSelector}
     */
    public static final class Builder implements software.amazon.jsii.Builder<PodSpecTopologySpreadConstraintLabelSelector> {
        java.lang.Object matchExpressions;
        java.util.Map<java.lang.String, java.lang.String> matchLabels;

        /**
         * Sets the value of {@link PodSpecTopologySpreadConstraintLabelSelector#getMatchExpressions}
         ...
         * @return {@code this}
         */
        public Builder matchExpressions(java.util.List<? extends imports.kubernetes.PodSpecTopologySpreadConstraintLabelSelectorMatchExpressions> matchExpressions) {
            this.matchExpressions = matchExpressions;
            return this;
        }

        /**
         * Sets the value of {@link PodSpecTopologySpreadConstraintLabelSelector#getMatchLabels}
         ...
         * @return a new instance of {@link PodSpecTopologySpreadConstraintLabelSelector}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public PodSpecTopologySpreadConstraintLabelSelector build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link PodSpecTopologySpreadConstraintLabelSelector}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodSpecTopologySpreadConstraintLabelSelector {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.PodSpecTopologySpreadConstraintLabelSelector"));
        ...
        public final boolean equals(final Object o) {
            ...
            PodSpecTopologySpreadConstraintLabelSelector.Jsii$Proxy that = (PodSpecTopologySpreadConstraintLabelSelector.Jsii$Proxy) o;
