...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:39.651Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DeploymentSpecTemplateSpecContainerStartupProbe")
@software.amazon.jsii.Jsii.Proxy(DeploymentSpecTemplateSpecContainerStartupProbe.Jsii$Proxy.class)
public interface DeploymentSpecTemplateSpecContainerStartupProbe extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.DeploymentSpecTemplateSpecContainerStartupProbeExec getExec() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.DeploymentSpecTemplateSpecContainerStartupProbeHttpGet getHttpGet() {
        return null;
    }
    ...
    /**
     * @return a {@link Builder} of {@link DeploymentSpecTemplateSpecContainerStartupProbe}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DeploymentSpecTemplateSpecContainerStartupProbe}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DeploymentSpecTemplateSpecContainerStartupProbe> {
        imports.kubernetes.DeploymentSpecTemplateSpecContainerStartupProbeExec exec;
        java.lang.Number failureThreshold;
        imports.kubernetes.DeploymentSpecTemplateSpecContainerStartupProbeHttpGet httpGet;
        ...
        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecContainerStartupProbe#getExec}
         * @param exec exec block.
         *             Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/deployment#exec Deployment#exec}
         * @return {@code this}
         */
        public Builder exec(imports.kubernetes.DeploymentSpecTemplateSpecContainerStartupProbeExec exec) {
            this.exec = exec;
            return this;
        }

        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecContainerStartupProbe#getFailureThreshold}
        ...
        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecContainerStartupProbe#getHttpGet}
         * @param httpGet http_get block.
         *                Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/deployment#http_get Deployment#http_get}
         * @return {@code this}
         */
        public Builder httpGet(imports.kubernetes.DeploymentSpecTemplateSpecContainerStartupProbeHttpGet httpGet) {
            this.httpGet = httpGet;
            return this;
        }

        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecContainerStartupProbe#getInitialDelaySeconds}
        ...
        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecContainerStartupProbe#getPeriodSeconds}
        ...
        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecContainerStartupProbe#getSuccessThreshold}
        ...
        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecContainerStartupProbe#getTcpSocket}
         ...
         * @return {@code this}
         */
        public Builder tcpSocket(java.util.List<? extends imports.kubernetes.DeploymentSpecTemplateSpecContainerStartupProbeTcpSocket> tcpSocket) {
            this.tcpSocket = tcpSocket;
            return this;
        }

        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecContainerStartupProbe#getTimeoutSeconds}
         ...
         * @return a new instance of {@link DeploymentSpecTemplateSpecContainerStartupProbe}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DeploymentSpecTemplateSpecContainerStartupProbe build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DeploymentSpecTemplateSpecContainerStartupProbe}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DeploymentSpecTemplateSpecContainerStartupProbe {
        private final imports.kubernetes.DeploymentSpecTemplateSpecContainerStartupProbeExec exec;
        private final java.lang.Number failureThreshold;
        private final imports.kubernetes.DeploymentSpecTemplateSpecContainerStartupProbeHttpGet httpGet;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.exec = software.amazon.jsii.Kernel.get(this, "exec", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DeploymentSpecTemplateSpecContainerStartupProbeExec.class));
            ...
            this.httpGet = software.amazon.jsii.Kernel.get(this, "httpGet", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DeploymentSpecTemplateSpecContainerStartupProbeHttpGet.class));
        ...
        @Override
        public final imports.kubernetes.DeploymentSpecTemplateSpecContainerStartupProbeExec getExec() {
            return this.exec;
        }
        ...
        @Override
        public final imports.kubernetes.DeploymentSpecTemplateSpecContainerStartupProbeHttpGet getHttpGet() {
            return this.httpGet;
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DeploymentSpecTemplateSpecContainerStartupProbe"));
        ...
        public final boolean equals(final Object o) {
            ...
            DeploymentSpecTemplateSpecContainerStartupProbe.Jsii$Proxy that = (DeploymentSpecTemplateSpecContainerStartupProbe.Jsii$Proxy) o;
