...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.NetworkPolicyV1SpecEgress")
@software.amazon.jsii.Jsii.Proxy(NetworkPolicyV1SpecEgress.Jsii$Proxy.class)
public interface NetworkPolicyV1SpecEgress extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link NetworkPolicyV1SpecEgress}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link NetworkPolicyV1SpecEgress}
     */
    public static final class Builder implements software.amazon.jsii.Builder<NetworkPolicyV1SpecEgress> {
        ...
        /**
         * Sets the value of {@link NetworkPolicyV1SpecEgress#getPorts}
         ...
         * @return {@code this}
         */
        public Builder ports(java.util.List<? extends imports.kubernetes.NetworkPolicyV1SpecEgressPorts> ports) {
            this.ports = ports;
            return this;
        }

        /**
         * Sets the value of {@link NetworkPolicyV1SpecEgress#getTo}
         * @param to to block.
         *           Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/network_policy_v1#to NetworkPolicyV1#to}
         * @return {@code this}
         */
         ...
         * @return {@code this}
         */
        public Builder to(java.util.List<? extends imports.kubernetes.NetworkPolicyV1SpecEgressTo> to) {
            this.to = to;
            return this;
        }
         ...
         * @return a new instance of {@link NetworkPolicyV1SpecEgress}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public NetworkPolicyV1SpecEgress build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link NetworkPolicyV1SpecEgress}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements NetworkPolicyV1SpecEgress {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.NetworkPolicyV1SpecEgress"));
        ...
        public final boolean equals(final Object o) {
            ...
            NetworkPolicyV1SpecEgress.Jsii$Proxy that = (NetworkPolicyV1SpecEgress.Jsii$Proxy) o;
