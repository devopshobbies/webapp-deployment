...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DaemonSetV1SpecTemplateSpecInitContainerReadinessProbeTcpSocketList")
public class DaemonSetV1SpecTemplateSpecInitContainerReadinessProbeTcpSocketList extends com.hashicorp.cdktf.ComplexList {

    protected DaemonSetV1SpecTemplateSpecInitContainerReadinessProbeTcpSocketList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DaemonSetV1SpecTemplateSpecInitContainerReadinessProbeTcpSocketList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.kubernetes.DaemonSetV1SpecTemplateSpecInitContainerReadinessProbeTcpSocketOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DaemonSetV1SpecTemplateSpecInitContainerReadinessProbeTcpSocketOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.DaemonSetV1SpecTemplateSpecInitContainerReadinessProbeTcpSocket> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
