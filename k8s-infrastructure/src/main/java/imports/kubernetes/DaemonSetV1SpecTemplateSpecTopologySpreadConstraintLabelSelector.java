...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:39.242Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DaemonSetV1SpecTemplateSpecTopologySpreadConstraintLabelSelector")
@software.amazon.jsii.Jsii.Proxy(DaemonSetV1SpecTemplateSpecTopologySpreadConstraintLabelSelector.Jsii$Proxy.class)
public interface DaemonSetV1SpecTemplateSpecTopologySpreadConstraintLabelSelector extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DaemonSetV1SpecTemplateSpecTopologySpreadConstraintLabelSelector}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DaemonSetV1SpecTemplateSpecTopologySpreadConstraintLabelSelector}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DaemonSetV1SpecTemplateSpecTopologySpreadConstraintLabelSelector> {
        java.lang.Object matchExpressions;
        java.util.Map<java.lang.String, java.lang.String> matchLabels;

        /**
         * Sets the value of {@link DaemonSetV1SpecTemplateSpecTopologySpreadConstraintLabelSelector#getMatchExpressions}
         ...
         * @return {@code this}
         */
        public Builder matchExpressions(java.util.List<? extends imports.kubernetes.DaemonSetV1SpecTemplateSpecTopologySpreadConstraintLabelSelectorMatchExpressions> matchExpressions) {
            this.matchExpressions = matchExpressions;
            return this;
        }

        /**
         * Sets the value of {@link DaemonSetV1SpecTemplateSpecTopologySpreadConstraintLabelSelector#getMatchLabels}
         ...
         * @return a new instance of {@link DaemonSetV1SpecTemplateSpecTopologySpreadConstraintLabelSelector}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DaemonSetV1SpecTemplateSpecTopologySpreadConstraintLabelSelector build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DaemonSetV1SpecTemplateSpecTopologySpreadConstraintLabelSelector}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DaemonSetV1SpecTemplateSpecTopologySpreadConstraintLabelSelector {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DaemonSetV1SpecTemplateSpecTopologySpreadConstraintLabelSelector"));
        ...
        public final boolean equals(final Object o) {
            ...
            DaemonSetV1SpecTemplateSpecTopologySpreadConstraintLabelSelector.Jsii$Proxy that = (DaemonSetV1SpecTemplateSpecTopologySpreadConstraintLabelSelector.Jsii$Proxy) o;
