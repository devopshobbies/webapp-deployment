...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DeploymentSpecTemplateSpecHostAliases")
@software.amazon.jsii.Jsii.Proxy(DeploymentSpecTemplateSpecHostAliases.Jsii$Proxy.class)
public interface DeploymentSpecTemplateSpecHostAliases extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DeploymentSpecTemplateSpecHostAliases}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DeploymentSpecTemplateSpecHostAliases}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DeploymentSpecTemplateSpecHostAliases> {
        java.util.List<java.lang.String> hostnames;
        java.lang.String ip;

        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecHostAliases#getHostnames}
        ...
        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecHostAliases#getIp}
         ...
         * @return a new instance of {@link DeploymentSpecTemplateSpecHostAliases}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DeploymentSpecTemplateSpecHostAliases build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DeploymentSpecTemplateSpecHostAliases}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DeploymentSpecTemplateSpecHostAliases {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DeploymentSpecTemplateSpecHostAliases"));
        ...
        public final boolean equals(final Object o) {
            ...
            DeploymentSpecTemplateSpecHostAliases.Jsii$Proxy that = (DeploymentSpecTemplateSpecHostAliases.Jsii$Proxy) o;
