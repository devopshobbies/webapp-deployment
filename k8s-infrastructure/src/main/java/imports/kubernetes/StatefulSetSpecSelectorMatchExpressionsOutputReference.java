...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.StatefulSetSpecSelectorMatchExpressionsOutputReference")
public class StatefulSetSpecSelectorMatchExpressionsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected StatefulSetSpecSelectorMatchExpressionsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected StatefulSetSpecSelectorMatchExpressionsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.StatefulSetSpecSelectorMatchExpressions value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
