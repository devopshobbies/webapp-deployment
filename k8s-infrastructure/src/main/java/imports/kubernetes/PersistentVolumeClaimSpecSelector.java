...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PersistentVolumeClaimSpecSelector")
@software.amazon.jsii.Jsii.Proxy(PersistentVolumeClaimSpecSelector.Jsii$Proxy.class)
public interface PersistentVolumeClaimSpecSelector extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link PersistentVolumeClaimSpecSelector}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link PersistentVolumeClaimSpecSelector}
     */
    public static final class Builder implements software.amazon.jsii.Builder<PersistentVolumeClaimSpecSelector> {
        java.lang.Object matchExpressions;
        java.util.Map<java.lang.String, java.lang.String> matchLabels;

        /**
         * Sets the value of {@link PersistentVolumeClaimSpecSelector#getMatchExpressions}
         ...
         * @return {@code this}
         */
        public Builder matchExpressions(java.util.List<? extends imports.kubernetes.PersistentVolumeClaimSpecSelectorMatchExpressions> matchExpressions) {
            this.matchExpressions = matchExpressions;
            return this;
        }

        /**
         * Sets the value of {@link PersistentVolumeClaimSpecSelector#getMatchLabels}
         ...
         * @return a new instance of {@link PersistentVolumeClaimSpecSelector}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public PersistentVolumeClaimSpecSelector build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link PersistentVolumeClaimSpecSelector}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PersistentVolumeClaimSpecSelector {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.PersistentVolumeClaimSpecSelector"));
        ...
        public final boolean equals(final Object o) {
            ...
            PersistentVolumeClaimSpecSelector.Jsii$Proxy that = (PersistentVolumeClaimSpecSelector.Jsii$Proxy) o;
