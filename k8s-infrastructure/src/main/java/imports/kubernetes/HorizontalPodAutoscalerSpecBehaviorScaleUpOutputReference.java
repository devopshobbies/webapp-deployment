...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.HorizontalPodAutoscalerSpecBehaviorScaleUpOutputReference")
public class HorizontalPodAutoscalerSpecBehaviorScaleUpOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected HorizontalPodAutoscalerSpecBehaviorScaleUpOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected HorizontalPodAutoscalerSpecBehaviorScaleUpOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public @org.jetbrains.annotations.NotNull imports.kubernetes.HorizontalPodAutoscalerSpecBehaviorScaleUpPolicyList getPolicy() {
        return software.amazon.jsii.Kernel.get(this, "policy", software.amazon.jsii.NativeType.forClass(imports.kubernetes.HorizontalPodAutoscalerSpecBehaviorScaleUpPolicyList.class));
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.HorizontalPodAutoscalerSpecBehaviorScaleUp value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
