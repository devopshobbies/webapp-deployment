...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:40.535Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PodV1SpecContainerSecurityContextCapabilities")
@software.amazon.jsii.Jsii.Proxy(PodV1SpecContainerSecurityContextCapabilities.Jsii$Proxy.class)
public interface PodV1SpecContainerSecurityContextCapabilities extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link PodV1SpecContainerSecurityContextCapabilities}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link PodV1SpecContainerSecurityContextCapabilities}
     */
    public static final class Builder implements software.amazon.jsii.Builder<PodV1SpecContainerSecurityContextCapabilities> {
        java.util.List<java.lang.String> add;
        java.util.List<java.lang.String> drop;

        /**
         * Sets the value of {@link PodV1SpecContainerSecurityContextCapabilities#getAdd}
        ...
        /**
         * Sets the value of {@link PodV1SpecContainerSecurityContextCapabilities#getDrop}
         ...
         * @return a new instance of {@link PodV1SpecContainerSecurityContextCapabilities}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public PodV1SpecContainerSecurityContextCapabilities build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link PodV1SpecContainerSecurityContextCapabilities}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodV1SpecContainerSecurityContextCapabilities {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.PodV1SpecContainerSecurityContextCapabilities"));
        ...
        public final boolean equals(final Object o) {
            ...
            PodV1SpecContainerSecurityContextCapabilities.Jsii$Proxy that = (PodV1SpecContainerSecurityContextCapabilities.Jsii$Proxy) o;
