...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.JobV1SpecTemplateSpecContainerStartupProbeTcpSocketList")
public class JobV1SpecTemplateSpecContainerStartupProbeTcpSocketList extends com.hashicorp.cdktf.ComplexList {

    protected JobV1SpecTemplateSpecContainerStartupProbeTcpSocketList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected JobV1SpecTemplateSpecContainerStartupProbeTcpSocketList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.kubernetes.JobV1SpecTemplateSpecContainerStartupProbeTcpSocketOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.kubernetes.JobV1SpecTemplateSpecContainerStartupProbeTcpSocketOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.JobV1SpecTemplateSpecContainerStartupProbeTcpSocket> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
