...
public interface DeploymentConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
     ...
     */
    @org.jetbrains.annotations.NotNull imports.kubernetes.DeploymentMetadata getMetadata();
     ...
     */
    @org.jetbrains.annotations.NotNull imports.kubernetes.DeploymentSpec getSpec();
    ...
    public static final class Builder implements software.amazon.jsii.Builder<DeploymentConfig> {
        imports.kubernetes.DeploymentMetadata metadata;
        imports.kubernetes.DeploymentSpec spec;
        java.lang.String id;
        imports.kubernetes.DeploymentTimeouts timeouts;
         ...
         * @return {@code this}
         */
        public Builder metadata(imports.kubernetes.DeploymentMetadata metadata) {
         ...
         * @return {@code this}
         */
        public Builder spec(imports.kubernetes.DeploymentSpec spec) {
            this.spec = spec;
            return this;
        }

        /**
         * Sets the value of {@link DeploymentConfig#getId}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/r/deployment#id Deployment#id}.
         *           Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2.
         *           If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link DeploymentConfig#getWaitForRollout}
        ...
        /**
         * Sets the value of {@link DeploymentConfig#getConnection}
        ...
        /**
         * Sets the value of {@link DeploymentConfig#getForEach}
        ...
        /**
         * Sets the value of {@link DeploymentConfig#getProvisioners}
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DeploymentConfig {
        private final imports.kubernetes.DeploymentMetadata metadata;
        private final imports.kubernetes.DeploymentSpec spec;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.metadata = software.amazon.jsii.Kernel.get(this, "metadata", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DeploymentMetadata.class));
            this.spec = software.amazon.jsii.Kernel.get(this, "spec", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DeploymentSpec.class));
        ...
        @Override
        public final imports.kubernetes.DeploymentMetadata getMetadata() {
            return this.metadata;
        }

        @Override
        public final imports.kubernetes.DeploymentSpec getSpec() {
            return this.spec;
        }
