 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:40.906Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.ServiceAccountV1")
public class ServiceAccountV1 extends com.hashicorp.cdktf.TerraformResource {

    protected ServiceAccountV1(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected ServiceAccountV1(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.kubernetes.ServiceAccountV1.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public ServiceAccountV1(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.kubernetes.ServiceAccountV1Config config) {
    ...
    public void putMetadata(final @org.jetbrains.annotations.NotNull imports.kubernetes.ServiceAccountV1Metadata value) {
    ...
    public void putTimeouts(final @org.jetbrains.annotations.NotNull imports.kubernetes.ServiceAccountV1Timeouts value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.kubernetes.ServiceAccountV1ImagePullSecretList getImagePullSecret() {
        return software.amazon.jsii.Kernel.get(this, "imagePullSecret", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ServiceAccountV1ImagePullSecretList.class));
    }

    public @org.jetbrains.annotations.NotNull imports.kubernetes.ServiceAccountV1MetadataOutputReference getMetadata() {
        return software.amazon.jsii.Kernel.get(this, "metadata", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ServiceAccountV1MetadataOutputReference.class));
    }

    public @org.jetbrains.annotations.NotNull imports.kubernetes.ServiceAccountV1SecretList getSecret() {
        return software.amazon.jsii.Kernel.get(this, "secret", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ServiceAccountV1SecretList.class));
    }

    public @org.jetbrains.annotations.NotNull imports.kubernetes.ServiceAccountV1TimeoutsOutputReference getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ServiceAccountV1TimeoutsOutputReference.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.kubernetes.ServiceAccountV1Metadata getMetadataInput() {
        return software.amazon.jsii.Kernel.get(this, "metadataInput", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ServiceAccountV1Metadata.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.kubernetes.ServiceAccountV1}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.kubernetes.ServiceAccountV1> {
        /**
        ...
        private final imports.kubernetes.ServiceAccountV1Config.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.kubernetes.ServiceAccountV1Config.Builder();
        }
         ...
         */
        public Builder metadata(final imports.kubernetes.ServiceAccountV1Metadata metadata) {
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/r/service_account_v1#id ServiceAccountV1#id}. This parameter is required.
         */
         ...
         * @param imagePullSecret image_pull_secret block. This parameter is required.
         */
        public Builder imagePullSecret(final java.util.List<? extends imports.kubernetes.ServiceAccountV1ImagePullSecret> imagePullSecret) {
            this.config.imagePullSecret(imagePullSecret);
            return this;
        }
         ...
         * @param secret secret block. This parameter is required.
         */
        public Builder secret(final java.util.List<? extends imports.kubernetes.ServiceAccountV1Secret> secret) {
            this.config.secret(secret);
            return this;
        }
         ...
         */
        public Builder timeouts(final imports.kubernetes.ServiceAccountV1Timeouts timeouts) {
            this.config.timeouts(timeouts);
            return this;
        }

        /**
         * @returns a newly built instance of {@link imports.kubernetes.ServiceAccountV1}.
         */
        @Override
        public imports.kubernetes.ServiceAccountV1 build() {
            return new imports.kubernetes.ServiceAccountV1(
                this.scope,
                this.id,
                this.config.build()
            );
