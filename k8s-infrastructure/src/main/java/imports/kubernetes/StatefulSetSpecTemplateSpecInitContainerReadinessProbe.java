...
public interface StatefulSetSpecTemplateSpecInitContainerReadinessProbe extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.StatefulSetSpecTemplateSpecInitContainerReadinessProbeExec getExec() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.StatefulSetSpecTemplateSpecInitContainerReadinessProbeHttpGet getHttpGet() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<StatefulSetSpecTemplateSpecInitContainerReadinessProbe> {
        imports.kubernetes.StatefulSetSpecTemplateSpecInitContainerReadinessProbeExec exec;
        java.lang.Number failureThreshold;
        imports.kubernetes.StatefulSetSpecTemplateSpecInitContainerReadinessProbeHttpGet httpGet;
         ...
         * @return {@code this}
         */
        public Builder exec(imports.kubernetes.StatefulSetSpecTemplateSpecInitContainerReadinessProbeExec exec) {
            this.exec = exec;
            return this;
        }
         ...
         * @return {@code this}
         */
        public Builder httpGet(imports.kubernetes.StatefulSetSpecTemplateSpecInitContainerReadinessProbeHttpGet httpGet) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements StatefulSetSpecTemplateSpecInitContainerReadinessProbe {
        private final imports.kubernetes.StatefulSetSpecTemplateSpecInitContainerReadinessProbeExec exec;
        private final java.lang.Number failureThreshold;
        private final imports.kubernetes.StatefulSetSpecTemplateSpecInitContainerReadinessProbeHttpGet httpGet;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.exec = software.amazon.jsii.Kernel.get(this, "exec", software.amazon.jsii.NativeType.forClass(imports.kubernetes.StatefulSetSpecTemplateSpecInitContainerReadinessProbeExec.class));
            ...
            this.httpGet = software.amazon.jsii.Kernel.get(this, "httpGet", software.amazon.jsii.NativeType.forClass(imports.kubernetes.StatefulSetSpecTemplateSpecInitContainerReadinessProbeHttpGet.class));
        ...
        @Override
        public final imports.kubernetes.StatefulSetSpecTemplateSpecInitContainerReadinessProbeExec getExec() {
            return this.exec;
        }
        ...
        @Override
        public final imports.kubernetes.StatefulSetSpecTemplateSpecInitContainerReadinessProbeHttpGet getHttpGet() {
            return this.httpGet;
        }
