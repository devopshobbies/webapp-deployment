...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:39.347Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbe")
@software.amazon.jsii.Jsii.Proxy(DaemonsetSpecTemplateSpecInitContainerLivenessProbe.Jsii$Proxy.class)
public interface DaemonsetSpecTemplateSpecInitContainerLivenessProbe extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeExec getExec() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeHttpGet getHttpGet() {
        return null;
    }
    ...
    /**
     * @return a {@link Builder} of {@link DaemonsetSpecTemplateSpecInitContainerLivenessProbe}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DaemonsetSpecTemplateSpecInitContainerLivenessProbe}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DaemonsetSpecTemplateSpecInitContainerLivenessProbe> {
        imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeExec exec;
        java.lang.Number failureThreshold;
        imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeHttpGet httpGet;
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerLivenessProbe#getExec}
         * @param exec exec block.
         *             Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/daemonset#exec Daemonset#exec}
         * @return {@code this}
         */
        public Builder exec(imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeExec exec) {
            this.exec = exec;
            return this;
        }

        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerLivenessProbe#getFailureThreshold}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerLivenessProbe#getHttpGet}
         * @param httpGet http_get block.
         *                Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/daemonset#http_get Daemonset#http_get}
         * @return {@code this}
         */
        public Builder httpGet(imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeHttpGet httpGet) {
            this.httpGet = httpGet;
            return this;
        }

        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerLivenessProbe#getInitialDelaySeconds}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerLivenessProbe#getPeriodSeconds}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerLivenessProbe#getSuccessThreshold}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerLivenessProbe#getTcpSocket}
         ...
         * @return {@code this}
         */
        public Builder tcpSocket(java.util.List<? extends imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeTcpSocket> tcpSocket) {
            this.tcpSocket = tcpSocket;
            return this;
        }

        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerLivenessProbe#getTimeoutSeconds}
         ...
         * @return a new instance of {@link DaemonsetSpecTemplateSpecInitContainerLivenessProbe}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DaemonsetSpecTemplateSpecInitContainerLivenessProbe build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DaemonsetSpecTemplateSpecInitContainerLivenessProbe}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DaemonsetSpecTemplateSpecInitContainerLivenessProbe {
        private final imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeExec exec;
        private final java.lang.Number failureThreshold;
        private final imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeHttpGet httpGet;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.exec = software.amazon.jsii.Kernel.get(this, "exec", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeExec.class));
            ...
            this.httpGet = software.amazon.jsii.Kernel.get(this, "httpGet", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeHttpGet.class));
        ...
        @Override
        public final imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeExec getExec() {
            return this.exec;
        }
        ...
        @Override
        public final imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeHttpGet getHttpGet() {
            return this.httpGet;
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbe"));
        ...
        public final boolean equals(final Object o) {
            ...
            DaemonsetSpecTemplateSpecInitContainerLivenessProbe.Jsii$Proxy that = (DaemonsetSpecTemplateSpecInitContainerLivenessProbe.Jsii$Proxy) o;
