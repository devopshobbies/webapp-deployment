...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DaemonsetSpecTemplateSpecVolumeDownwardApiItemsFieldRef")
@software.amazon.jsii.Jsii.Proxy(DaemonsetSpecTemplateSpecVolumeDownwardApiItemsFieldRef.Jsii$Proxy.class)
public interface DaemonsetSpecTemplateSpecVolumeDownwardApiItemsFieldRef extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DaemonsetSpecTemplateSpecVolumeDownwardApiItemsFieldRef}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DaemonsetSpecTemplateSpecVolumeDownwardApiItemsFieldRef}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DaemonsetSpecTemplateSpecVolumeDownwardApiItemsFieldRef> {
        java.lang.String apiVersion;
        java.lang.String fieldPath;

        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecVolumeDownwardApiItemsFieldRef#getApiVersion}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecVolumeDownwardApiItemsFieldRef#getFieldPath}
         ...
         * @return a new instance of {@link DaemonsetSpecTemplateSpecVolumeDownwardApiItemsFieldRef}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DaemonsetSpecTemplateSpecVolumeDownwardApiItemsFieldRef build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DaemonsetSpecTemplateSpecVolumeDownwardApiItemsFieldRef}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DaemonsetSpecTemplateSpecVolumeDownwardApiItemsFieldRef {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DaemonsetSpecTemplateSpecVolumeDownwardApiItemsFieldRef"));
        ...
        public final boolean equals(final Object o) {
            ...
            DaemonsetSpecTemplateSpecVolumeDownwardApiItemsFieldRef.Jsii$Proxy that = (DaemonsetSpecTemplateSpecVolumeDownwardApiItemsFieldRef.Jsii$Proxy) o;
