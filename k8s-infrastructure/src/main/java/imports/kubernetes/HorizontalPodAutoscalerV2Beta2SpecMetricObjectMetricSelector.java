...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:39.879Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.HorizontalPodAutoscalerV2Beta2SpecMetricObjectMetricSelector")
@software.amazon.jsii.Jsii.Proxy(HorizontalPodAutoscalerV2Beta2SpecMetricObjectMetricSelector.Jsii$Proxy.class)
public interface HorizontalPodAutoscalerV2Beta2SpecMetricObjectMetricSelector extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link HorizontalPodAutoscalerV2Beta2SpecMetricObjectMetricSelector}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link HorizontalPodAutoscalerV2Beta2SpecMetricObjectMetricSelector}
     */
    public static final class Builder implements software.amazon.jsii.Builder<HorizontalPodAutoscalerV2Beta2SpecMetricObjectMetricSelector> {
        java.lang.Object matchExpressions;
        java.util.Map<java.lang.String, java.lang.String> matchLabels;

        /**
         * Sets the value of {@link HorizontalPodAutoscalerV2Beta2SpecMetricObjectMetricSelector#getMatchExpressions}
         ...
         * @return {@code this}
         */
        public Builder matchExpressions(java.util.List<? extends imports.kubernetes.HorizontalPodAutoscalerV2Beta2SpecMetricObjectMetricSelectorMatchExpressions> matchExpressions) {
            this.matchExpressions = matchExpressions;
            return this;
        }

        /**
         * Sets the value of {@link HorizontalPodAutoscalerV2Beta2SpecMetricObjectMetricSelector#getMatchLabels}
         ...
         * @return a new instance of {@link HorizontalPodAutoscalerV2Beta2SpecMetricObjectMetricSelector}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public HorizontalPodAutoscalerV2Beta2SpecMetricObjectMetricSelector build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link HorizontalPodAutoscalerV2Beta2SpecMetricObjectMetricSelector}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements HorizontalPodAutoscalerV2Beta2SpecMetricObjectMetricSelector {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.HorizontalPodAutoscalerV2Beta2SpecMetricObjectMetricSelector"));
        ...
        public final boolean equals(final Object o) {
            ...
            HorizontalPodAutoscalerV2Beta2SpecMetricObjectMetricSelector.Jsii$Proxy that = (HorizontalPodAutoscalerV2Beta2SpecMetricObjectMetricSelector.Jsii$Proxy) o;
