...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DaemonSetV1SpecTemplateSpecAffinityPodAffinity")
@software.amazon.jsii.Jsii.Proxy(DaemonSetV1SpecTemplateSpecAffinityPodAffinity.Jsii$Proxy.class)
public interface DaemonSetV1SpecTemplateSpecAffinityPodAffinity extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DaemonSetV1SpecTemplateSpecAffinityPodAffinity}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DaemonSetV1SpecTemplateSpecAffinityPodAffinity}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DaemonSetV1SpecTemplateSpecAffinityPodAffinity> {
        ...
        /**
         * Sets the value of {@link DaemonSetV1SpecTemplateSpecAffinityPodAffinity#getPreferredDuringSchedulingIgnoredDuringExecution}
         ...
         * @return {@code this}
         */
        public Builder preferredDuringSchedulingIgnoredDuringExecution(java.util.List<? extends imports.kubernetes.DaemonSetV1SpecTemplateSpecAffinityPodAffinityPreferredDuringSchedulingIgnoredDuringExecution> preferredDuringSchedulingIgnoredDuringExecution) {
            this.preferredDuringSchedulingIgnoredDuringExecution = preferredDuringSchedulingIgnoredDuringExecution;
            return this;
        }

        /**
         * Sets the value of {@link DaemonSetV1SpecTemplateSpecAffinityPodAffinity#getRequiredDuringSchedulingIgnoredDuringExecution}
         ...
         * @return {@code this}
         */
        public Builder requiredDuringSchedulingIgnoredDuringExecution(java.util.List<? extends imports.kubernetes.DaemonSetV1SpecTemplateSpecAffinityPodAffinityRequiredDuringSchedulingIgnoredDuringExecution> requiredDuringSchedulingIgnoredDuringExecution) {
            this.requiredDuringSchedulingIgnoredDuringExecution = requiredDuringSchedulingIgnoredDuringExecution;
            return this;
        }
         ...
         * @return a new instance of {@link DaemonSetV1SpecTemplateSpecAffinityPodAffinity}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DaemonSetV1SpecTemplateSpecAffinityPodAffinity build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DaemonSetV1SpecTemplateSpecAffinityPodAffinity}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DaemonSetV1SpecTemplateSpecAffinityPodAffinity {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DaemonSetV1SpecTemplateSpecAffinityPodAffinity"));
        ...
        public final boolean equals(final Object o) {
            ...
            DaemonSetV1SpecTemplateSpecAffinityPodAffinity.Jsii$Proxy that = (DaemonSetV1SpecTemplateSpecAffinityPodAffinity.Jsii$Proxy) o;
