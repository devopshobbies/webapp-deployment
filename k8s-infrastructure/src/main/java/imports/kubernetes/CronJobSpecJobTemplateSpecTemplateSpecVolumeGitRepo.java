...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.CronJobSpecJobTemplateSpecTemplateSpecVolumeGitRepo")
@software.amazon.jsii.Jsii.Proxy(CronJobSpecJobTemplateSpecTemplateSpecVolumeGitRepo.Jsii$Proxy.class)
public interface CronJobSpecJobTemplateSpecTemplateSpecVolumeGitRepo extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link CronJobSpecJobTemplateSpecTemplateSpecVolumeGitRepo}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link CronJobSpecJobTemplateSpecTemplateSpecVolumeGitRepo}
     */
    public static final class Builder implements software.amazon.jsii.Builder<CronJobSpecJobTemplateSpecTemplateSpecVolumeGitRepo> {
        java.lang.String directory;
        java.lang.String repository;
        java.lang.String revision;

        /**
         * Sets the value of {@link CronJobSpecJobTemplateSpecTemplateSpecVolumeGitRepo#getDirectory}
        ...
        /**
         * Sets the value of {@link CronJobSpecJobTemplateSpecTemplateSpecVolumeGitRepo#getRepository}
        ...
        /**
         * Sets the value of {@link CronJobSpecJobTemplateSpecTemplateSpecVolumeGitRepo#getRevision}
         ...
         * @return a new instance of {@link CronJobSpecJobTemplateSpecTemplateSpecVolumeGitRepo}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public CronJobSpecJobTemplateSpecTemplateSpecVolumeGitRepo build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link CronJobSpecJobTemplateSpecTemplateSpecVolumeGitRepo}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CronJobSpecJobTemplateSpecTemplateSpecVolumeGitRepo {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.CronJobSpecJobTemplateSpecTemplateSpecVolumeGitRepo"));
        ...
        public final boolean equals(final Object o) {
            ...
            CronJobSpecJobTemplateSpecTemplateSpecVolumeGitRepo.Jsii$Proxy that = (CronJobSpecJobTemplateSpecTemplateSpecVolumeGitRepo.Jsii$Proxy) o;
