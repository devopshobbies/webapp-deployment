...
public interface HorizontalPodAutoscalerSpec extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull imports.kubernetes.HorizontalPodAutoscalerSpecScaleTargetRef getScaleTargetRef();
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.HorizontalPodAutoscalerSpecBehavior getBehavior() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<HorizontalPodAutoscalerSpec> {
        ...
        imports.kubernetes.HorizontalPodAutoscalerSpecScaleTargetRef scaleTargetRef;
        imports.kubernetes.HorizontalPodAutoscalerSpecBehavior behavior;
         ...
         * @return {@code this}
         */
        public Builder scaleTargetRef(imports.kubernetes.HorizontalPodAutoscalerSpecScaleTargetRef scaleTargetRef) {
            this.scaleTargetRef = scaleTargetRef;
            return this;
        }

        /**
         * Sets the value of {@link HorizontalPodAutoscalerSpec#getBehavior}
         * @param behavior behavior block.
         *                 Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/horizontal_pod_autoscaler#behavior HorizontalPodAutoscaler#behavior}
         * @return {@code this}
         */
        public Builder behavior(imports.kubernetes.HorizontalPodAutoscalerSpecBehavior behavior) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements HorizontalPodAutoscalerSpec {
        ...
        private final imports.kubernetes.HorizontalPodAutoscalerSpecScaleTargetRef scaleTargetRef;
        private final imports.kubernetes.HorizontalPodAutoscalerSpecBehavior behavior;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.scaleTargetRef = software.amazon.jsii.Kernel.get(this, "scaleTargetRef", software.amazon.jsii.NativeType.forClass(imports.kubernetes.HorizontalPodAutoscalerSpecScaleTargetRef.class));
            this.behavior = software.amazon.jsii.Kernel.get(this, "behavior", software.amazon.jsii.NativeType.forClass(imports.kubernetes.HorizontalPodAutoscalerSpecBehavior.class));
        ...
        @Override
        public final imports.kubernetes.HorizontalPodAutoscalerSpecScaleTargetRef getScaleTargetRef() {
            return this.scaleTargetRef;
        }

        @Override
        public final imports.kubernetes.HorizontalPodAutoscalerSpecBehavior getBehavior() {
