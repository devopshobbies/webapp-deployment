...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.NetworkPolicySpecIngressFromNamespaceSelector")
@software.amazon.jsii.Jsii.Proxy(NetworkPolicySpecIngressFromNamespaceSelector.Jsii$Proxy.class)
public interface NetworkPolicySpecIngressFromNamespaceSelector extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link NetworkPolicySpecIngressFromNamespaceSelector}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link NetworkPolicySpecIngressFromNamespaceSelector}
     */
    public static final class Builder implements software.amazon.jsii.Builder<NetworkPolicySpecIngressFromNamespaceSelector> {
        java.lang.Object matchExpressions;
        java.util.Map<java.lang.String, java.lang.String> matchLabels;

        /**
         * Sets the value of {@link NetworkPolicySpecIngressFromNamespaceSelector#getMatchExpressions}
         ...
         * @return {@code this}
         */
        public Builder matchExpressions(java.util.List<? extends imports.kubernetes.NetworkPolicySpecIngressFromNamespaceSelectorMatchExpressions> matchExpressions) {
            this.matchExpressions = matchExpressions;
            return this;
        }

        /**
         * Sets the value of {@link NetworkPolicySpecIngressFromNamespaceSelector#getMatchLabels}
         ...
         * @return a new instance of {@link NetworkPolicySpecIngressFromNamespaceSelector}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public NetworkPolicySpecIngressFromNamespaceSelector build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link NetworkPolicySpecIngressFromNamespaceSelector}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements NetworkPolicySpecIngressFromNamespaceSelector {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.NetworkPolicySpecIngressFromNamespaceSelector"));
        ...
        public final boolean equals(final Object o) {
            ...
            NetworkPolicySpecIngressFromNamespaceSelector.Jsii$Proxy that = (NetworkPolicySpecIngressFromNamespaceSelector.Jsii$Proxy) o;
