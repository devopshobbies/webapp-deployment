...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.HorizontalPodAutoscalerV2SpecBehaviorScaleDownPolicy")
@software.amazon.jsii.Jsii.Proxy(HorizontalPodAutoscalerV2SpecBehaviorScaleDownPolicy.Jsii$Proxy.class)
public interface HorizontalPodAutoscalerV2SpecBehaviorScaleDownPolicy extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link HorizontalPodAutoscalerV2SpecBehaviorScaleDownPolicy}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link HorizontalPodAutoscalerV2SpecBehaviorScaleDownPolicy}
     */
    public static final class Builder implements software.amazon.jsii.Builder<HorizontalPodAutoscalerV2SpecBehaviorScaleDownPolicy> {
        java.lang.Number periodSeconds;
        java.lang.String type;
        java.lang.Number value;

        /**
         * Sets the value of {@link HorizontalPodAutoscalerV2SpecBehaviorScaleDownPolicy#getPeriodSeconds}
        ...
        /**
         * Sets the value of {@link HorizontalPodAutoscalerV2SpecBehaviorScaleDownPolicy#getType}
        ...
        /**
         * Sets the value of {@link HorizontalPodAutoscalerV2SpecBehaviorScaleDownPolicy#getValue}
         ...
         * @return a new instance of {@link HorizontalPodAutoscalerV2SpecBehaviorScaleDownPolicy}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public HorizontalPodAutoscalerV2SpecBehaviorScaleDownPolicy build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link HorizontalPodAutoscalerV2SpecBehaviorScaleDownPolicy}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements HorizontalPodAutoscalerV2SpecBehaviorScaleDownPolicy {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.HorizontalPodAutoscalerV2SpecBehaviorScaleDownPolicy"));
        ...
        public final boolean equals(final Object o) {
            ...
            HorizontalPodAutoscalerV2SpecBehaviorScaleDownPolicy.Jsii$Proxy that = (HorizontalPodAutoscalerV2SpecBehaviorScaleDownPolicy.Jsii$Proxy) o;
