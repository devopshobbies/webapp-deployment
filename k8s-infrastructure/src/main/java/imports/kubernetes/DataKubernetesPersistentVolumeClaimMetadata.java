...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:39.436Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DataKubernetesPersistentVolumeClaimMetadata")
@software.amazon.jsii.Jsii.Proxy(DataKubernetesPersistentVolumeClaimMetadata.Jsii$Proxy.class)
public interface DataKubernetesPersistentVolumeClaimMetadata extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DataKubernetesPersistentVolumeClaimMetadata}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DataKubernetesPersistentVolumeClaimMetadata}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DataKubernetesPersistentVolumeClaimMetadata> {
        ...
        /**
         * Sets the value of {@link DataKubernetesPersistentVolumeClaimMetadata#getAnnotations}
         * @param annotations An unstructured key value map stored with the persistent volume claim that may be used to store arbitrary metadata.
         *                    More info: http://kubernetes.io/docs/user-guide/annotations
         *                    <p>
         *                    Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/d/persistent_volume_claim#annotations DataKubernetesPersistentVolumeClaim#annotations}
         * @return {@code this}
        ...
        /**
         * Sets the value of {@link DataKubernetesPersistentVolumeClaimMetadata#getGenerateName}
        ...
        /**
         * Sets the value of {@link DataKubernetesPersistentVolumeClaimMetadata#getLabels}
         * @param labels Map of string keys and values that can be used to organize and categorize (scope and select) the persistent volume claim.
         *               May match selectors of replication controllers and services. More info: http://kubernetes.io/docs/user-guide/labels
         *               <p>
         *               Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/d/persistent_volume_claim#labels DataKubernetesPersistentVolumeClaim#labels}
         * @return {@code this}
        ...
        /**
         * Sets the value of {@link DataKubernetesPersistentVolumeClaimMetadata#getName}
         * @param name Name of the persistent volume claim, must be unique. Cannot be updated. More info: http://kubernetes.io/docs/user-guide/identifiers#names.
         *             Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/d/persistent_volume_claim#name DataKubernetesPersistentVolumeClaim#name}
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link DataKubernetesPersistentVolumeClaimMetadata#getNamespace}
         * @param namespace Namespace defines the space within which name of the persistent volume claim must be unique.
         *                  Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/d/persistent_volume_claim#namespace DataKubernetesPersistentVolumeClaim#namespace}
         * @return {@code this}
         */
         ...
         * @return a new instance of {@link DataKubernetesPersistentVolumeClaimMetadata}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DataKubernetesPersistentVolumeClaimMetadata build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DataKubernetesPersistentVolumeClaimMetadata}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DataKubernetesPersistentVolumeClaimMetadata {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DataKubernetesPersistentVolumeClaimMetadata"));
        ...
        public final boolean equals(final Object o) {
            ...
            DataKubernetesPersistentVolumeClaimMetadata.Jsii$Proxy that = (DataKubernetesPersistentVolumeClaimMetadata.Jsii$Proxy) o;
