...
public interface ReplicationControllerSpecTemplateSpecContainerEnvValueFrom extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerEnvValueFromConfigMapKeyRef getConfigMapKeyRef() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerEnvValueFromFieldRef getFieldRef() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerEnvValueFromResourceFieldRef getResourceFieldRef() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerEnvValueFromSecretKeyRef getSecretKeyRef() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<ReplicationControllerSpecTemplateSpecContainerEnvValueFrom> {
        imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerEnvValueFromConfigMapKeyRef configMapKeyRef;
        imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerEnvValueFromFieldRef fieldRef;
        imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerEnvValueFromResourceFieldRef resourceFieldRef;
         ...
         * @return {@code this}
         */
        public Builder configMapKeyRef(imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerEnvValueFromConfigMapKeyRef configMapKeyRef) {
         ...
         * @return {@code this}
         */
        public Builder fieldRef(imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerEnvValueFromFieldRef fieldRef) {
         ...
         * @return {@code this}
         */
        public Builder resourceFieldRef(imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerEnvValueFromResourceFieldRef resourceFieldRef) {
         ...
         * @return {@code this}
         */
        public Builder secretKeyRef(imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerEnvValueFromSecretKeyRef secretKeyRef) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ReplicationControllerSpecTemplateSpecContainerEnvValueFrom {
        private final imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerEnvValueFromConfigMapKeyRef configMapKeyRef;
        private final imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerEnvValueFromFieldRef fieldRef;
        private final imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerEnvValueFromResourceFieldRef resourceFieldRef;
        private final imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerEnvValueFromSecretKeyRef secretKeyRef;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.configMapKeyRef = software.amazon.jsii.Kernel.get(this, "configMapKeyRef", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerEnvValueFromConfigMapKeyRef.class));
            this.fieldRef = software.amazon.jsii.Kernel.get(this, "fieldRef", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerEnvValueFromFieldRef.class));
            this.resourceFieldRef = software.amazon.jsii.Kernel.get(this, "resourceFieldRef", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerEnvValueFromResourceFieldRef.class));
            this.secretKeyRef = software.amazon.jsii.Kernel.get(this, "secretKeyRef", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerEnvValueFromSecretKeyRef.class));
        }
        ...
        @Override
        public final imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerEnvValueFromConfigMapKeyRef getConfigMapKeyRef() {
            return this.configMapKeyRef;
        }

        @Override
        public final imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerEnvValueFromFieldRef getFieldRef() {
            return this.fieldRef;
        }

        @Override
        public final imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerEnvValueFromResourceFieldRef getResourceFieldRef() {
            return this.resourceFieldRef;
        }

        @Override
        public final imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerEnvValueFromSecretKeyRef getSecretKeyRef() {
