...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.NetworkPolicySpecEgressToNamespaceSelectorOutputReference")
public class NetworkPolicySpecEgressToNamespaceSelectorOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected NetworkPolicySpecEgressToNamespaceSelectorOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected NetworkPolicySpecEgressToNamespaceSelectorOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public NetworkPolicySpecEgressToNamespaceSelectorOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public @org.jetbrains.annotations.NotNull imports.kubernetes.NetworkPolicySpecEgressToNamespaceSelectorMatchExpressionsList getMatchExpressions() {
        return software.amazon.jsii.Kernel.get(this, "matchExpressions", software.amazon.jsii.NativeType.forClass(imports.kubernetes.NetworkPolicySpecEgressToNamespaceSelectorMatchExpressionsList.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.kubernetes.NetworkPolicySpecEgressToNamespaceSelector getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.kubernetes.NetworkPolicySpecEgressToNamespaceSelector.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.NetworkPolicySpecEgressToNamespaceSelector value) {
