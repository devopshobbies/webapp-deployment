...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PodV1SpecVolumeProjectedSourcesDownwardApiItemsFieldRefOutputReference")
public class PodV1SpecVolumeProjectedSourcesDownwardApiItemsFieldRefOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected PodV1SpecVolumeProjectedSourcesDownwardApiItemsFieldRefOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected PodV1SpecVolumeProjectedSourcesDownwardApiItemsFieldRefOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public PodV1SpecVolumeProjectedSourcesDownwardApiItemsFieldRefOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public @org.jetbrains.annotations.Nullable imports.kubernetes.PodV1SpecVolumeProjectedSourcesDownwardApiItemsFieldRef getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodV1SpecVolumeProjectedSourcesDownwardApiItemsFieldRef.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.PodV1SpecVolumeProjectedSourcesDownwardApiItemsFieldRef value) {
