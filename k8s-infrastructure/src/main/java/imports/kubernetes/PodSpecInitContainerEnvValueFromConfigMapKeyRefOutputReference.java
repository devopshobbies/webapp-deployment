...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PodSpecInitContainerEnvValueFromConfigMapKeyRefOutputReference")
public class PodSpecInitContainerEnvValueFromConfigMapKeyRefOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected PodSpecInitContainerEnvValueFromConfigMapKeyRefOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected PodSpecInitContainerEnvValueFromConfigMapKeyRefOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public PodSpecInitContainerEnvValueFromConfigMapKeyRefOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public @org.jetbrains.annotations.Nullable imports.kubernetes.PodSpecInitContainerEnvValueFromConfigMapKeyRef getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecInitContainerEnvValueFromConfigMapKeyRef.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.PodSpecInitContainerEnvValueFromConfigMapKeyRef value) {
