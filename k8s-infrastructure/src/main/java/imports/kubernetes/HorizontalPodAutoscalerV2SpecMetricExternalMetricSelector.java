...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:39.893Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.HorizontalPodAutoscalerV2SpecMetricExternalMetricSelector")
@software.amazon.jsii.Jsii.Proxy(HorizontalPodAutoscalerV2SpecMetricExternalMetricSelector.Jsii$Proxy.class)
public interface HorizontalPodAutoscalerV2SpecMetricExternalMetricSelector extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link HorizontalPodAutoscalerV2SpecMetricExternalMetricSelector}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link HorizontalPodAutoscalerV2SpecMetricExternalMetricSelector}
     */
    public static final class Builder implements software.amazon.jsii.Builder<HorizontalPodAutoscalerV2SpecMetricExternalMetricSelector> {
        java.lang.Object matchExpressions;
        java.util.Map<java.lang.String, java.lang.String> matchLabels;

        /**
         * Sets the value of {@link HorizontalPodAutoscalerV2SpecMetricExternalMetricSelector#getMatchExpressions}
         ...
         * @return {@code this}
         */
        public Builder matchExpressions(java.util.List<? extends imports.kubernetes.HorizontalPodAutoscalerV2SpecMetricExternalMetricSelectorMatchExpressions> matchExpressions) {
            this.matchExpressions = matchExpressions;
            return this;
        }

        /**
         * Sets the value of {@link HorizontalPodAutoscalerV2SpecMetricExternalMetricSelector#getMatchLabels}
         ...
         * @return a new instance of {@link HorizontalPodAutoscalerV2SpecMetricExternalMetricSelector}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public HorizontalPodAutoscalerV2SpecMetricExternalMetricSelector build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link HorizontalPodAutoscalerV2SpecMetricExternalMetricSelector}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements HorizontalPodAutoscalerV2SpecMetricExternalMetricSelector {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.HorizontalPodAutoscalerV2SpecMetricExternalMetricSelector"));
        ...
        public final boolean equals(final Object o) {
            ...
            HorizontalPodAutoscalerV2SpecMetricExternalMetricSelector.Jsii$Proxy that = (HorizontalPodAutoscalerV2SpecMetricExternalMetricSelector.Jsii$Proxy) o;
