...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DataKubernetesPodSpecVolumeDownwardApiItemsResourceFieldRefList")
public class DataKubernetesPodSpecVolumeDownwardApiItemsResourceFieldRefList extends com.hashicorp.cdktf.ComplexList {

    protected DataKubernetesPodSpecVolumeDownwardApiItemsResourceFieldRefList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecVolumeDownwardApiItemsResourceFieldRefList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.kubernetes.DataKubernetesPodSpecVolumeDownwardApiItemsResourceFieldRefOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DataKubernetesPodSpecVolumeDownwardApiItemsResourceFieldRefOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
