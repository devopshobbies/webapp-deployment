...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PersistentVolumeSpecPersistentVolumeSourceNfs")
@software.amazon.jsii.Jsii.Proxy(PersistentVolumeSpecPersistentVolumeSourceNfs.Jsii$Proxy.class)
public interface PersistentVolumeSpecPersistentVolumeSourceNfs extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link PersistentVolumeSpecPersistentVolumeSourceNfs}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link PersistentVolumeSpecPersistentVolumeSourceNfs}
     */
    public static final class Builder implements software.amazon.jsii.Builder<PersistentVolumeSpecPersistentVolumeSourceNfs> {
        java.lang.String path;
        java.lang.String server;
        java.lang.Object readOnly;

        /**
         * Sets the value of {@link PersistentVolumeSpecPersistentVolumeSourceNfs#getPath}
        ...
        /**
         * Sets the value of {@link PersistentVolumeSpecPersistentVolumeSourceNfs#getServer}
        ...
        /**
         * Sets the value of {@link PersistentVolumeSpecPersistentVolumeSourceNfs#getReadOnly}
         ...
         * @return a new instance of {@link PersistentVolumeSpecPersistentVolumeSourceNfs}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public PersistentVolumeSpecPersistentVolumeSourceNfs build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link PersistentVolumeSpecPersistentVolumeSourceNfs}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PersistentVolumeSpecPersistentVolumeSourceNfs {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.PersistentVolumeSpecPersistentVolumeSourceNfs"));
        ...
        public final boolean equals(final Object o) {
            ...
            PersistentVolumeSpecPersistentVolumeSourceNfs.Jsii$Proxy that = (PersistentVolumeSpecPersistentVolumeSourceNfs.Jsii$Proxy) o;
