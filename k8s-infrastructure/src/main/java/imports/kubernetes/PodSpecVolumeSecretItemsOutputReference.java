...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PodSpecVolumeSecretItemsOutputReference")
public class PodSpecVolumeSecretItemsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected PodSpecVolumeSecretItemsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected PodSpecVolumeSecretItemsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.PodSpecVolumeSecretItems value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
