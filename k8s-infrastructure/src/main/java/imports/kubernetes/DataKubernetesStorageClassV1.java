 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:39.587Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DataKubernetesStorageClassV1")
public class DataKubernetesStorageClassV1 extends com.hashicorp.cdktf.TerraformDataSource {

    protected DataKubernetesStorageClassV1(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesStorageClassV1(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.kubernetes.DataKubernetesStorageClassV1.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public DataKubernetesStorageClassV1(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.kubernetes.DataKubernetesStorageClassV1Config config) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(id, "id is required"), java.util.Objects.requireNonNull(config, "config is required") });
    }

    public void putAllowedTopologies(final @org.jetbrains.annotations.NotNull imports.kubernetes.DataKubernetesStorageClassV1AllowedTopologies value) {
    ...
    public void putMetadata(final @org.jetbrains.annotations.NotNull imports.kubernetes.DataKubernetesStorageClassV1Metadata value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.kubernetes.DataKubernetesStorageClassV1AllowedTopologiesOutputReference getAllowedTopologies() {
        return software.amazon.jsii.Kernel.get(this, "allowedTopologies", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DataKubernetesStorageClassV1AllowedTopologiesOutputReference.class));
    }

    public @org.jetbrains.annotations.NotNull imports.kubernetes.DataKubernetesStorageClassV1MetadataOutputReference getMetadata() {
        return software.amazon.jsii.Kernel.get(this, "metadata", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DataKubernetesStorageClassV1MetadataOutputReference.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.kubernetes.DataKubernetesStorageClassV1AllowedTopologies getAllowedTopologiesInput() {
        return software.amazon.jsii.Kernel.get(this, "allowedTopologiesInput", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DataKubernetesStorageClassV1AllowedTopologies.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.kubernetes.DataKubernetesStorageClassV1Metadata getMetadataInput() {
        return software.amazon.jsii.Kernel.get(this, "metadataInput", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DataKubernetesStorageClassV1Metadata.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.kubernetes.DataKubernetesStorageClassV1}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.kubernetes.DataKubernetesStorageClassV1> {
        /**
        ...
        private final imports.kubernetes.DataKubernetesStorageClassV1Config.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.kubernetes.DataKubernetesStorageClassV1Config.Builder();
        }
         ...
         */
        public Builder metadata(final imports.kubernetes.DataKubernetesStorageClassV1Metadata metadata) {
         ...
         */
        public Builder allowedTopologies(final imports.kubernetes.DataKubernetesStorageClassV1AllowedTopologies allowedTopologies) {
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/d/storage_class_v1#id DataKubernetesStorageClassV1#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.kubernetes.DataKubernetesStorageClassV1}.
         */
        @Override
        public imports.kubernetes.DataKubernetesStorageClassV1 build() {
            return new imports.kubernetes.DataKubernetesStorageClassV1(
                this.scope,
                this.id,
                this.config.build()
            );
