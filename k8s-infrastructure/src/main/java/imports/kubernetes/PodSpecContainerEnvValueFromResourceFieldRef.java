...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PodSpecContainerEnvValueFromResourceFieldRef")
@software.amazon.jsii.Jsii.Proxy(PodSpecContainerEnvValueFromResourceFieldRef.Jsii$Proxy.class)
public interface PodSpecContainerEnvValueFromResourceFieldRef extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link PodSpecContainerEnvValueFromResourceFieldRef}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link PodSpecContainerEnvValueFromResourceFieldRef}
     */
    public static final class Builder implements software.amazon.jsii.Builder<PodSpecContainerEnvValueFromResourceFieldRef> {
        java.lang.String resource;
        java.lang.String containerName;
        java.lang.String divisor;

        /**
         * Sets the value of {@link PodSpecContainerEnvValueFromResourceFieldRef#getResource}
        ...
        /**
         * Sets the value of {@link PodSpecContainerEnvValueFromResourceFieldRef#getContainerName}
         * @param containerName Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/r/pod#container_name Pod#container_name}.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link PodSpecContainerEnvValueFromResourceFieldRef#getDivisor}
         ...
         * @return a new instance of {@link PodSpecContainerEnvValueFromResourceFieldRef}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public PodSpecContainerEnvValueFromResourceFieldRef build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link PodSpecContainerEnvValueFromResourceFieldRef}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodSpecContainerEnvValueFromResourceFieldRef {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.PodSpecContainerEnvValueFromResourceFieldRef"));
        ...
        public final boolean equals(final Object o) {
            ...
            PodSpecContainerEnvValueFromResourceFieldRef.Jsii$Proxy that = (PodSpecContainerEnvValueFromResourceFieldRef.Jsii$Proxy) o;
