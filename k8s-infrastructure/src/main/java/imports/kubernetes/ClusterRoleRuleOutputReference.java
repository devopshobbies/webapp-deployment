...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.ClusterRoleRuleOutputReference")
public class ClusterRoleRuleOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected ClusterRoleRuleOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected ClusterRoleRuleOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.ClusterRoleRule value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
