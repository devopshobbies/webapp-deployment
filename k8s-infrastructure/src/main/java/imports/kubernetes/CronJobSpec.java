...
public interface CronJobSpec extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull imports.kubernetes.CronJobSpecJobTemplate getJobTemplate();
    ...
    public static final class Builder implements software.amazon.jsii.Builder<CronJobSpec> {
        imports.kubernetes.CronJobSpecJobTemplate jobTemplate;
         ...
         * @return {@code this}
         */
        public Builder jobTemplate(imports.kubernetes.CronJobSpecJobTemplate jobTemplate) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CronJobSpec {
        private final imports.kubernetes.CronJobSpecJobTemplate jobTemplate;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.jobTemplate = software.amazon.jsii.Kernel.get(this, "jobTemplate", software.amazon.jsii.NativeType.forClass(imports.kubernetes.CronJobSpecJobTemplate.class));
        ...
        @Override
        public final imports.kubernetes.CronJobSpecJobTemplate getJobTemplate() {
