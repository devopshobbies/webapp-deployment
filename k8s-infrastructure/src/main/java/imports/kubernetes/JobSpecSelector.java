...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.JobSpecSelector")
@software.amazon.jsii.Jsii.Proxy(JobSpecSelector.Jsii$Proxy.class)
public interface JobSpecSelector extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link JobSpecSelector}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link JobSpecSelector}
     */
    public static final class Builder implements software.amazon.jsii.Builder<JobSpecSelector> {
        java.lang.Object matchExpressions;
        java.util.Map<java.lang.String, java.lang.String> matchLabels;

        /**
         * Sets the value of {@link JobSpecSelector#getMatchExpressions}
         ...
         * @return {@code this}
         */
        public Builder matchExpressions(java.util.List<? extends imports.kubernetes.JobSpecSelectorMatchExpressions> matchExpressions) {
            this.matchExpressions = matchExpressions;
            return this;
        }

        /**
         * Sets the value of {@link JobSpecSelector#getMatchLabels}
         ...
         * @return a new instance of {@link JobSpecSelector}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public JobSpecSelector build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link JobSpecSelector}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements JobSpecSelector {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.JobSpecSelector"));
        ...
        public final boolean equals(final Object o) {
            ...
            JobSpecSelector.Jsii$Proxy that = (JobSpecSelector.Jsii$Proxy) o;
