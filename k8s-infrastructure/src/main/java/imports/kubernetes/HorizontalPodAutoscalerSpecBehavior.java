...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:39.840Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.HorizontalPodAutoscalerSpecBehavior")
@software.amazon.jsii.Jsii.Proxy(HorizontalPodAutoscalerSpecBehavior.Jsii$Proxy.class)
public interface HorizontalPodAutoscalerSpecBehavior extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link HorizontalPodAutoscalerSpecBehavior}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link HorizontalPodAutoscalerSpecBehavior}
     */
    public static final class Builder implements software.amazon.jsii.Builder<HorizontalPodAutoscalerSpecBehavior> {
        java.lang.Object scaleDown;
        java.lang.Object scaleUp;

        /**
         * Sets the value of {@link HorizontalPodAutoscalerSpecBehavior#getScaleDown}
         ...
         * @return {@code this}
         */
        public Builder scaleDown(java.util.List<? extends imports.kubernetes.HorizontalPodAutoscalerSpecBehaviorScaleDown> scaleDown) {
            this.scaleDown = scaleDown;
            return this;
        }

        /**
         * Sets the value of {@link HorizontalPodAutoscalerSpecBehavior#getScaleUp}
         ...
         * @return {@code this}
         */
        public Builder scaleUp(java.util.List<? extends imports.kubernetes.HorizontalPodAutoscalerSpecBehaviorScaleUp> scaleUp) {
            this.scaleUp = scaleUp;
            return this;
        }
         ...
         * @return a new instance of {@link HorizontalPodAutoscalerSpecBehavior}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public HorizontalPodAutoscalerSpecBehavior build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link HorizontalPodAutoscalerSpecBehavior}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements HorizontalPodAutoscalerSpecBehavior {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.HorizontalPodAutoscalerSpecBehavior"));
        ...
        public final boolean equals(final Object o) {
            ...
            HorizontalPodAutoscalerSpecBehavior.Jsii$Proxy that = (HorizontalPodAutoscalerSpecBehavior.Jsii$Proxy) o;
