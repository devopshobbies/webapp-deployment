...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.RoleBindingMetadata")
@software.amazon.jsii.Jsii.Proxy(RoleBindingMetadata.Jsii$Proxy.class)
public interface RoleBindingMetadata extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link RoleBindingMetadata}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link RoleBindingMetadata}
     */
    public static final class Builder implements software.amazon.jsii.Builder<RoleBindingMetadata> {
        ...
        /**
         * Sets the value of {@link RoleBindingMetadata#getAnnotations}
         * @param annotations An unstructured key value map stored with the roleBinding that may be used to store arbitrary metadata.
         *                    More info: http://kubernetes.io/docs/user-guide/annotations
         *                    <p>
         *                    Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/role_binding#annotations RoleBinding#annotations}
         * @return {@code this}
        ...
        /**
         * Sets the value of {@link RoleBindingMetadata#getLabels}
         * @param labels Map of string keys and values that can be used to organize and categorize (scope and select) the roleBinding.
         *               May match selectors of replication controllers and services. More info: http://kubernetes.io/docs/user-guide/labels
         *               <p>
         *               Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/role_binding#labels RoleBinding#labels}
         * @return {@code this}
        ...
        /**
         * Sets the value of {@link RoleBindingMetadata#getName}
         * @param name Name of the roleBinding, must be unique. Cannot be updated. More info: http://kubernetes.io/docs/user-guide/identifiers#names.
         *             Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/role_binding#name RoleBinding#name}
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link RoleBindingMetadata#getNamespace}
         * @param namespace Namespace defines the space within which name of the roleBinding must be unique.
         *                  Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/role_binding#namespace RoleBinding#namespace}
         * @return {@code this}
         */
         ...
         * @return a new instance of {@link RoleBindingMetadata}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public RoleBindingMetadata build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link RoleBindingMetadata}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements RoleBindingMetadata {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.RoleBindingMetadata"));
        ...
        public final boolean equals(final Object o) {
            ...
            RoleBindingMetadata.Jsii$Proxy that = (RoleBindingMetadata.Jsii$Proxy) o;
