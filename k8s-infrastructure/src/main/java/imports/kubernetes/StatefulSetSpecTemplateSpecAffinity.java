...
public interface StatefulSetSpecTemplateSpecAffinity extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.StatefulSetSpecTemplateSpecAffinityNodeAffinity getNodeAffinity() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.StatefulSetSpecTemplateSpecAffinityPodAffinity getPodAffinity() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.StatefulSetSpecTemplateSpecAffinityPodAntiAffinity getPodAntiAffinity() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<StatefulSetSpecTemplateSpecAffinity> {
        imports.kubernetes.StatefulSetSpecTemplateSpecAffinityNodeAffinity nodeAffinity;
        imports.kubernetes.StatefulSetSpecTemplateSpecAffinityPodAffinity podAffinity;
         ...
         * @return {@code this}
         */
        public Builder nodeAffinity(imports.kubernetes.StatefulSetSpecTemplateSpecAffinityNodeAffinity nodeAffinity) {
         ...
         * @return {@code this}
         */
        public Builder podAffinity(imports.kubernetes.StatefulSetSpecTemplateSpecAffinityPodAffinity podAffinity) {
         ...
         * @return {@code this}
         */
        public Builder podAntiAffinity(imports.kubernetes.StatefulSetSpecTemplateSpecAffinityPodAntiAffinity podAntiAffinity) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements StatefulSetSpecTemplateSpecAffinity {
        private final imports.kubernetes.StatefulSetSpecTemplateSpecAffinityNodeAffinity nodeAffinity;
        private final imports.kubernetes.StatefulSetSpecTemplateSpecAffinityPodAffinity podAffinity;
        private final imports.kubernetes.StatefulSetSpecTemplateSpecAffinityPodAntiAffinity podAntiAffinity;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.nodeAffinity = software.amazon.jsii.Kernel.get(this, "nodeAffinity", software.amazon.jsii.NativeType.forClass(imports.kubernetes.StatefulSetSpecTemplateSpecAffinityNodeAffinity.class));
            this.podAffinity = software.amazon.jsii.Kernel.get(this, "podAffinity", software.amazon.jsii.NativeType.forClass(imports.kubernetes.StatefulSetSpecTemplateSpecAffinityPodAffinity.class));
            this.podAntiAffinity = software.amazon.jsii.Kernel.get(this, "podAntiAffinity", software.amazon.jsii.NativeType.forClass(imports.kubernetes.StatefulSetSpecTemplateSpecAffinityPodAntiAffinity.class));
        }
        ...
        @Override
        public final imports.kubernetes.StatefulSetSpecTemplateSpecAffinityNodeAffinity getNodeAffinity() {
            return this.nodeAffinity;
        }

        @Override
        public final imports.kubernetes.StatefulSetSpecTemplateSpecAffinityPodAffinity getPodAffinity() {
            return this.podAffinity;
        }

        @Override
        public final imports.kubernetes.StatefulSetSpecTemplateSpecAffinityPodAntiAffinity getPodAntiAffinity() {
