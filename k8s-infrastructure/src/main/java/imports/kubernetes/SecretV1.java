...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.SecretV1")
public class SecretV1 extends com.hashicorp.cdktf.TerraformResource {

    protected SecretV1(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected SecretV1(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.kubernetes.SecretV1.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public SecretV1(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.kubernetes.SecretV1Config config) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(id, "id is required"), java.util.Objects.requireNonNull(config, "config is required") });
    }

    public void putMetadata(final @org.jetbrains.annotations.NotNull imports.kubernetes.SecretV1Metadata value) {
    ...
    public void putTimeouts(final @org.jetbrains.annotations.NotNull imports.kubernetes.SecretV1Timeouts value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.kubernetes.SecretV1MetadataOutputReference getMetadata() {
        return software.amazon.jsii.Kernel.get(this, "metadata", software.amazon.jsii.NativeType.forClass(imports.kubernetes.SecretV1MetadataOutputReference.class));
    }

    public @org.jetbrains.annotations.NotNull imports.kubernetes.SecretV1TimeoutsOutputReference getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.kubernetes.SecretV1TimeoutsOutputReference.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.kubernetes.SecretV1Metadata getMetadataInput() {
        return software.amazon.jsii.Kernel.get(this, "metadataInput", software.amazon.jsii.NativeType.forClass(imports.kubernetes.SecretV1Metadata.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.kubernetes.SecretV1}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.kubernetes.SecretV1> {
        /**
        ...
        private final imports.kubernetes.SecretV1Config.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.kubernetes.SecretV1Config.Builder();
        }
         ...
         */
        public Builder metadata(final imports.kubernetes.SecretV1Metadata metadata) {
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/r/secret_v1#id SecretV1#id}. This parameter is required.
         */
         ...
         */
        public Builder timeouts(final imports.kubernetes.SecretV1Timeouts timeouts) {
        ...
        /**
         * @returns a newly built instance of {@link imports.kubernetes.SecretV1}.
         */
        @Override
        public imports.kubernetes.SecretV1 build() {
            return new imports.kubernetes.SecretV1(
                this.scope,
                this.id,
                this.config.build()
            );
