...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:39.271Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DaemonSetV1SpecTemplateSpecVolumeProjectedSourcesServiceAccountToken")
@software.amazon.jsii.Jsii.Proxy(DaemonSetV1SpecTemplateSpecVolumeProjectedSourcesServiceAccountToken.Jsii$Proxy.class)
public interface DaemonSetV1SpecTemplateSpecVolumeProjectedSourcesServiceAccountToken extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DaemonSetV1SpecTemplateSpecVolumeProjectedSourcesServiceAccountToken}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DaemonSetV1SpecTemplateSpecVolumeProjectedSourcesServiceAccountToken}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DaemonSetV1SpecTemplateSpecVolumeProjectedSourcesServiceAccountToken> {
        java.lang.String path;
        java.lang.String audience;
        java.lang.Number expirationSeconds;

        /**
         * Sets the value of {@link DaemonSetV1SpecTemplateSpecVolumeProjectedSourcesServiceAccountToken#getPath}
        ...
        /**
         * Sets the value of {@link DaemonSetV1SpecTemplateSpecVolumeProjectedSourcesServiceAccountToken#getAudience}
        ...
        /**
         * Sets the value of {@link DaemonSetV1SpecTemplateSpecVolumeProjectedSourcesServiceAccountToken#getExpirationSeconds}
         ...
         * @return a new instance of {@link DaemonSetV1SpecTemplateSpecVolumeProjectedSourcesServiceAccountToken}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DaemonSetV1SpecTemplateSpecVolumeProjectedSourcesServiceAccountToken build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DaemonSetV1SpecTemplateSpecVolumeProjectedSourcesServiceAccountToken}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DaemonSetV1SpecTemplateSpecVolumeProjectedSourcesServiceAccountToken {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DaemonSetV1SpecTemplateSpecVolumeProjectedSourcesServiceAccountToken"));
        ...
        public final boolean equals(final Object o) {
            ...
            DaemonSetV1SpecTemplateSpecVolumeProjectedSourcesServiceAccountToken.Jsii$Proxy that = (DaemonSetV1SpecTemplateSpecVolumeProjectedSourcesServiceAccountToken.Jsii$Proxy) o;
