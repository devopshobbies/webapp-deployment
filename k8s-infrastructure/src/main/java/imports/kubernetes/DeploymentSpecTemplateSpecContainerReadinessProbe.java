...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DeploymentSpecTemplateSpecContainerReadinessProbe")
@software.amazon.jsii.Jsii.Proxy(DeploymentSpecTemplateSpecContainerReadinessProbe.Jsii$Proxy.class)
public interface DeploymentSpecTemplateSpecContainerReadinessProbe extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.DeploymentSpecTemplateSpecContainerReadinessProbeExec getExec() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.DeploymentSpecTemplateSpecContainerReadinessProbeHttpGet getHttpGet() {
        return null;
    }
    ...
    /**
     * @return a {@link Builder} of {@link DeploymentSpecTemplateSpecContainerReadinessProbe}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DeploymentSpecTemplateSpecContainerReadinessProbe}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DeploymentSpecTemplateSpecContainerReadinessProbe> {
        imports.kubernetes.DeploymentSpecTemplateSpecContainerReadinessProbeExec exec;
        java.lang.Number failureThreshold;
        imports.kubernetes.DeploymentSpecTemplateSpecContainerReadinessProbeHttpGet httpGet;
        ...
        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecContainerReadinessProbe#getExec}
         * @param exec exec block.
         *             Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/deployment#exec Deployment#exec}
         * @return {@code this}
         */
        public Builder exec(imports.kubernetes.DeploymentSpecTemplateSpecContainerReadinessProbeExec exec) {
            this.exec = exec;
            return this;
        }

        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecContainerReadinessProbe#getFailureThreshold}
        ...
        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecContainerReadinessProbe#getHttpGet}
         * @param httpGet http_get block.
         *                Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/deployment#http_get Deployment#http_get}
         * @return {@code this}
         */
        public Builder httpGet(imports.kubernetes.DeploymentSpecTemplateSpecContainerReadinessProbeHttpGet httpGet) {
            this.httpGet = httpGet;
            return this;
        }

        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecContainerReadinessProbe#getInitialDelaySeconds}
        ...
        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecContainerReadinessProbe#getPeriodSeconds}
        ...
        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecContainerReadinessProbe#getSuccessThreshold}
        ...
        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecContainerReadinessProbe#getTcpSocket}
         ...
         * @return {@code this}
         */
        public Builder tcpSocket(java.util.List<? extends imports.kubernetes.DeploymentSpecTemplateSpecContainerReadinessProbeTcpSocket> tcpSocket) {
            this.tcpSocket = tcpSocket;
            return this;
        }

        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecContainerReadinessProbe#getTimeoutSeconds}
         ...
         * @return a new instance of {@link DeploymentSpecTemplateSpecContainerReadinessProbe}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DeploymentSpecTemplateSpecContainerReadinessProbe build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DeploymentSpecTemplateSpecContainerReadinessProbe}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DeploymentSpecTemplateSpecContainerReadinessProbe {
        private final imports.kubernetes.DeploymentSpecTemplateSpecContainerReadinessProbeExec exec;
        private final java.lang.Number failureThreshold;
        private final imports.kubernetes.DeploymentSpecTemplateSpecContainerReadinessProbeHttpGet httpGet;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.exec = software.amazon.jsii.Kernel.get(this, "exec", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DeploymentSpecTemplateSpecContainerReadinessProbeExec.class));
            ...
            this.httpGet = software.amazon.jsii.Kernel.get(this, "httpGet", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DeploymentSpecTemplateSpecContainerReadinessProbeHttpGet.class));
        ...
        @Override
        public final imports.kubernetes.DeploymentSpecTemplateSpecContainerReadinessProbeExec getExec() {
            return this.exec;
        }
        ...
        @Override
        public final imports.kubernetes.DeploymentSpecTemplateSpecContainerReadinessProbeHttpGet getHttpGet() {
            return this.httpGet;
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DeploymentSpecTemplateSpecContainerReadinessProbe"));
        ...
        public final boolean equals(final Object o) {
            ...
            DeploymentSpecTemplateSpecContainerReadinessProbe.Jsii$Proxy that = (DeploymentSpecTemplateSpecContainerReadinessProbe.Jsii$Proxy) o;
