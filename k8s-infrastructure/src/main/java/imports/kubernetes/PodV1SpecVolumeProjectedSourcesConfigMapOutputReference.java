...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PodV1SpecVolumeProjectedSourcesConfigMapOutputReference")
public class PodV1SpecVolumeProjectedSourcesConfigMapOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected PodV1SpecVolumeProjectedSourcesConfigMapOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected PodV1SpecVolumeProjectedSourcesConfigMapOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public @org.jetbrains.annotations.NotNull imports.kubernetes.PodV1SpecVolumeProjectedSourcesConfigMapItemsList getItems() {
        return software.amazon.jsii.Kernel.get(this, "items", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodV1SpecVolumeProjectedSourcesConfigMapItemsList.class));
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.PodV1SpecVolumeProjectedSourcesConfigMap value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
