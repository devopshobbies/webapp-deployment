...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.IngressClassV1SpecParametersList")
public class IngressClassV1SpecParametersList extends com.hashicorp.cdktf.ComplexList {

    protected IngressClassV1SpecParametersList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected IngressClassV1SpecParametersList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public IngressClassV1SpecParametersList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.kubernetes.IngressClassV1SpecParametersOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.kubernetes.IngressClassV1SpecParametersOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.IngressClassV1SpecParameters> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
