...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PersistentVolumeV1Metadata")
@software.amazon.jsii.Jsii.Proxy(PersistentVolumeV1Metadata.Jsii$Proxy.class)
public interface PersistentVolumeV1Metadata extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link PersistentVolumeV1Metadata}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link PersistentVolumeV1Metadata}
     */
    public static final class Builder implements software.amazon.jsii.Builder<PersistentVolumeV1Metadata> {
        java.util.Map<java.lang.String, java.lang.String> annotations;
        java.util.Map<java.lang.String, java.lang.String> labels;
        java.lang.String name;

        /**
         * Sets the value of {@link PersistentVolumeV1Metadata#getAnnotations}
         * @param annotations An unstructured key value map stored with the persistent volume that may be used to store arbitrary metadata.
         *                    More info: http://kubernetes.io/docs/user-guide/annotations
         *                    <p>
         *                    Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/persistent_volume_v1#annotations PersistentVolumeV1#annotations}
         * @return {@code this}
        ...
        /**
         * Sets the value of {@link PersistentVolumeV1Metadata#getLabels}
         * @param labels Map of string keys and values that can be used to organize and categorize (scope and select) the persistent volume.
         *               May match selectors of replication controllers and services. More info: http://kubernetes.io/docs/user-guide/labels
         *               <p>
         *               Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/persistent_volume_v1#labels PersistentVolumeV1#labels}
         * @return {@code this}
        ...
        /**
         * Sets the value of {@link PersistentVolumeV1Metadata#getName}
         * @param name Name of the persistent volume, must be unique. Cannot be updated. More info: http://kubernetes.io/docs/user-guide/identifiers#names.
         *             Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/persistent_volume_v1#name PersistentVolumeV1#name}
         * @return {@code this}
         */
         ...
         * @return a new instance of {@link PersistentVolumeV1Metadata}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public PersistentVolumeV1Metadata build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link PersistentVolumeV1Metadata}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PersistentVolumeV1Metadata {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.PersistentVolumeV1Metadata"));
        ...
        public final boolean equals(final Object o) {
            ...
            PersistentVolumeV1Metadata.Jsii$Proxy that = (PersistentVolumeV1Metadata.Jsii$Proxy) o;
