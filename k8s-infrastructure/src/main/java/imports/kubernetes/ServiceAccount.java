 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:40.898Z")
...
public class ServiceAccount extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.kubernetes.ServiceAccount.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
    ...
    public void putMetadata(final @org.jetbrains.annotations.NotNull imports.kubernetes.ServiceAccountMetadata value) {
    ...
    public void putTimeouts(final @org.jetbrains.annotations.NotNull imports.kubernetes.ServiceAccountTimeouts value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.kubernetes.ServiceAccountImagePullSecretList getImagePullSecret() {
        return software.amazon.jsii.Kernel.get(this, "imagePullSecret", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ServiceAccountImagePullSecretList.class));
    }

    public @org.jetbrains.annotations.NotNull imports.kubernetes.ServiceAccountMetadataOutputReference getMetadata() {
        return software.amazon.jsii.Kernel.get(this, "metadata", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ServiceAccountMetadataOutputReference.class));
    }

    public @org.jetbrains.annotations.NotNull imports.kubernetes.ServiceAccountSecretList getSecret() {
        return software.amazon.jsii.Kernel.get(this, "secret", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ServiceAccountSecretList.class));
    }

    public @org.jetbrains.annotations.NotNull imports.kubernetes.ServiceAccountTimeoutsOutputReference getTimeouts() {
        return software.amazon.jsii.Kernel.get(this, "timeouts", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ServiceAccountTimeoutsOutputReference.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.kubernetes.ServiceAccountMetadata getMetadataInput() {
        return software.amazon.jsii.Kernel.get(this, "metadataInput", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ServiceAccountMetadata.class));
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<imports.kubernetes.ServiceAccount> {
         ...
         */
        public Builder metadata(final imports.kubernetes.ServiceAccountMetadata metadata) {
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/r/service_account#id ServiceAccount#id}. This parameter is required.
         */
