...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.MutatingWebhookConfigurationWebhookObjectSelector")
@software.amazon.jsii.Jsii.Proxy(MutatingWebhookConfigurationWebhookObjectSelector.Jsii$Proxy.class)
public interface MutatingWebhookConfigurationWebhookObjectSelector extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link MutatingWebhookConfigurationWebhookObjectSelector}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link MutatingWebhookConfigurationWebhookObjectSelector}
     */
    public static final class Builder implements software.amazon.jsii.Builder<MutatingWebhookConfigurationWebhookObjectSelector> {
        java.lang.Object matchExpressions;
        java.util.Map<java.lang.String, java.lang.String> matchLabels;

        /**
         * Sets the value of {@link MutatingWebhookConfigurationWebhookObjectSelector#getMatchExpressions}
         ...
         * @return {@code this}
         */
        public Builder matchExpressions(java.util.List<? extends imports.kubernetes.MutatingWebhookConfigurationWebhookObjectSelectorMatchExpressions> matchExpressions) {
            this.matchExpressions = matchExpressions;
            return this;
        }

        /**
         * Sets the value of {@link MutatingWebhookConfigurationWebhookObjectSelector#getMatchLabels}
         ...
         * @return a new instance of {@link MutatingWebhookConfigurationWebhookObjectSelector}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public MutatingWebhookConfigurationWebhookObjectSelector build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link MutatingWebhookConfigurationWebhookObjectSelector}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements MutatingWebhookConfigurationWebhookObjectSelector {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.MutatingWebhookConfigurationWebhookObjectSelector"));
        ...
        public final boolean equals(final Object o) {
            ...
            MutatingWebhookConfigurationWebhookObjectSelector.Jsii$Proxy that = (MutatingWebhookConfigurationWebhookObjectSelector.Jsii$Proxy) o;
