...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DeploymentSpecTemplateSpecVolumeEmptyDir")
@software.amazon.jsii.Jsii.Proxy(DeploymentSpecTemplateSpecVolumeEmptyDir.Jsii$Proxy.class)
public interface DeploymentSpecTemplateSpecVolumeEmptyDir extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DeploymentSpecTemplateSpecVolumeEmptyDir}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DeploymentSpecTemplateSpecVolumeEmptyDir}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DeploymentSpecTemplateSpecVolumeEmptyDir> {
        java.lang.String medium;
        java.lang.String sizeLimit;

        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecVolumeEmptyDir#getMedium}
        ...
        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecVolumeEmptyDir#getSizeLimit}
         ...
         * @return a new instance of {@link DeploymentSpecTemplateSpecVolumeEmptyDir}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DeploymentSpecTemplateSpecVolumeEmptyDir build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DeploymentSpecTemplateSpecVolumeEmptyDir}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DeploymentSpecTemplateSpecVolumeEmptyDir {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DeploymentSpecTemplateSpecVolumeEmptyDir"));
        ...
        public final boolean equals(final Object o) {
            ...
            DeploymentSpecTemplateSpecVolumeEmptyDir.Jsii$Proxy that = (DeploymentSpecTemplateSpecVolumeEmptyDir.Jsii$Proxy) o;
