...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.NetworkPolicySpecIngressFromPodSelector")
@software.amazon.jsii.Jsii.Proxy(NetworkPolicySpecIngressFromPodSelector.Jsii$Proxy.class)
public interface NetworkPolicySpecIngressFromPodSelector extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link NetworkPolicySpecIngressFromPodSelector}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link NetworkPolicySpecIngressFromPodSelector}
     */
    public static final class Builder implements software.amazon.jsii.Builder<NetworkPolicySpecIngressFromPodSelector> {
        java.lang.Object matchExpressions;
        java.util.Map<java.lang.String, java.lang.String> matchLabels;

        /**
         * Sets the value of {@link NetworkPolicySpecIngressFromPodSelector#getMatchExpressions}
         ...
         * @return {@code this}
         */
        public Builder matchExpressions(java.util.List<? extends imports.kubernetes.NetworkPolicySpecIngressFromPodSelectorMatchExpressions> matchExpressions) {
            this.matchExpressions = matchExpressions;
            return this;
        }

        /**
         * Sets the value of {@link NetworkPolicySpecIngressFromPodSelector#getMatchLabels}
         ...
         * @return a new instance of {@link NetworkPolicySpecIngressFromPodSelector}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public NetworkPolicySpecIngressFromPodSelector build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link NetworkPolicySpecIngressFromPodSelector}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements NetworkPolicySpecIngressFromPodSelector {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.NetworkPolicySpecIngressFromPodSelector"));
        ...
        public final boolean equals(final Object o) {
            ...
            NetworkPolicySpecIngressFromPodSelector.Jsii$Proxy that = (NetworkPolicySpecIngressFromPodSelector.Jsii$Proxy) o;
