...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:40.696Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContext")
@software.amazon.jsii.Jsii.Proxy(ReplicationControllerSpecTemplateSpecContainerSecurityContext.Jsii$Proxy.class)
public interface ReplicationControllerSpecTemplateSpecContainerSecurityContext extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextCapabilities getCapabilities() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextSeccompProfile getSeccompProfile() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextSeLinuxOptions getSeLinuxOptions() {
        return null;
    }

    /**
     * @return a {@link Builder} of {@link ReplicationControllerSpecTemplateSpecContainerSecurityContext}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ReplicationControllerSpecTemplateSpecContainerSecurityContext}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ReplicationControllerSpecTemplateSpecContainerSecurityContext> {
        java.lang.Object allowPrivilegeEscalation;
        imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextCapabilities capabilities;
        ...
        imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextSeccompProfile seccompProfile;
        imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextSeLinuxOptions seLinuxOptions;

        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateSpecContainerSecurityContext#getAllowPrivilegeEscalation}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateSpecContainerSecurityContext#getCapabilities}
         * @param capabilities capabilities block.
         *                     Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/replication_controller#capabilities ReplicationController#capabilities}
         * @return {@code this}
         */
        public Builder capabilities(imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextCapabilities capabilities) {
            this.capabilities = capabilities;
            return this;
        }

        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateSpecContainerSecurityContext#getPrivileged}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateSpecContainerSecurityContext#getReadOnlyRootFilesystem}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateSpecContainerSecurityContext#getRunAsGroup}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateSpecContainerSecurityContext#getRunAsNonRoot}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateSpecContainerSecurityContext#getRunAsUser}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateSpecContainerSecurityContext#getSeccompProfile}
         * @param seccompProfile seccomp_profile block.
         *                       Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/replication_controller#seccomp_profile ReplicationController#seccomp_profile}
         * @return {@code this}
         */
        public Builder seccompProfile(imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextSeccompProfile seccompProfile) {
            this.seccompProfile = seccompProfile;
            return this;
        }

        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateSpecContainerSecurityContext#getSeLinuxOptions}
         * @param seLinuxOptions se_linux_options block.
         *                       Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/replication_controller#se_linux_options ReplicationController#se_linux_options}
         * @return {@code this}
         */
        public Builder seLinuxOptions(imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextSeLinuxOptions seLinuxOptions) {
         ...
         * @return a new instance of {@link ReplicationControllerSpecTemplateSpecContainerSecurityContext}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ReplicationControllerSpecTemplateSpecContainerSecurityContext build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link ReplicationControllerSpecTemplateSpecContainerSecurityContext}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ReplicationControllerSpecTemplateSpecContainerSecurityContext {
        private final java.lang.Object allowPrivilegeEscalation;
        private final imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextCapabilities capabilities;
        ...
        private final imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextSeccompProfile seccompProfile;
        private final imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextSeLinuxOptions seLinuxOptions;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.capabilities = software.amazon.jsii.Kernel.get(this, "capabilities", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextCapabilities.class));
            ...
            this.seccompProfile = software.amazon.jsii.Kernel.get(this, "seccompProfile", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextSeccompProfile.class));
            this.seLinuxOptions = software.amazon.jsii.Kernel.get(this, "seLinuxOptions", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextSeLinuxOptions.class));
        }
        ...
        @Override
        public final imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextCapabilities getCapabilities() {
        ...
        @Override
        public final imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextSeccompProfile getSeccompProfile() {
            return this.seccompProfile;
        }

        @Override
        public final imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextSeLinuxOptions getSeLinuxOptions() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContext"));
        ...
        public final boolean equals(final Object o) {
            ...
            ReplicationControllerSpecTemplateSpecContainerSecurityContext.Jsii$Proxy that = (ReplicationControllerSpecTemplateSpecContainerSecurityContext.Jsii$Proxy) o;
