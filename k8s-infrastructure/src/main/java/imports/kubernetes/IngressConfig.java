...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:39.915Z")
...
public interface IngressConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
     ...
     */
    @org.jetbrains.annotations.NotNull imports.kubernetes.IngressMetadata getMetadata();
     ...
     */
    @org.jetbrains.annotations.NotNull imports.kubernetes.IngressSpec getSpec();
    ...
    public static final class Builder implements software.amazon.jsii.Builder<IngressConfig> {
        imports.kubernetes.IngressMetadata metadata;
        imports.kubernetes.IngressSpec spec;
        java.lang.String id;
         ...
         * @return {@code this}
         */
        public Builder metadata(imports.kubernetes.IngressMetadata metadata) {
         ...
         * @return {@code this}
         */
        public Builder spec(imports.kubernetes.IngressSpec spec) {
            this.spec = spec;
            return this;
        }

        /**
         * Sets the value of {@link IngressConfig#getId}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/r/ingress#id Ingress#id}.
         *           Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2.
         *           If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link IngressConfig#getConnection}
        ...
        /**
         * Sets the value of {@link IngressConfig#getForEach}
        ...
        /**
         * Sets the value of {@link IngressConfig#getProvisioners}
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements IngressConfig {
        private final imports.kubernetes.IngressMetadata metadata;
        private final imports.kubernetes.IngressSpec spec;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.metadata = software.amazon.jsii.Kernel.get(this, "metadata", software.amazon.jsii.NativeType.forClass(imports.kubernetes.IngressMetadata.class));
            this.spec = software.amazon.jsii.Kernel.get(this, "spec", software.amazon.jsii.NativeType.forClass(imports.kubernetes.IngressSpec.class));
        ...
        @Override
        public final imports.kubernetes.IngressMetadata getMetadata() {
            return this.metadata;
        }

        @Override
        public final imports.kubernetes.IngressSpec getSpec() {
            return this.spec;
        }
