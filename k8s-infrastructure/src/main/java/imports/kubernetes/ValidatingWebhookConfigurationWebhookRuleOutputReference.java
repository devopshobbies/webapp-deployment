...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.ValidatingWebhookConfigurationWebhookRuleOutputReference")
public class ValidatingWebhookConfigurationWebhookRuleOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected ValidatingWebhookConfigurationWebhookRuleOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected ValidatingWebhookConfigurationWebhookRuleOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.ValidatingWebhookConfigurationWebhookRule value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
