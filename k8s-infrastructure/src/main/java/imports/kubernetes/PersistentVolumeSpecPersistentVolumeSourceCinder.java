...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PersistentVolumeSpecPersistentVolumeSourceCinder")
@software.amazon.jsii.Jsii.Proxy(PersistentVolumeSpecPersistentVolumeSourceCinder.Jsii$Proxy.class)
public interface PersistentVolumeSpecPersistentVolumeSourceCinder extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link PersistentVolumeSpecPersistentVolumeSourceCinder}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link PersistentVolumeSpecPersistentVolumeSourceCinder}
     */
    public static final class Builder implements software.amazon.jsii.Builder<PersistentVolumeSpecPersistentVolumeSourceCinder> {
        java.lang.String volumeId;
        java.lang.String fsType;
        java.lang.Object readOnly;

        /**
         * Sets the value of {@link PersistentVolumeSpecPersistentVolumeSourceCinder#getVolumeId}
        ...
        /**
         * Sets the value of {@link PersistentVolumeSpecPersistentVolumeSourceCinder#getFsType}
        ...
        /**
         * Sets the value of {@link PersistentVolumeSpecPersistentVolumeSourceCinder#getReadOnly}
         ...
         * @return a new instance of {@link PersistentVolumeSpecPersistentVolumeSourceCinder}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public PersistentVolumeSpecPersistentVolumeSourceCinder build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link PersistentVolumeSpecPersistentVolumeSourceCinder}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PersistentVolumeSpecPersistentVolumeSourceCinder {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.PersistentVolumeSpecPersistentVolumeSourceCinder"));
        ...
        public final boolean equals(final Object o) {
            ...
            PersistentVolumeSpecPersistentVolumeSourceCinder.Jsii$Proxy that = (PersistentVolumeSpecPersistentVolumeSourceCinder.Jsii$Proxy) o;
