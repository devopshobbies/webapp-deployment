...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:39.306Z")
...
public interface DaemonsetSpecTemplateSpecContainerEnvValueFrom extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.DaemonsetSpecTemplateSpecContainerEnvValueFromConfigMapKeyRef getConfigMapKeyRef() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.DaemonsetSpecTemplateSpecContainerEnvValueFromFieldRef getFieldRef() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.DaemonsetSpecTemplateSpecContainerEnvValueFromResourceFieldRef getResourceFieldRef() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.DaemonsetSpecTemplateSpecContainerEnvValueFromSecretKeyRef getSecretKeyRef() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<DaemonsetSpecTemplateSpecContainerEnvValueFrom> {
        imports.kubernetes.DaemonsetSpecTemplateSpecContainerEnvValueFromConfigMapKeyRef configMapKeyRef;
        imports.kubernetes.DaemonsetSpecTemplateSpecContainerEnvValueFromFieldRef fieldRef;
        imports.kubernetes.DaemonsetSpecTemplateSpecContainerEnvValueFromResourceFieldRef resourceFieldRef;
         ...
         * @return {@code this}
         */
        public Builder configMapKeyRef(imports.kubernetes.DaemonsetSpecTemplateSpecContainerEnvValueFromConfigMapKeyRef configMapKeyRef) {
         ...
         * @return {@code this}
         */
        public Builder fieldRef(imports.kubernetes.DaemonsetSpecTemplateSpecContainerEnvValueFromFieldRef fieldRef) {
         ...
         * @return {@code this}
         */
        public Builder resourceFieldRef(imports.kubernetes.DaemonsetSpecTemplateSpecContainerEnvValueFromResourceFieldRef resourceFieldRef) {
         ...
         * @return {@code this}
         */
        public Builder secretKeyRef(imports.kubernetes.DaemonsetSpecTemplateSpecContainerEnvValueFromSecretKeyRef secretKeyRef) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DaemonsetSpecTemplateSpecContainerEnvValueFrom {
        private final imports.kubernetes.DaemonsetSpecTemplateSpecContainerEnvValueFromConfigMapKeyRef configMapKeyRef;
        private final imports.kubernetes.DaemonsetSpecTemplateSpecContainerEnvValueFromFieldRef fieldRef;
        private final imports.kubernetes.DaemonsetSpecTemplateSpecContainerEnvValueFromResourceFieldRef resourceFieldRef;
        private final imports.kubernetes.DaemonsetSpecTemplateSpecContainerEnvValueFromSecretKeyRef secretKeyRef;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.configMapKeyRef = software.amazon.jsii.Kernel.get(this, "configMapKeyRef", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DaemonsetSpecTemplateSpecContainerEnvValueFromConfigMapKeyRef.class));
            this.fieldRef = software.amazon.jsii.Kernel.get(this, "fieldRef", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DaemonsetSpecTemplateSpecContainerEnvValueFromFieldRef.class));
            this.resourceFieldRef = software.amazon.jsii.Kernel.get(this, "resourceFieldRef", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DaemonsetSpecTemplateSpecContainerEnvValueFromResourceFieldRef.class));
            this.secretKeyRef = software.amazon.jsii.Kernel.get(this, "secretKeyRef", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DaemonsetSpecTemplateSpecContainerEnvValueFromSecretKeyRef.class));
        }
        ...
        @Override
        public final imports.kubernetes.DaemonsetSpecTemplateSpecContainerEnvValueFromConfigMapKeyRef getConfigMapKeyRef() {
            return this.configMapKeyRef;
        }

        @Override
        public final imports.kubernetes.DaemonsetSpecTemplateSpecContainerEnvValueFromFieldRef getFieldRef() {
            return this.fieldRef;
        }

        @Override
        public final imports.kubernetes.DaemonsetSpecTemplateSpecContainerEnvValueFromResourceFieldRef getResourceFieldRef() {
            return this.resourceFieldRef;
        }

        @Override
        public final imports.kubernetes.DaemonsetSpecTemplateSpecContainerEnvValueFromSecretKeyRef getSecretKeyRef() {
