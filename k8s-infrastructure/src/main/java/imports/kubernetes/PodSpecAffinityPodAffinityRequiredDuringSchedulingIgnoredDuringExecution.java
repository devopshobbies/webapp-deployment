...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PodSpecAffinityPodAffinityRequiredDuringSchedulingIgnoredDuringExecution")
@software.amazon.jsii.Jsii.Proxy(PodSpecAffinityPodAffinityRequiredDuringSchedulingIgnoredDuringExecution.Jsii$Proxy.class)
public interface PodSpecAffinityPodAffinityRequiredDuringSchedulingIgnoredDuringExecution extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link PodSpecAffinityPodAffinityRequiredDuringSchedulingIgnoredDuringExecution}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link PodSpecAffinityPodAffinityRequiredDuringSchedulingIgnoredDuringExecution}
     */
    public static final class Builder implements software.amazon.jsii.Builder<PodSpecAffinityPodAffinityRequiredDuringSchedulingIgnoredDuringExecution> {
        java.lang.String topologyKey;
        java.lang.Object labelSelector;
        java.util.List<java.lang.String> namespaces;

        /**
         * Sets the value of {@link PodSpecAffinityPodAffinityRequiredDuringSchedulingIgnoredDuringExecution#getTopologyKey}
        ...
        /**
         * Sets the value of {@link PodSpecAffinityPodAffinityRequiredDuringSchedulingIgnoredDuringExecution#getLabelSelector}
         ...
         * @return {@code this}
         */
        public Builder labelSelector(java.util.List<? extends imports.kubernetes.PodSpecAffinityPodAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelector> labelSelector) {
            this.labelSelector = labelSelector;
            return this;
        }

        /**
         * Sets the value of {@link PodSpecAffinityPodAffinityRequiredDuringSchedulingIgnoredDuringExecution#getNamespaces}
         ...
         * @return a new instance of {@link PodSpecAffinityPodAffinityRequiredDuringSchedulingIgnoredDuringExecution}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public PodSpecAffinityPodAffinityRequiredDuringSchedulingIgnoredDuringExecution build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link PodSpecAffinityPodAffinityRequiredDuringSchedulingIgnoredDuringExecution}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodSpecAffinityPodAffinityRequiredDuringSchedulingIgnoredDuringExecution {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.PodSpecAffinityPodAffinityRequiredDuringSchedulingIgnoredDuringExecution"));
        ...
        public final boolean equals(final Object o) {
            ...
            PodSpecAffinityPodAffinityRequiredDuringSchedulingIgnoredDuringExecution.Jsii$Proxy that = (PodSpecAffinityPodAffinityRequiredDuringSchedulingIgnoredDuringExecution.Jsii$Proxy) o;
