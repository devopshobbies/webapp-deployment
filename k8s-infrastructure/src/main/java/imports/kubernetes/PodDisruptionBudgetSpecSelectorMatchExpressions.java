...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PodDisruptionBudgetSpecSelectorMatchExpressions")
@software.amazon.jsii.Jsii.Proxy(PodDisruptionBudgetSpecSelectorMatchExpressions.Jsii$Proxy.class)
public interface PodDisruptionBudgetSpecSelectorMatchExpressions extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link PodDisruptionBudgetSpecSelectorMatchExpressions}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link PodDisruptionBudgetSpecSelectorMatchExpressions}
     */
    public static final class Builder implements software.amazon.jsii.Builder<PodDisruptionBudgetSpecSelectorMatchExpressions> {
        java.lang.String key;
        java.lang.String operator;
        java.util.List<java.lang.String> values;

        /**
         * Sets the value of {@link PodDisruptionBudgetSpecSelectorMatchExpressions#getKey}
        ...
        /**
         * Sets the value of {@link PodDisruptionBudgetSpecSelectorMatchExpressions#getOperator}
        ...
        /**
         * Sets the value of {@link PodDisruptionBudgetSpecSelectorMatchExpressions#getValues}
         ...
         * @return a new instance of {@link PodDisruptionBudgetSpecSelectorMatchExpressions}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public PodDisruptionBudgetSpecSelectorMatchExpressions build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link PodDisruptionBudgetSpecSelectorMatchExpressions}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodDisruptionBudgetSpecSelectorMatchExpressions {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.PodDisruptionBudgetSpecSelectorMatchExpressions"));
        ...
        public final boolean equals(final Object o) {
            ...
            PodDisruptionBudgetSpecSelectorMatchExpressions.Jsii$Proxy that = (PodDisruptionBudgetSpecSelectorMatchExpressions.Jsii$Proxy) o;
