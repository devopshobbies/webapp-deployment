...
public interface JobSpecTemplateSpecInitContainerLifecyclePreStop extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.JobSpecTemplateSpecInitContainerLifecyclePreStopExec getExec() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.JobSpecTemplateSpecInitContainerLifecyclePreStopHttpGet getHttpGet() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<JobSpecTemplateSpecInitContainerLifecyclePreStop> {
        imports.kubernetes.JobSpecTemplateSpecInitContainerLifecyclePreStopExec exec;
        imports.kubernetes.JobSpecTemplateSpecInitContainerLifecyclePreStopHttpGet httpGet;
         ...
         * @return {@code this}
         */
        public Builder exec(imports.kubernetes.JobSpecTemplateSpecInitContainerLifecyclePreStopExec exec) {
            this.exec = exec;
            return this;
        }
         ...
         * @return {@code this}
         */
        public Builder httpGet(imports.kubernetes.JobSpecTemplateSpecInitContainerLifecyclePreStopHttpGet httpGet) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements JobSpecTemplateSpecInitContainerLifecyclePreStop {
        private final imports.kubernetes.JobSpecTemplateSpecInitContainerLifecyclePreStopExec exec;
        private final imports.kubernetes.JobSpecTemplateSpecInitContainerLifecyclePreStopHttpGet httpGet;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.exec = software.amazon.jsii.Kernel.get(this, "exec", software.amazon.jsii.NativeType.forClass(imports.kubernetes.JobSpecTemplateSpecInitContainerLifecyclePreStopExec.class));
            this.httpGet = software.amazon.jsii.Kernel.get(this, "httpGet", software.amazon.jsii.NativeType.forClass(imports.kubernetes.JobSpecTemplateSpecInitContainerLifecyclePreStopHttpGet.class));
        ...
        @Override
        public final imports.kubernetes.JobSpecTemplateSpecInitContainerLifecyclePreStopExec getExec() {
            return this.exec;
        }

        @Override
        public final imports.kubernetes.JobSpecTemplateSpecInitContainerLifecyclePreStopHttpGet getHttpGet() {
            return this.httpGet;
        }
