...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.StatefulSetV1SpecTemplateSpecHostAliases")
@software.amazon.jsii.Jsii.Proxy(StatefulSetV1SpecTemplateSpecHostAliases.Jsii$Proxy.class)
public interface StatefulSetV1SpecTemplateSpecHostAliases extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link StatefulSetV1SpecTemplateSpecHostAliases}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link StatefulSetV1SpecTemplateSpecHostAliases}
     */
    public static final class Builder implements software.amazon.jsii.Builder<StatefulSetV1SpecTemplateSpecHostAliases> {
        java.util.List<java.lang.String> hostnames;
        java.lang.String ip;

        /**
         * Sets the value of {@link StatefulSetV1SpecTemplateSpecHostAliases#getHostnames}
        ...
        /**
         * Sets the value of {@link StatefulSetV1SpecTemplateSpecHostAliases#getIp}
         ...
         * @return a new instance of {@link StatefulSetV1SpecTemplateSpecHostAliases}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public StatefulSetV1SpecTemplateSpecHostAliases build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link StatefulSetV1SpecTemplateSpecHostAliases}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements StatefulSetV1SpecTemplateSpecHostAliases {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.StatefulSetV1SpecTemplateSpecHostAliases"));
        ...
        public final boolean equals(final Object o) {
            ...
            StatefulSetV1SpecTemplateSpecHostAliases.Jsii$Proxy that = (StatefulSetV1SpecTemplateSpecHostAliases.Jsii$Proxy) o;
