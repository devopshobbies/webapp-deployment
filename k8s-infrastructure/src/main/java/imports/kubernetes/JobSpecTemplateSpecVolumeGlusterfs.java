...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:40.024Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.JobSpecTemplateSpecVolumeGlusterfs")
@software.amazon.jsii.Jsii.Proxy(JobSpecTemplateSpecVolumeGlusterfs.Jsii$Proxy.class)
public interface JobSpecTemplateSpecVolumeGlusterfs extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link JobSpecTemplateSpecVolumeGlusterfs}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link JobSpecTemplateSpecVolumeGlusterfs}
     */
    public static final class Builder implements software.amazon.jsii.Builder<JobSpecTemplateSpecVolumeGlusterfs> {
        java.lang.String endpointsName;
        java.lang.String path;
        java.lang.Object readOnly;

        /**
         * Sets the value of {@link JobSpecTemplateSpecVolumeGlusterfs#getEndpointsName}
        ...
        /**
         * Sets the value of {@link JobSpecTemplateSpecVolumeGlusterfs#getPath}
        ...
        /**
         * Sets the value of {@link JobSpecTemplateSpecVolumeGlusterfs#getReadOnly}
         ...
         * @return a new instance of {@link JobSpecTemplateSpecVolumeGlusterfs}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public JobSpecTemplateSpecVolumeGlusterfs build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link JobSpecTemplateSpecVolumeGlusterfs}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements JobSpecTemplateSpecVolumeGlusterfs {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.JobSpecTemplateSpecVolumeGlusterfs"));
        ...
        public final boolean equals(final Object o) {
            ...
            JobSpecTemplateSpecVolumeGlusterfs.Jsii$Proxy that = (JobSpecTemplateSpecVolumeGlusterfs.Jsii$Proxy) o;
