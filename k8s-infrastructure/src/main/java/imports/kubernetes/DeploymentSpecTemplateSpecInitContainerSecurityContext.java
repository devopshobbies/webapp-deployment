...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:39.683Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DeploymentSpecTemplateSpecInitContainerSecurityContext")
@software.amazon.jsii.Jsii.Proxy(DeploymentSpecTemplateSpecInitContainerSecurityContext.Jsii$Proxy.class)
public interface DeploymentSpecTemplateSpecInitContainerSecurityContext extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.DeploymentSpecTemplateSpecInitContainerSecurityContextCapabilities getCapabilities() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.DeploymentSpecTemplateSpecInitContainerSecurityContextSeccompProfile getSeccompProfile() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.DeploymentSpecTemplateSpecInitContainerSecurityContextSeLinuxOptions getSeLinuxOptions() {
        return null;
    }

    /**
     * @return a {@link Builder} of {@link DeploymentSpecTemplateSpecInitContainerSecurityContext}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DeploymentSpecTemplateSpecInitContainerSecurityContext}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DeploymentSpecTemplateSpecInitContainerSecurityContext> {
        java.lang.Object allowPrivilegeEscalation;
        imports.kubernetes.DeploymentSpecTemplateSpecInitContainerSecurityContextCapabilities capabilities;
        ...
        imports.kubernetes.DeploymentSpecTemplateSpecInitContainerSecurityContextSeccompProfile seccompProfile;
        imports.kubernetes.DeploymentSpecTemplateSpecInitContainerSecurityContextSeLinuxOptions seLinuxOptions;

        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecInitContainerSecurityContext#getAllowPrivilegeEscalation}
        ...
        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecInitContainerSecurityContext#getCapabilities}
         * @param capabilities capabilities block.
         *                     Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/deployment#capabilities Deployment#capabilities}
         * @return {@code this}
         */
        public Builder capabilities(imports.kubernetes.DeploymentSpecTemplateSpecInitContainerSecurityContextCapabilities capabilities) {
            this.capabilities = capabilities;
            return this;
        }

        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecInitContainerSecurityContext#getPrivileged}
        ...
        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecInitContainerSecurityContext#getReadOnlyRootFilesystem}
        ...
        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecInitContainerSecurityContext#getRunAsGroup}
        ...
        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecInitContainerSecurityContext#getRunAsNonRoot}
        ...
        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecInitContainerSecurityContext#getRunAsUser}
        ...
        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecInitContainerSecurityContext#getSeccompProfile}
         * @param seccompProfile seccomp_profile block.
         *                       Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/deployment#seccomp_profile Deployment#seccomp_profile}
         * @return {@code this}
         */
        public Builder seccompProfile(imports.kubernetes.DeploymentSpecTemplateSpecInitContainerSecurityContextSeccompProfile seccompProfile) {
            this.seccompProfile = seccompProfile;
            return this;
        }

        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecInitContainerSecurityContext#getSeLinuxOptions}
         * @param seLinuxOptions se_linux_options block.
         *                       Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/deployment#se_linux_options Deployment#se_linux_options}
         * @return {@code this}
         */
        public Builder seLinuxOptions(imports.kubernetes.DeploymentSpecTemplateSpecInitContainerSecurityContextSeLinuxOptions seLinuxOptions) {
         ...
         * @return a new instance of {@link DeploymentSpecTemplateSpecInitContainerSecurityContext}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DeploymentSpecTemplateSpecInitContainerSecurityContext build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DeploymentSpecTemplateSpecInitContainerSecurityContext}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DeploymentSpecTemplateSpecInitContainerSecurityContext {
        private final java.lang.Object allowPrivilegeEscalation;
        private final imports.kubernetes.DeploymentSpecTemplateSpecInitContainerSecurityContextCapabilities capabilities;
        ...
        private final imports.kubernetes.DeploymentSpecTemplateSpecInitContainerSecurityContextSeccompProfile seccompProfile;
        private final imports.kubernetes.DeploymentSpecTemplateSpecInitContainerSecurityContextSeLinuxOptions seLinuxOptions;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.capabilities = software.amazon.jsii.Kernel.get(this, "capabilities", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DeploymentSpecTemplateSpecInitContainerSecurityContextCapabilities.class));
            ...
            this.seccompProfile = software.amazon.jsii.Kernel.get(this, "seccompProfile", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DeploymentSpecTemplateSpecInitContainerSecurityContextSeccompProfile.class));
            this.seLinuxOptions = software.amazon.jsii.Kernel.get(this, "seLinuxOptions", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DeploymentSpecTemplateSpecInitContainerSecurityContextSeLinuxOptions.class));
        }
        ...
        @Override
        public final imports.kubernetes.DeploymentSpecTemplateSpecInitContainerSecurityContextCapabilities getCapabilities() {
        ...
        @Override
        public final imports.kubernetes.DeploymentSpecTemplateSpecInitContainerSecurityContextSeccompProfile getSeccompProfile() {
            return this.seccompProfile;
        }

        @Override
        public final imports.kubernetes.DeploymentSpecTemplateSpecInitContainerSecurityContextSeLinuxOptions getSeLinuxOptions() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DeploymentSpecTemplateSpecInitContainerSecurityContext"));
        ...
        public final boolean equals(final Object o) {
            ...
            DeploymentSpecTemplateSpecInitContainerSecurityContext.Jsii$Proxy that = (DeploymentSpecTemplateSpecInitContainerSecurityContext.Jsii$Proxy) o;
