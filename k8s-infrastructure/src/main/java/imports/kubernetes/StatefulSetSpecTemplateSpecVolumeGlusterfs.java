...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.StatefulSetSpecTemplateSpecVolumeGlusterfs")
@software.amazon.jsii.Jsii.Proxy(StatefulSetSpecTemplateSpecVolumeGlusterfs.Jsii$Proxy.class)
public interface StatefulSetSpecTemplateSpecVolumeGlusterfs extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link StatefulSetSpecTemplateSpecVolumeGlusterfs}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link StatefulSetSpecTemplateSpecVolumeGlusterfs}
     */
    public static final class Builder implements software.amazon.jsii.Builder<StatefulSetSpecTemplateSpecVolumeGlusterfs> {
        java.lang.String endpointsName;
        java.lang.String path;
        java.lang.Object readOnly;

        /**
         * Sets the value of {@link StatefulSetSpecTemplateSpecVolumeGlusterfs#getEndpointsName}
        ...
        /**
         * Sets the value of {@link StatefulSetSpecTemplateSpecVolumeGlusterfs#getPath}
        ...
        /**
         * Sets the value of {@link StatefulSetSpecTemplateSpecVolumeGlusterfs#getReadOnly}
         ...
         * @return a new instance of {@link StatefulSetSpecTemplateSpecVolumeGlusterfs}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public StatefulSetSpecTemplateSpecVolumeGlusterfs build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link StatefulSetSpecTemplateSpecVolumeGlusterfs}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements StatefulSetSpecTemplateSpecVolumeGlusterfs {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.StatefulSetSpecTemplateSpecVolumeGlusterfs"));
        ...
        public final boolean equals(final Object o) {
            ...
            StatefulSetSpecTemplateSpecVolumeGlusterfs.Jsii$Proxy that = (StatefulSetSpecTemplateSpecVolumeGlusterfs.Jsii$Proxy) o;
