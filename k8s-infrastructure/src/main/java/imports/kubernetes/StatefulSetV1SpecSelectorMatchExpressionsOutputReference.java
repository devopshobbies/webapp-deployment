...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.StatefulSetV1SpecSelectorMatchExpressionsOutputReference")
public class StatefulSetV1SpecSelectorMatchExpressionsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected StatefulSetV1SpecSelectorMatchExpressionsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected StatefulSetV1SpecSelectorMatchExpressionsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.StatefulSetV1SpecSelectorMatchExpressions value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
