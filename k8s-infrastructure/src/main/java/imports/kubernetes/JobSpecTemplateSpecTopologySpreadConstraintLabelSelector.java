...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.JobSpecTemplateSpecTopologySpreadConstraintLabelSelector")
@software.amazon.jsii.Jsii.Proxy(JobSpecTemplateSpecTopologySpreadConstraintLabelSelector.Jsii$Proxy.class)
public interface JobSpecTemplateSpecTopologySpreadConstraintLabelSelector extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link JobSpecTemplateSpecTopologySpreadConstraintLabelSelector}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link JobSpecTemplateSpecTopologySpreadConstraintLabelSelector}
     */
    public static final class Builder implements software.amazon.jsii.Builder<JobSpecTemplateSpecTopologySpreadConstraintLabelSelector> {
        java.lang.Object matchExpressions;
        java.util.Map<java.lang.String, java.lang.String> matchLabels;

        /**
         * Sets the value of {@link JobSpecTemplateSpecTopologySpreadConstraintLabelSelector#getMatchExpressions}
         ...
         * @return {@code this}
         */
        public Builder matchExpressions(java.util.List<? extends imports.kubernetes.JobSpecTemplateSpecTopologySpreadConstraintLabelSelectorMatchExpressions> matchExpressions) {
            this.matchExpressions = matchExpressions;
            return this;
        }

        /**
         * Sets the value of {@link JobSpecTemplateSpecTopologySpreadConstraintLabelSelector#getMatchLabels}
         ...
         * @return a new instance of {@link JobSpecTemplateSpecTopologySpreadConstraintLabelSelector}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public JobSpecTemplateSpecTopologySpreadConstraintLabelSelector build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link JobSpecTemplateSpecTopologySpreadConstraintLabelSelector}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements JobSpecTemplateSpecTopologySpreadConstraintLabelSelector {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.JobSpecTemplateSpecTopologySpreadConstraintLabelSelector"));
        ...
        public final boolean equals(final Object o) {
            ...
            JobSpecTemplateSpecTopologySpreadConstraintLabelSelector.Jsii$Proxy that = (JobSpecTemplateSpecTopologySpreadConstraintLabelSelector.Jsii$Proxy) o;
