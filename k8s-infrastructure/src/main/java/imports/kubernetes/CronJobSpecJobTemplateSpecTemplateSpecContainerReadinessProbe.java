...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:38.905Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbe")
@software.amazon.jsii.Jsii.Proxy(CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbe.Jsii$Proxy.class)
public interface CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbe extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbeExec getExec() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbeHttpGet getHttpGet() {
        return null;
    }
    ...
    /**
     * @return a {@link Builder} of {@link CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbe}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbe}
     */
    public static final class Builder implements software.amazon.jsii.Builder<CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbe> {
        imports.kubernetes.CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbeExec exec;
        java.lang.Number failureThreshold;
        imports.kubernetes.CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbeHttpGet httpGet;
        ...
        /**
         * Sets the value of {@link CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbe#getExec}
         * @param exec exec block.
         *             Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/cron_job#exec CronJob#exec}
         * @return {@code this}
         */
        public Builder exec(imports.kubernetes.CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbeExec exec) {
            this.exec = exec;
            return this;
        }

        /**
         * Sets the value of {@link CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbe#getFailureThreshold}
        ...
        /**
         * Sets the value of {@link CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbe#getHttpGet}
         * @param httpGet http_get block.
         *                Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/cron_job#http_get CronJob#http_get}
         * @return {@code this}
         */
        public Builder httpGet(imports.kubernetes.CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbeHttpGet httpGet) {
            this.httpGet = httpGet;
            return this;
        }

        /**
         * Sets the value of {@link CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbe#getInitialDelaySeconds}
        ...
        /**
         * Sets the value of {@link CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbe#getPeriodSeconds}
        ...
        /**
         * Sets the value of {@link CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbe#getSuccessThreshold}
        ...
        /**
         * Sets the value of {@link CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbe#getTcpSocket}
         ...
         * @return {@code this}
         */
        public Builder tcpSocket(java.util.List<? extends imports.kubernetes.CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbeTcpSocket> tcpSocket) {
            this.tcpSocket = tcpSocket;
            return this;
        }

        /**
         * Sets the value of {@link CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbe#getTimeoutSeconds}
         ...
         * @return a new instance of {@link CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbe}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbe build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbe}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbe {
        private final imports.kubernetes.CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbeExec exec;
        private final java.lang.Number failureThreshold;
        private final imports.kubernetes.CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbeHttpGet httpGet;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.exec = software.amazon.jsii.Kernel.get(this, "exec", software.amazon.jsii.NativeType.forClass(imports.kubernetes.CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbeExec.class));
            ...
            this.httpGet = software.amazon.jsii.Kernel.get(this, "httpGet", software.amazon.jsii.NativeType.forClass(imports.kubernetes.CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbeHttpGet.class));
        ...
        @Override
        public final imports.kubernetes.CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbeExec getExec() {
            return this.exec;
        }
        ...
        @Override
        public final imports.kubernetes.CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbeHttpGet getHttpGet() {
            return this.httpGet;
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbe"));
        ...
        public final boolean equals(final Object o) {
            ...
            CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbe.Jsii$Proxy that = (CronJobSpecJobTemplateSpecTemplateSpecContainerReadinessProbe.Jsii$Proxy) o;
