...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PodSecurityPolicySpecRunAsGroupRangeOutputReference")
public class PodSecurityPolicySpecRunAsGroupRangeOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected PodSecurityPolicySpecRunAsGroupRangeOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected PodSecurityPolicySpecRunAsGroupRangeOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.PodSecurityPolicySpecRunAsGroupRange value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
