...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PodV1SpecInitContainerSecurityContextCapabilities")
@software.amazon.jsii.Jsii.Proxy(PodV1SpecInitContainerSecurityContextCapabilities.Jsii$Proxy.class)
public interface PodV1SpecInitContainerSecurityContextCapabilities extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link PodV1SpecInitContainerSecurityContextCapabilities}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link PodV1SpecInitContainerSecurityContextCapabilities}
     */
    public static final class Builder implements software.amazon.jsii.Builder<PodV1SpecInitContainerSecurityContextCapabilities> {
        java.util.List<java.lang.String> add;
        java.util.List<java.lang.String> drop;

        /**
         * Sets the value of {@link PodV1SpecInitContainerSecurityContextCapabilities#getAdd}
        ...
        /**
         * Sets the value of {@link PodV1SpecInitContainerSecurityContextCapabilities#getDrop}
         ...
         * @return a new instance of {@link PodV1SpecInitContainerSecurityContextCapabilities}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public PodV1SpecInitContainerSecurityContextCapabilities build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link PodV1SpecInitContainerSecurityContextCapabilities}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodV1SpecInitContainerSecurityContextCapabilities {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.PodV1SpecInitContainerSecurityContextCapabilities"));
        ...
        public final boolean equals(final Object o) {
            ...
            PodV1SpecInitContainerSecurityContextCapabilities.Jsii$Proxy that = (PodV1SpecInitContainerSecurityContextCapabilities.Jsii$Proxy) o;
