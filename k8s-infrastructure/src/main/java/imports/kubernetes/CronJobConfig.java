...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:38.811Z")
...
public interface CronJobConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
     ...
     */
    @org.jetbrains.annotations.NotNull imports.kubernetes.CronJobMetadata getMetadata();
     ...
     */
    @org.jetbrains.annotations.NotNull imports.kubernetes.CronJobSpec getSpec();
    ...
    public static final class Builder implements software.amazon.jsii.Builder<CronJobConfig> {
        imports.kubernetes.CronJobMetadata metadata;
        imports.kubernetes.CronJobSpec spec;
        java.lang.String id;
        imports.kubernetes.CronJobTimeouts timeouts;
         ...
         * @return {@code this}
         */
        public Builder metadata(imports.kubernetes.CronJobMetadata metadata) {
         ...
         * @return {@code this}
         */
        public Builder spec(imports.kubernetes.CronJobSpec spec) {
            this.spec = spec;
            return this;
        }

        /**
         * Sets the value of {@link CronJobConfig#getId}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/r/cron_job#id CronJob#id}.
         *           Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2.
         *           If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link CronJobConfig#getConnection}
        ...
        /**
         * Sets the value of {@link CronJobConfig#getForEach}
        ...
        /**
         * Sets the value of {@link CronJobConfig#getProvisioners}
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CronJobConfig {
        private final imports.kubernetes.CronJobMetadata metadata;
        private final imports.kubernetes.CronJobSpec spec;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.metadata = software.amazon.jsii.Kernel.get(this, "metadata", software.amazon.jsii.NativeType.forClass(imports.kubernetes.CronJobMetadata.class));
            this.spec = software.amazon.jsii.Kernel.get(this, "spec", software.amazon.jsii.NativeType.forClass(imports.kubernetes.CronJobSpec.class));
        ...
        @Override
        public final imports.kubernetes.CronJobMetadata getMetadata() {
            return this.metadata;
        }

        @Override
        public final imports.kubernetes.CronJobSpec getSpec() {
            return this.spec;
        }
