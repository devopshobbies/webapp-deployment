...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.ResourceQuotaSpecScopeSelectorMatchExpressionList")
public class ResourceQuotaSpecScopeSelectorMatchExpressionList extends com.hashicorp.cdktf.ComplexList {

    protected ResourceQuotaSpecScopeSelectorMatchExpressionList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected ResourceQuotaSpecScopeSelectorMatchExpressionList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public ResourceQuotaSpecScopeSelectorMatchExpressionList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.kubernetes.ResourceQuotaSpecScopeSelectorMatchExpressionOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ResourceQuotaSpecScopeSelectorMatchExpressionOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.ResourceQuotaSpecScopeSelectorMatchExpression> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
