...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.NetworkPolicyV1SpecEgressToNamespaceSelectorOutputReference")
public class NetworkPolicyV1SpecEgressToNamespaceSelectorOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected NetworkPolicyV1SpecEgressToNamespaceSelectorOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected NetworkPolicyV1SpecEgressToNamespaceSelectorOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public NetworkPolicyV1SpecEgressToNamespaceSelectorOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public @org.jetbrains.annotations.NotNull imports.kubernetes.NetworkPolicyV1SpecEgressToNamespaceSelectorMatchExpressionsList getMatchExpressions() {
        return software.amazon.jsii.Kernel.get(this, "matchExpressions", software.amazon.jsii.NativeType.forClass(imports.kubernetes.NetworkPolicyV1SpecEgressToNamespaceSelectorMatchExpressionsList.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.kubernetes.NetworkPolicyV1SpecEgressToNamespaceSelector getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.kubernetes.NetworkPolicyV1SpecEgressToNamespaceSelector.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.NetworkPolicyV1SpecEgressToNamespaceSelector value) {
