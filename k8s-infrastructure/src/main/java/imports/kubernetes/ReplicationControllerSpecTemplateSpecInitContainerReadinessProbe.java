...
public interface ReplicationControllerSpecTemplateSpecInitContainerReadinessProbe extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerReadinessProbeExec getExec() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerReadinessProbeHttpGet getHttpGet() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<ReplicationControllerSpecTemplateSpecInitContainerReadinessProbe> {
        imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerReadinessProbeExec exec;
        java.lang.Number failureThreshold;
        imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerReadinessProbeHttpGet httpGet;
         ...
         * @return {@code this}
         */
        public Builder exec(imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerReadinessProbeExec exec) {
            this.exec = exec;
            return this;
        }
         ...
         * @return {@code this}
         */
        public Builder httpGet(imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerReadinessProbeHttpGet httpGet) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ReplicationControllerSpecTemplateSpecInitContainerReadinessProbe {
        private final imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerReadinessProbeExec exec;
        private final java.lang.Number failureThreshold;
        private final imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerReadinessProbeHttpGet httpGet;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.exec = software.amazon.jsii.Kernel.get(this, "exec", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerReadinessProbeExec.class));
            ...
            this.httpGet = software.amazon.jsii.Kernel.get(this, "httpGet", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerReadinessProbeHttpGet.class));
        ...
        @Override
        public final imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerReadinessProbeExec getExec() {
            return this.exec;
        }
        ...
        @Override
        public final imports.kubernetes.ReplicationControllerSpecTemplateSpecInitContainerReadinessProbeHttpGet getHttpGet() {
            return this.httpGet;
        }
