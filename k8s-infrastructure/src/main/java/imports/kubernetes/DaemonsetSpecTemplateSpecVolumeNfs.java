...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DaemonsetSpecTemplateSpecVolumeNfs")
@software.amazon.jsii.Jsii.Proxy(DaemonsetSpecTemplateSpecVolumeNfs.Jsii$Proxy.class)
public interface DaemonsetSpecTemplateSpecVolumeNfs extends software.amazon.jsii.JsiiSerializable {
     ...
     * <p>
     * Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/daemonset#server Daemonset#server}
     */
    ...
    /**
     * @return a {@link Builder} of {@link DaemonsetSpecTemplateSpecVolumeNfs}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DaemonsetSpecTemplateSpecVolumeNfs}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DaemonsetSpecTemplateSpecVolumeNfs> {
        java.lang.String path;
        java.lang.String server;
        java.lang.Object readOnly;

        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecVolumeNfs#getPath}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecVolumeNfs#getServer}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecVolumeNfs#getReadOnly}
         ...
         * @return a new instance of {@link DaemonsetSpecTemplateSpecVolumeNfs}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DaemonsetSpecTemplateSpecVolumeNfs build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DaemonsetSpecTemplateSpecVolumeNfs}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DaemonsetSpecTemplateSpecVolumeNfs {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DaemonsetSpecTemplateSpecVolumeNfs"));
        ...
        public final boolean equals(final Object o) {
            ...
            DaemonsetSpecTemplateSpecVolumeNfs.Jsii$Proxy that = (DaemonsetSpecTemplateSpecVolumeNfs.Jsii$Proxy) o;
