...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PodSpecVolumeDownwardApiItemsFieldRef")
@software.amazon.jsii.Jsii.Proxy(PodSpecVolumeDownwardApiItemsFieldRef.Jsii$Proxy.class)
public interface PodSpecVolumeDownwardApiItemsFieldRef extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link PodSpecVolumeDownwardApiItemsFieldRef}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link PodSpecVolumeDownwardApiItemsFieldRef}
     */
    public static final class Builder implements software.amazon.jsii.Builder<PodSpecVolumeDownwardApiItemsFieldRef> {
        java.lang.String apiVersion;
        java.lang.String fieldPath;

        /**
         * Sets the value of {@link PodSpecVolumeDownwardApiItemsFieldRef#getApiVersion}
        ...
        /**
         * Sets the value of {@link PodSpecVolumeDownwardApiItemsFieldRef#getFieldPath}
         ...
         * @return a new instance of {@link PodSpecVolumeDownwardApiItemsFieldRef}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public PodSpecVolumeDownwardApiItemsFieldRef build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link PodSpecVolumeDownwardApiItemsFieldRef}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodSpecVolumeDownwardApiItemsFieldRef {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.PodSpecVolumeDownwardApiItemsFieldRef"));
        ...
        public final boolean equals(final Object o) {
            ...
            PodSpecVolumeDownwardApiItemsFieldRef.Jsii$Proxy that = (PodSpecVolumeDownwardApiItemsFieldRef.Jsii$Proxy) o;
