...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.IngressV1SpecTlsOutputReference")
public class IngressV1SpecTlsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected IngressV1SpecTlsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected IngressV1SpecTlsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.IngressV1SpecTls value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
