...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.EndpointsV1Subset")
@software.amazon.jsii.Jsii.Proxy(EndpointsV1Subset.Jsii$Proxy.class)
public interface EndpointsV1Subset extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link EndpointsV1Subset}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link EndpointsV1Subset}
     */
    public static final class Builder implements software.amazon.jsii.Builder<EndpointsV1Subset> {
        ...
        /**
         * Sets the value of {@link EndpointsV1Subset#getAddress}
         ...
         * @return {@code this}
         */
        public Builder address(java.util.List<? extends imports.kubernetes.EndpointsV1SubsetAddress> address) {
            this.address = address;
            return this;
        }

        /**
         * Sets the value of {@link EndpointsV1Subset#getNotReadyAddress}
         ...
         * @return {@code this}
         */
        public Builder notReadyAddress(java.util.List<? extends imports.kubernetes.EndpointsV1SubsetNotReadyAddress> notReadyAddress) {
            this.notReadyAddress = notReadyAddress;
            return this;
        }

        /**
         * Sets the value of {@link EndpointsV1Subset#getPort}
         ...
         * @return {@code this}
         */
        public Builder port(java.util.List<? extends imports.kubernetes.EndpointsV1SubsetPort> port) {
            this.port = port;
            return this;
        }
         ...
         * @return a new instance of {@link EndpointsV1Subset}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public EndpointsV1Subset build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link EndpointsV1Subset}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements EndpointsV1Subset {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.EndpointsV1Subset"));
        ...
        public final boolean equals(final Object o) {
            ...
            EndpointsV1Subset.Jsii$Proxy that = (EndpointsV1Subset.Jsii$Proxy) o;
