...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:40.908Z")
...
public interface ServiceConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
     ...
     */
    @org.jetbrains.annotations.NotNull imports.kubernetes.ServiceMetadata getMetadata();
     ...
     */
    @org.jetbrains.annotations.NotNull imports.kubernetes.ServiceSpec getSpec();
    ...
    public static final class Builder implements software.amazon.jsii.Builder<ServiceConfig> {
        imports.kubernetes.ServiceMetadata metadata;
        imports.kubernetes.ServiceSpec spec;
        java.lang.String id;
        imports.kubernetes.ServiceTimeouts timeouts;
         ...
         * @return {@code this}
         */
        public Builder metadata(imports.kubernetes.ServiceMetadata metadata) {
         ...
         * @return {@code this}
         */
        public Builder spec(imports.kubernetes.ServiceSpec spec) {
            this.spec = spec;
            return this;
        }

        /**
         * Sets the value of {@link ServiceConfig#getId}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/r/service#id Service#id}.
         *           Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2.
         *           If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link ServiceConfig#getWaitForLoadBalancer}
        ...
        /**
         * Sets the value of {@link ServiceConfig#getConnection}
        ...
        /**
         * Sets the value of {@link ServiceConfig#getForEach}
        ...
        /**
         * Sets the value of {@link ServiceConfig#getProvisioners}
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ServiceConfig {
        private final imports.kubernetes.ServiceMetadata metadata;
        private final imports.kubernetes.ServiceSpec spec;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.metadata = software.amazon.jsii.Kernel.get(this, "metadata", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ServiceMetadata.class));
            this.spec = software.amazon.jsii.Kernel.get(this, "spec", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ServiceSpec.class));
        ...
        @Override
        public final imports.kubernetes.ServiceMetadata getMetadata() {
            return this.metadata;
        }

        @Override
        public final imports.kubernetes.ServiceSpec getSpec() {
            return this.spec;
        }
