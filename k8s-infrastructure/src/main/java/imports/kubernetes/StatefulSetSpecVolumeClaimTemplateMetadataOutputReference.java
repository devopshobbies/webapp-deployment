...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.StatefulSetSpecVolumeClaimTemplateMetadataOutputReference")
public class StatefulSetSpecVolumeClaimTemplateMetadataOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected StatefulSetSpecVolumeClaimTemplateMetadataOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected StatefulSetSpecVolumeClaimTemplateMetadataOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public StatefulSetSpecVolumeClaimTemplateMetadataOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public @org.jetbrains.annotations.Nullable imports.kubernetes.StatefulSetSpecVolumeClaimTemplateMetadata getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.kubernetes.StatefulSetSpecVolumeClaimTemplateMetadata.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.StatefulSetSpecVolumeClaimTemplateMetadata value) {
