...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DataKubernetesPodSpecContainerSecurityContextSeLinuxOptionsList")
public class DataKubernetesPodSpecContainerSecurityContextSeLinuxOptionsList extends com.hashicorp.cdktf.ComplexList {

    protected DataKubernetesPodSpecContainerSecurityContextSeLinuxOptionsList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecContainerSecurityContextSeLinuxOptionsList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.kubernetes.DataKubernetesPodSpecContainerSecurityContextSeLinuxOptionsOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DataKubernetesPodSpecContainerSecurityContextSeLinuxOptionsOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
