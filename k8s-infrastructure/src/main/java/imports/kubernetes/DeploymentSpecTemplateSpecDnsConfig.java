...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DeploymentSpecTemplateSpecDnsConfig")
@software.amazon.jsii.Jsii.Proxy(DeploymentSpecTemplateSpecDnsConfig.Jsii$Proxy.class)
public interface DeploymentSpecTemplateSpecDnsConfig extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DeploymentSpecTemplateSpecDnsConfig}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DeploymentSpecTemplateSpecDnsConfig}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DeploymentSpecTemplateSpecDnsConfig> {
        java.util.List<java.lang.String> nameservers;
        java.lang.Object option;
        java.util.List<java.lang.String> searches;

        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecDnsConfig#getNameservers}
        ...
        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecDnsConfig#getOption}
         ...
         * @return {@code this}
         */
        public Builder option(java.util.List<? extends imports.kubernetes.DeploymentSpecTemplateSpecDnsConfigOption> option) {
            this.option = option;
            return this;
        }

        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecDnsConfig#getSearches}
         ...
         * @return a new instance of {@link DeploymentSpecTemplateSpecDnsConfig}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DeploymentSpecTemplateSpecDnsConfig build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DeploymentSpecTemplateSpecDnsConfig}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DeploymentSpecTemplateSpecDnsConfig {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DeploymentSpecTemplateSpecDnsConfig"));
        ...
        public final boolean equals(final Object o) {
            ...
            DeploymentSpecTemplateSpecDnsConfig.Jsii$Proxy that = (DeploymentSpecTemplateSpecDnsConfig.Jsii$Proxy) o;
