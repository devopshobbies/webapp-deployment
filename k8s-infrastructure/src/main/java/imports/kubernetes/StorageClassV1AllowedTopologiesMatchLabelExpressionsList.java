...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.StorageClassV1AllowedTopologiesMatchLabelExpressionsList")
public class StorageClassV1AllowedTopologiesMatchLabelExpressionsList extends com.hashicorp.cdktf.ComplexList {

    protected StorageClassV1AllowedTopologiesMatchLabelExpressionsList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected StorageClassV1AllowedTopologiesMatchLabelExpressionsList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.kubernetes.StorageClassV1AllowedTopologiesMatchLabelExpressionsOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.kubernetes.StorageClassV1AllowedTopologiesMatchLabelExpressionsOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.StorageClassV1AllowedTopologiesMatchLabelExpressions> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
