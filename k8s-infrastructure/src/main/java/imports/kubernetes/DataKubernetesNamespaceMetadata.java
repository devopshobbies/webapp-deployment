...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DataKubernetesNamespaceMetadata")
@software.amazon.jsii.Jsii.Proxy(DataKubernetesNamespaceMetadata.Jsii$Proxy.class)
public interface DataKubernetesNamespaceMetadata extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DataKubernetesNamespaceMetadata}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DataKubernetesNamespaceMetadata}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DataKubernetesNamespaceMetadata> {
        java.util.Map<java.lang.String, java.lang.String> annotations;
        java.util.Map<java.lang.String, java.lang.String> labels;
        java.lang.String name;

        /**
         * Sets the value of {@link DataKubernetesNamespaceMetadata#getAnnotations}
         * @param annotations An unstructured key value map stored with the namespace that may be used to store arbitrary metadata.
         *                    More info: http://kubernetes.io/docs/user-guide/annotations
         *                    <p>
         *                    Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/d/namespace#annotations DataKubernetesNamespace#annotations}
         * @return {@code this}
        ...
        /**
         * Sets the value of {@link DataKubernetesNamespaceMetadata#getLabels}
         * @param labels Map of string keys and values that can be used to organize and categorize (scope and select) the namespace.
         *               May match selectors of replication controllers and services. More info: http://kubernetes.io/docs/user-guide/labels
         *               <p>
         *               Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/d/namespace#labels DataKubernetesNamespace#labels}
         * @return {@code this}
        ...
        /**
         * Sets the value of {@link DataKubernetesNamespaceMetadata#getName}
         * @param name Name of the namespace, must be unique. Cannot be updated. More info: http://kubernetes.io/docs/user-guide/identifiers#names.
         *             Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/d/namespace#name DataKubernetesNamespace#name}
         * @return {@code this}
         */
         ...
         * @return a new instance of {@link DataKubernetesNamespaceMetadata}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DataKubernetesNamespaceMetadata build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DataKubernetesNamespaceMetadata}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DataKubernetesNamespaceMetadata {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DataKubernetesNamespaceMetadata"));
        ...
        public final boolean equals(final Object o) {
            ...
            DataKubernetesNamespaceMetadata.Jsii$Proxy that = (DataKubernetesNamespaceMetadata.Jsii$Proxy) o;
