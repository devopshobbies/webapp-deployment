...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.HorizontalPodAutoscalerSpecBehaviorScaleDown")
@software.amazon.jsii.Jsii.Proxy(HorizontalPodAutoscalerSpecBehaviorScaleDown.Jsii$Proxy.class)
public interface HorizontalPodAutoscalerSpecBehaviorScaleDown extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link HorizontalPodAutoscalerSpecBehaviorScaleDown}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link HorizontalPodAutoscalerSpecBehaviorScaleDown}
     */
    public static final class Builder implements software.amazon.jsii.Builder<HorizontalPodAutoscalerSpecBehaviorScaleDown> {
        java.lang.Object policy;
        java.lang.String selectPolicy;
        java.lang.Number stabilizationWindowSeconds;

        /**
         * Sets the value of {@link HorizontalPodAutoscalerSpecBehaviorScaleDown#getPolicy}
         ...
         * @return {@code this}
         */
        public Builder policy(java.util.List<? extends imports.kubernetes.HorizontalPodAutoscalerSpecBehaviorScaleDownPolicy> policy) {
            this.policy = policy;
            return this;
        }

        /**
         * Sets the value of {@link HorizontalPodAutoscalerSpecBehaviorScaleDown#getSelectPolicy}
        ...
        /**
         * Sets the value of {@link HorizontalPodAutoscalerSpecBehaviorScaleDown#getStabilizationWindowSeconds}
         ...
         * @return a new instance of {@link HorizontalPodAutoscalerSpecBehaviorScaleDown}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public HorizontalPodAutoscalerSpecBehaviorScaleDown build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link HorizontalPodAutoscalerSpecBehaviorScaleDown}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements HorizontalPodAutoscalerSpecBehaviorScaleDown {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.HorizontalPodAutoscalerSpecBehaviorScaleDown"));
        ...
        public final boolean equals(final Object o) {
            ...
            HorizontalPodAutoscalerSpecBehaviorScaleDown.Jsii$Proxy that = (HorizontalPodAutoscalerSpecBehaviorScaleDown.Jsii$Proxy) o;
