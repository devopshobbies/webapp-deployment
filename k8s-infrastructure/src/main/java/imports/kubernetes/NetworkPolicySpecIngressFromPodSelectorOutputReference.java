...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.NetworkPolicySpecIngressFromPodSelectorOutputReference")
public class NetworkPolicySpecIngressFromPodSelectorOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected NetworkPolicySpecIngressFromPodSelectorOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected NetworkPolicySpecIngressFromPodSelectorOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public NetworkPolicySpecIngressFromPodSelectorOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public @org.jetbrains.annotations.NotNull imports.kubernetes.NetworkPolicySpecIngressFromPodSelectorMatchExpressionsList getMatchExpressions() {
        return software.amazon.jsii.Kernel.get(this, "matchExpressions", software.amazon.jsii.NativeType.forClass(imports.kubernetes.NetworkPolicySpecIngressFromPodSelectorMatchExpressionsList.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.kubernetes.NetworkPolicySpecIngressFromPodSelector getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.kubernetes.NetworkPolicySpecIngressFromPodSelector.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.NetworkPolicySpecIngressFromPodSelector value) {
