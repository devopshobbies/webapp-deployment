...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.NetworkPolicyV1SpecIngressFromPodSelectorMatchExpressionsList")
public class NetworkPolicyV1SpecIngressFromPodSelectorMatchExpressionsList extends com.hashicorp.cdktf.ComplexList {

    protected NetworkPolicyV1SpecIngressFromPodSelectorMatchExpressionsList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected NetworkPolicyV1SpecIngressFromPodSelectorMatchExpressionsList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.kubernetes.NetworkPolicyV1SpecIngressFromPodSelectorMatchExpressionsOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.kubernetes.NetworkPolicyV1SpecIngressFromPodSelectorMatchExpressionsOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.NetworkPolicyV1SpecIngressFromPodSelectorMatchExpressions> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
