...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DaemonSetV1SpecTemplateSpecVolumeDownwardApiItemsResourceFieldRef")
@software.amazon.jsii.Jsii.Proxy(DaemonSetV1SpecTemplateSpecVolumeDownwardApiItemsResourceFieldRef.Jsii$Proxy.class)
public interface DaemonSetV1SpecTemplateSpecVolumeDownwardApiItemsResourceFieldRef extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DaemonSetV1SpecTemplateSpecVolumeDownwardApiItemsResourceFieldRef}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DaemonSetV1SpecTemplateSpecVolumeDownwardApiItemsResourceFieldRef}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DaemonSetV1SpecTemplateSpecVolumeDownwardApiItemsResourceFieldRef> {
        java.lang.String containerName;
        java.lang.String resource;
        java.lang.String divisor;

        /**
         * Sets the value of {@link DaemonSetV1SpecTemplateSpecVolumeDownwardApiItemsResourceFieldRef#getContainerName}
        ...
        /**
         * Sets the value of {@link DaemonSetV1SpecTemplateSpecVolumeDownwardApiItemsResourceFieldRef#getResource}
        ...
        /**
         * Sets the value of {@link DaemonSetV1SpecTemplateSpecVolumeDownwardApiItemsResourceFieldRef#getDivisor}
         ...
         * @return a new instance of {@link DaemonSetV1SpecTemplateSpecVolumeDownwardApiItemsResourceFieldRef}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DaemonSetV1SpecTemplateSpecVolumeDownwardApiItemsResourceFieldRef build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DaemonSetV1SpecTemplateSpecVolumeDownwardApiItemsResourceFieldRef}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DaemonSetV1SpecTemplateSpecVolumeDownwardApiItemsResourceFieldRef {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DaemonSetV1SpecTemplateSpecVolumeDownwardApiItemsResourceFieldRef"));
        ...
        public final boolean equals(final Object o) {
            ...
            DaemonSetV1SpecTemplateSpecVolumeDownwardApiItemsResourceFieldRef.Jsii$Proxy that = (DaemonSetV1SpecTemplateSpecVolumeDownwardApiItemsResourceFieldRef.Jsii$Proxy) o;
