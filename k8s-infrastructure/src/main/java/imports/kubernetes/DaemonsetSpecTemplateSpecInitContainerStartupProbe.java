...
public interface DaemonsetSpecTemplateSpecInitContainerStartupProbe extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerStartupProbeExec getExec() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerStartupProbeHttpGet getHttpGet() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<DaemonsetSpecTemplateSpecInitContainerStartupProbe> {
        imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerStartupProbeExec exec;
         ...
         * @return {@code this}
         */
        public Builder exec(imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerStartupProbeExec exec) {
            this.exec = exec;
            return this;
        }
         ...
         * @return {@code this}
         */
        public Builder httpGet(imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerStartupProbeHttpGet httpGet) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DaemonsetSpecTemplateSpecInitContainerStartupProbe {
        private final imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerStartupProbeExec exec;
        private final java.lang.Number failureThreshold;
        private final imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerStartupProbeHttpGet httpGet;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.exec = software.amazon.jsii.Kernel.get(this, "exec", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerStartupProbeExec.class));
            ...
            this.httpGet = software.amazon.jsii.Kernel.get(this, "httpGet", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerStartupProbeHttpGet.class));
        ...
        @Override
        public final imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerStartupProbeExec getExec() {
            return this.exec;
        }
        ...
        @Override
        public final imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerStartupProbeHttpGet getHttpGet() {
            return this.httpGet;
        }
