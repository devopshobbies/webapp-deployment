...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.RoleV1RuleOutputReference")
public class RoleV1RuleOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected RoleV1RuleOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected RoleV1RuleOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.RoleV1Rule value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
