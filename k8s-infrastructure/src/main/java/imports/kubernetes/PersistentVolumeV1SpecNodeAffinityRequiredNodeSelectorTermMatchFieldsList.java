...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PersistentVolumeV1SpecNodeAffinityRequiredNodeSelectorTermMatchFieldsList")
public class PersistentVolumeV1SpecNodeAffinityRequiredNodeSelectorTermMatchFieldsList extends com.hashicorp.cdktf.ComplexList {

    protected PersistentVolumeV1SpecNodeAffinityRequiredNodeSelectorTermMatchFieldsList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected PersistentVolumeV1SpecNodeAffinityRequiredNodeSelectorTermMatchFieldsList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.kubernetes.PersistentVolumeV1SpecNodeAffinityRequiredNodeSelectorTermMatchFieldsOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PersistentVolumeV1SpecNodeAffinityRequiredNodeSelectorTermMatchFieldsOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.PersistentVolumeV1SpecNodeAffinityRequiredNodeSelectorTermMatchFields> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
