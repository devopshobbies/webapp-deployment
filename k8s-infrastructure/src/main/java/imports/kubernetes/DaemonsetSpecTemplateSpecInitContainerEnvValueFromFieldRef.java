...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DaemonsetSpecTemplateSpecInitContainerEnvValueFromFieldRef")
@software.amazon.jsii.Jsii.Proxy(DaemonsetSpecTemplateSpecInitContainerEnvValueFromFieldRef.Jsii$Proxy.class)
public interface DaemonsetSpecTemplateSpecInitContainerEnvValueFromFieldRef extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DaemonsetSpecTemplateSpecInitContainerEnvValueFromFieldRef}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DaemonsetSpecTemplateSpecInitContainerEnvValueFromFieldRef}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DaemonsetSpecTemplateSpecInitContainerEnvValueFromFieldRef> {
        java.lang.String apiVersion;
        java.lang.String fieldPath;

        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerEnvValueFromFieldRef#getApiVersion}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerEnvValueFromFieldRef#getFieldPath}
         ...
         * @return a new instance of {@link DaemonsetSpecTemplateSpecInitContainerEnvValueFromFieldRef}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DaemonsetSpecTemplateSpecInitContainerEnvValueFromFieldRef build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DaemonsetSpecTemplateSpecInitContainerEnvValueFromFieldRef}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DaemonsetSpecTemplateSpecInitContainerEnvValueFromFieldRef {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DaemonsetSpecTemplateSpecInitContainerEnvValueFromFieldRef"));
        ...
        public final boolean equals(final Object o) {
            ...
            DaemonsetSpecTemplateSpecInitContainerEnvValueFromFieldRef.Jsii$Proxy that = (DaemonsetSpecTemplateSpecInitContainerEnvValueFromFieldRef.Jsii$Proxy) o;
