...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.ClusterRoleBindingSubjectOutputReference")
public class ClusterRoleBindingSubjectOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected ClusterRoleBindingSubjectOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected ClusterRoleBindingSubjectOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.ClusterRoleBindingSubject value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
