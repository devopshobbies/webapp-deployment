...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.StatefulSetSpecTemplateSpecVolumePersistentVolumeClaim")
@software.amazon.jsii.Jsii.Proxy(StatefulSetSpecTemplateSpecVolumePersistentVolumeClaim.Jsii$Proxy.class)
public interface StatefulSetSpecTemplateSpecVolumePersistentVolumeClaim extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link StatefulSetSpecTemplateSpecVolumePersistentVolumeClaim}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link StatefulSetSpecTemplateSpecVolumePersistentVolumeClaim}
     */
    public static final class Builder implements software.amazon.jsii.Builder<StatefulSetSpecTemplateSpecVolumePersistentVolumeClaim> {
        java.lang.String claimName;
        java.lang.Object readOnly;

        /**
         * Sets the value of {@link StatefulSetSpecTemplateSpecVolumePersistentVolumeClaim#getClaimName}
        ...
        /**
         * Sets the value of {@link StatefulSetSpecTemplateSpecVolumePersistentVolumeClaim#getReadOnly}
         ...
         * @return a new instance of {@link StatefulSetSpecTemplateSpecVolumePersistentVolumeClaim}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public StatefulSetSpecTemplateSpecVolumePersistentVolumeClaim build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link StatefulSetSpecTemplateSpecVolumePersistentVolumeClaim}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements StatefulSetSpecTemplateSpecVolumePersistentVolumeClaim {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.StatefulSetSpecTemplateSpecVolumePersistentVolumeClaim"));
        ...
        public final boolean equals(final Object o) {
            ...
            StatefulSetSpecTemplateSpecVolumePersistentVolumeClaim.Jsii$Proxy that = (StatefulSetSpecTemplateSpecVolumePersistentVolumeClaim.Jsii$Proxy) o;
