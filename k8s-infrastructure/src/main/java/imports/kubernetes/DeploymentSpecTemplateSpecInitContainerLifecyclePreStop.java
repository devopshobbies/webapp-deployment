...
public interface DeploymentSpecTemplateSpecInitContainerLifecyclePreStop extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.DeploymentSpecTemplateSpecInitContainerLifecyclePreStopExec getExec() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.DeploymentSpecTemplateSpecInitContainerLifecyclePreStopHttpGet getHttpGet() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<DeploymentSpecTemplateSpecInitContainerLifecyclePreStop> {
        imports.kubernetes.DeploymentSpecTemplateSpecInitContainerLifecyclePreStopExec exec;
        imports.kubernetes.DeploymentSpecTemplateSpecInitContainerLifecyclePreStopHttpGet httpGet;
         ...
         * @return {@code this}
         */
        public Builder exec(imports.kubernetes.DeploymentSpecTemplateSpecInitContainerLifecyclePreStopExec exec) {
            this.exec = exec;
            return this;
        }
         ...
         * @return {@code this}
         */
        public Builder httpGet(imports.kubernetes.DeploymentSpecTemplateSpecInitContainerLifecyclePreStopHttpGet httpGet) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DeploymentSpecTemplateSpecInitContainerLifecyclePreStop {
        private final imports.kubernetes.DeploymentSpecTemplateSpecInitContainerLifecyclePreStopExec exec;
        private final imports.kubernetes.DeploymentSpecTemplateSpecInitContainerLifecyclePreStopHttpGet httpGet;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.exec = software.amazon.jsii.Kernel.get(this, "exec", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DeploymentSpecTemplateSpecInitContainerLifecyclePreStopExec.class));
            this.httpGet = software.amazon.jsii.Kernel.get(this, "httpGet", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DeploymentSpecTemplateSpecInitContainerLifecyclePreStopHttpGet.class));
        ...
        @Override
        public final imports.kubernetes.DeploymentSpecTemplateSpecInitContainerLifecyclePreStopExec getExec() {
            return this.exec;
        }

        @Override
        public final imports.kubernetes.DeploymentSpecTemplateSpecInitContainerLifecyclePreStopHttpGet getHttpGet() {
            return this.httpGet;
        }
