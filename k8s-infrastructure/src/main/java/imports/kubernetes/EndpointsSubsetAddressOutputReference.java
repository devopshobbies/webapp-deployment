...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.EndpointsSubsetAddressOutputReference")
public class EndpointsSubsetAddressOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected EndpointsSubsetAddressOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected EndpointsSubsetAddressOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.EndpointsSubsetAddress value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
