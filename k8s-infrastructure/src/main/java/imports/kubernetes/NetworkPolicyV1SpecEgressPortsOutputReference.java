...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.NetworkPolicyV1SpecEgressPortsOutputReference")
public class NetworkPolicyV1SpecEgressPortsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected NetworkPolicyV1SpecEgressPortsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected NetworkPolicyV1SpecEgressPortsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.NetworkPolicyV1SpecEgressPorts value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
