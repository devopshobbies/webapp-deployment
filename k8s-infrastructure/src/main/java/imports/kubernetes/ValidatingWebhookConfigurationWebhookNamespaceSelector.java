...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.ValidatingWebhookConfigurationWebhookNamespaceSelector")
@software.amazon.jsii.Jsii.Proxy(ValidatingWebhookConfigurationWebhookNamespaceSelector.Jsii$Proxy.class)
public interface ValidatingWebhookConfigurationWebhookNamespaceSelector extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link ValidatingWebhookConfigurationWebhookNamespaceSelector}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ValidatingWebhookConfigurationWebhookNamespaceSelector}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ValidatingWebhookConfigurationWebhookNamespaceSelector> {
        java.lang.Object matchExpressions;
        java.util.Map<java.lang.String, java.lang.String> matchLabels;

        /**
         * Sets the value of {@link ValidatingWebhookConfigurationWebhookNamespaceSelector#getMatchExpressions}
         ...
         * @return {@code this}
         */
        public Builder matchExpressions(java.util.List<? extends imports.kubernetes.ValidatingWebhookConfigurationWebhookNamespaceSelectorMatchExpressions> matchExpressions) {
            this.matchExpressions = matchExpressions;
            return this;
        }

        /**
         * Sets the value of {@link ValidatingWebhookConfigurationWebhookNamespaceSelector#getMatchLabels}
         ...
         * @return a new instance of {@link ValidatingWebhookConfigurationWebhookNamespaceSelector}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ValidatingWebhookConfigurationWebhookNamespaceSelector build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link ValidatingWebhookConfigurationWebhookNamespaceSelector}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ValidatingWebhookConfigurationWebhookNamespaceSelector {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.ValidatingWebhookConfigurationWebhookNamespaceSelector"));
        ...
        public final boolean equals(final Object o) {
            ...
            ValidatingWebhookConfigurationWebhookNamespaceSelector.Jsii$Proxy that = (ValidatingWebhookConfigurationWebhookNamespaceSelector.Jsii$Proxy) o;
