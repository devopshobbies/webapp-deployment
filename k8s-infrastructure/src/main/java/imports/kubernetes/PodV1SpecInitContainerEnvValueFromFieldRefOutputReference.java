...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PodV1SpecInitContainerEnvValueFromFieldRefOutputReference")
public class PodV1SpecInitContainerEnvValueFromFieldRefOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected PodV1SpecInitContainerEnvValueFromFieldRefOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected PodV1SpecInitContainerEnvValueFromFieldRefOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public PodV1SpecInitContainerEnvValueFromFieldRefOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
    ...
    public @org.jetbrains.annotations.Nullable imports.kubernetes.PodV1SpecInitContainerEnvValueFromFieldRef getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodV1SpecInitContainerEnvValueFromFieldRef.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.PodV1SpecInitContainerEnvValueFromFieldRef value) {
