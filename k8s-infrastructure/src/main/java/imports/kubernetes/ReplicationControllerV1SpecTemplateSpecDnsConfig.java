...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:40.815Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.ReplicationControllerV1SpecTemplateSpecDnsConfig")
@software.amazon.jsii.Jsii.Proxy(ReplicationControllerV1SpecTemplateSpecDnsConfig.Jsii$Proxy.class)
public interface ReplicationControllerV1SpecTemplateSpecDnsConfig extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link ReplicationControllerV1SpecTemplateSpecDnsConfig}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ReplicationControllerV1SpecTemplateSpecDnsConfig}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ReplicationControllerV1SpecTemplateSpecDnsConfig> {
        java.util.List<java.lang.String> nameservers;
        java.lang.Object option;
        java.util.List<java.lang.String> searches;

        /**
         * Sets the value of {@link ReplicationControllerV1SpecTemplateSpecDnsConfig#getNameservers}
        ...
        /**
         * Sets the value of {@link ReplicationControllerV1SpecTemplateSpecDnsConfig#getOption}
         ...
         * @return {@code this}
         */
        public Builder option(java.util.List<? extends imports.kubernetes.ReplicationControllerV1SpecTemplateSpecDnsConfigOption> option) {
            this.option = option;
            return this;
        }

        /**
         * Sets the value of {@link ReplicationControllerV1SpecTemplateSpecDnsConfig#getSearches}
         ...
         * @return a new instance of {@link ReplicationControllerV1SpecTemplateSpecDnsConfig}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ReplicationControllerV1SpecTemplateSpecDnsConfig build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link ReplicationControllerV1SpecTemplateSpecDnsConfig}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ReplicationControllerV1SpecTemplateSpecDnsConfig {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.ReplicationControllerV1SpecTemplateSpecDnsConfig"));
        ...
        public final boolean equals(final Object o) {
            ...
            ReplicationControllerV1SpecTemplateSpecDnsConfig.Jsii$Proxy that = (ReplicationControllerV1SpecTemplateSpecDnsConfig.Jsii$Proxy) o;
