...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PodSecurityPolicySpecRunAsUserRange")
@software.amazon.jsii.Jsii.Proxy(PodSecurityPolicySpecRunAsUserRange.Jsii$Proxy.class)
public interface PodSecurityPolicySpecRunAsUserRange extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link PodSecurityPolicySpecRunAsUserRange}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link PodSecurityPolicySpecRunAsUserRange}
     */
    public static final class Builder implements software.amazon.jsii.Builder<PodSecurityPolicySpecRunAsUserRange> {
        java.lang.Number max;
        java.lang.Number min;

        /**
         * Sets the value of {@link PodSecurityPolicySpecRunAsUserRange#getMax}
        ...
        /**
         * Sets the value of {@link PodSecurityPolicySpecRunAsUserRange#getMin}
         ...
         * @return a new instance of {@link PodSecurityPolicySpecRunAsUserRange}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public PodSecurityPolicySpecRunAsUserRange build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link PodSecurityPolicySpecRunAsUserRange}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodSecurityPolicySpecRunAsUserRange {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.PodSecurityPolicySpecRunAsUserRange"));
        ...
        public final boolean equals(final Object o) {
            ...
            PodSecurityPolicySpecRunAsUserRange.Jsii$Proxy that = (PodSecurityPolicySpecRunAsUserRange.Jsii$Proxy) o;
