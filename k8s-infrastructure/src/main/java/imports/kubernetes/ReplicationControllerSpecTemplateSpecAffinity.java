...
public interface ReplicationControllerSpecTemplateSpecAffinity extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.ReplicationControllerSpecTemplateSpecAffinityNodeAffinity getNodeAffinity() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.ReplicationControllerSpecTemplateSpecAffinityPodAffinity getPodAffinity() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.ReplicationControllerSpecTemplateSpecAffinityPodAntiAffinity getPodAntiAffinity() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<ReplicationControllerSpecTemplateSpecAffinity> {
        imports.kubernetes.ReplicationControllerSpecTemplateSpecAffinityNodeAffinity nodeAffinity;
        imports.kubernetes.ReplicationControllerSpecTemplateSpecAffinityPodAffinity podAffinity;
         ...
         * @return {@code this}
         */
        public Builder nodeAffinity(imports.kubernetes.ReplicationControllerSpecTemplateSpecAffinityNodeAffinity nodeAffinity) {
         ...
         * @return {@code this}
         */
        public Builder podAffinity(imports.kubernetes.ReplicationControllerSpecTemplateSpecAffinityPodAffinity podAffinity) {
         ...
         * @return {@code this}
         */
        public Builder podAntiAffinity(imports.kubernetes.ReplicationControllerSpecTemplateSpecAffinityPodAntiAffinity podAntiAffinity) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ReplicationControllerSpecTemplateSpecAffinity {
        private final imports.kubernetes.ReplicationControllerSpecTemplateSpecAffinityNodeAffinity nodeAffinity;
        private final imports.kubernetes.ReplicationControllerSpecTemplateSpecAffinityPodAffinity podAffinity;
        private final imports.kubernetes.ReplicationControllerSpecTemplateSpecAffinityPodAntiAffinity podAntiAffinity;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.nodeAffinity = software.amazon.jsii.Kernel.get(this, "nodeAffinity", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateSpecAffinityNodeAffinity.class));
            this.podAffinity = software.amazon.jsii.Kernel.get(this, "podAffinity", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateSpecAffinityPodAffinity.class));
            this.podAntiAffinity = software.amazon.jsii.Kernel.get(this, "podAntiAffinity", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateSpecAffinityPodAntiAffinity.class));
        }
        ...
        @Override
        public final imports.kubernetes.ReplicationControllerSpecTemplateSpecAffinityNodeAffinity getNodeAffinity() {
            return this.nodeAffinity;
        }

        @Override
        public final imports.kubernetes.ReplicationControllerSpecTemplateSpecAffinityPodAffinity getPodAffinity() {
            return this.podAffinity;
        }

        @Override
        public final imports.kubernetes.ReplicationControllerSpecTemplateSpecAffinityPodAntiAffinity getPodAntiAffinity() {
