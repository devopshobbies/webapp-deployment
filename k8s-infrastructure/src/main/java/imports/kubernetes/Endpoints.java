...
public class Endpoints extends com.hashicorp.cdktf.TerraformResource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.kubernetes.Endpoints.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
    ...
    public void putMetadata(final @org.jetbrains.annotations.NotNull imports.kubernetes.EndpointsMetadata value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.kubernetes.EndpointsMetadataOutputReference getMetadata() {
        return software.amazon.jsii.Kernel.get(this, "metadata", software.amazon.jsii.NativeType.forClass(imports.kubernetes.EndpointsMetadataOutputReference.class));
    }

    public @org.jetbrains.annotations.NotNull imports.kubernetes.EndpointsSubsetList getSubset() {
        return software.amazon.jsii.Kernel.get(this, "subset", software.amazon.jsii.NativeType.forClass(imports.kubernetes.EndpointsSubsetList.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.kubernetes.EndpointsMetadata getMetadataInput() {
        return software.amazon.jsii.Kernel.get(this, "metadataInput", software.amazon.jsii.NativeType.forClass(imports.kubernetes.EndpointsMetadata.class));
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<imports.kubernetes.Endpoints> {
         ...
         */
        public Builder metadata(final imports.kubernetes.EndpointsMetadata metadata) {
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/r/endpoints#id Endpoints#id}. This parameter is required.
         */
