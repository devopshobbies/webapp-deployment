...
public interface JobConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
     ...
     */
    @org.jetbrains.annotations.NotNull imports.kubernetes.JobMetadata getMetadata();
     ...
     */
    @org.jetbrains.annotations.NotNull imports.kubernetes.JobSpec getSpec();
    ...
    public static final class Builder implements software.amazon.jsii.Builder<JobConfig> {
        imports.kubernetes.JobMetadata metadata;
        imports.kubernetes.JobSpec spec;
        java.lang.String id;
        imports.kubernetes.JobTimeouts timeouts;
         ...
         * @return {@code this}
         */
        public Builder metadata(imports.kubernetes.JobMetadata metadata) {
         ...
         * @return {@code this}
         */
        public Builder spec(imports.kubernetes.JobSpec spec) {
            this.spec = spec;
            return this;
        }

        /**
         * Sets the value of {@link JobConfig#getId}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/r/job#id Job#id}.
         *           Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2.
         *           If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
         * @return {@code this}
         */
         ...
         * @param waitForCompletion Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/r/job#wait_for_completion Job#wait_for_completion}.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link JobConfig#getConnection}
        ...
        /**
         * Sets the value of {@link JobConfig#getForEach}
        ...
        /**
         * Sets the value of {@link JobConfig#getProvisioners}
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements JobConfig {
        private final imports.kubernetes.JobMetadata metadata;
        private final imports.kubernetes.JobSpec spec;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.metadata = software.amazon.jsii.Kernel.get(this, "metadata", software.amazon.jsii.NativeType.forClass(imports.kubernetes.JobMetadata.class));
            this.spec = software.amazon.jsii.Kernel.get(this, "spec", software.amazon.jsii.NativeType.forClass(imports.kubernetes.JobSpec.class));
        ...
        @Override
        public final imports.kubernetes.JobMetadata getMetadata() {
            return this.metadata;
        }

        @Override
        public final imports.kubernetes.JobSpec getSpec() {
            return this.spec;
        }
