...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.HorizontalPodAutoscalerSpecBehaviorScaleUpPolicy")
@software.amazon.jsii.Jsii.Proxy(HorizontalPodAutoscalerSpecBehaviorScaleUpPolicy.Jsii$Proxy.class)
public interface HorizontalPodAutoscalerSpecBehaviorScaleUpPolicy extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link HorizontalPodAutoscalerSpecBehaviorScaleUpPolicy}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link HorizontalPodAutoscalerSpecBehaviorScaleUpPolicy}
     */
    public static final class Builder implements software.amazon.jsii.Builder<HorizontalPodAutoscalerSpecBehaviorScaleUpPolicy> {
        java.lang.Number periodSeconds;
        java.lang.String type;
        java.lang.Number value;

        /**
         * Sets the value of {@link HorizontalPodAutoscalerSpecBehaviorScaleUpPolicy#getPeriodSeconds}
        ...
        /**
         * Sets the value of {@link HorizontalPodAutoscalerSpecBehaviorScaleUpPolicy#getType}
        ...
        /**
         * Sets the value of {@link HorizontalPodAutoscalerSpecBehaviorScaleUpPolicy#getValue}
         ...
         * @return a new instance of {@link HorizontalPodAutoscalerSpecBehaviorScaleUpPolicy}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public HorizontalPodAutoscalerSpecBehaviorScaleUpPolicy build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link HorizontalPodAutoscalerSpecBehaviorScaleUpPolicy}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements HorizontalPodAutoscalerSpecBehaviorScaleUpPolicy {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.HorizontalPodAutoscalerSpecBehaviorScaleUpPolicy"));
        ...
        public final boolean equals(final Object o) {
            ...
            HorizontalPodAutoscalerSpecBehaviorScaleUpPolicy.Jsii$Proxy that = (HorizontalPodAutoscalerSpecBehaviorScaleUpPolicy.Jsii$Proxy) o;
