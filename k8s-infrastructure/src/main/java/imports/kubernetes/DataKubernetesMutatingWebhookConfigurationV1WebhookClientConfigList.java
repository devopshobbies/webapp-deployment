...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DataKubernetesMutatingWebhookConfigurationV1WebhookClientConfigList")
public class DataKubernetesMutatingWebhookConfigurationV1WebhookClientConfigList extends com.hashicorp.cdktf.ComplexList {

    protected DataKubernetesMutatingWebhookConfigurationV1WebhookClientConfigList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesMutatingWebhookConfigurationV1WebhookClientConfigList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.kubernetes.DataKubernetesMutatingWebhookConfigurationV1WebhookClientConfigOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DataKubernetesMutatingWebhookConfigurationV1WebhookClientConfigOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
