...
public class DataKubernetesPod extends com.hashicorp.cdktf.TerraformDataSource {
    ...
    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.kubernetes.DataKubernetesPod.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
    ...
    public void putMetadata(final @org.jetbrains.annotations.NotNull imports.kubernetes.DataKubernetesPodMetadata value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.kubernetes.DataKubernetesPodMetadataOutputReference getMetadata() {
        return software.amazon.jsii.Kernel.get(this, "metadata", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DataKubernetesPodMetadataOutputReference.class));
    }

    public @org.jetbrains.annotations.NotNull imports.kubernetes.DataKubernetesPodSpecList getSpec() {
        return software.amazon.jsii.Kernel.get(this, "spec", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DataKubernetesPodSpecList.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.kubernetes.DataKubernetesPodMetadata getMetadataInput() {
        return software.amazon.jsii.Kernel.get(this, "metadataInput", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DataKubernetesPodMetadata.class));
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<imports.kubernetes.DataKubernetesPod> {
         ...
         */
        public Builder metadata(final imports.kubernetes.DataKubernetesPodMetadata metadata) {
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/d/pod#id DataKubernetesPod#id}. This parameter is required.
         */
