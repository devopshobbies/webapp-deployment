...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DaemonsetSpecTemplateSpecVolumePersistentVolumeClaim")
@software.amazon.jsii.Jsii.Proxy(DaemonsetSpecTemplateSpecVolumePersistentVolumeClaim.Jsii$Proxy.class)
public interface DaemonsetSpecTemplateSpecVolumePersistentVolumeClaim extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DaemonsetSpecTemplateSpecVolumePersistentVolumeClaim}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DaemonsetSpecTemplateSpecVolumePersistentVolumeClaim}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DaemonsetSpecTemplateSpecVolumePersistentVolumeClaim> {
        java.lang.String claimName;
        java.lang.Object readOnly;

        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecVolumePersistentVolumeClaim#getClaimName}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecVolumePersistentVolumeClaim#getReadOnly}
         ...
         * @return a new instance of {@link DaemonsetSpecTemplateSpecVolumePersistentVolumeClaim}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DaemonsetSpecTemplateSpecVolumePersistentVolumeClaim build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DaemonsetSpecTemplateSpecVolumePersistentVolumeClaim}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DaemonsetSpecTemplateSpecVolumePersistentVolumeClaim {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DaemonsetSpecTemplateSpecVolumePersistentVolumeClaim"));
        ...
        public final boolean equals(final Object o) {
            ...
            DaemonsetSpecTemplateSpecVolumePersistentVolumeClaim.Jsii$Proxy that = (DaemonsetSpecTemplateSpecVolumePersistentVolumeClaim.Jsii$Proxy) o;
