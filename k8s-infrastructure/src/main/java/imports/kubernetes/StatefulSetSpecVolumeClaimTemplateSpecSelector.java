...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.StatefulSetSpecVolumeClaimTemplateSpecSelector")
@software.amazon.jsii.Jsii.Proxy(StatefulSetSpecVolumeClaimTemplateSpecSelector.Jsii$Proxy.class)
public interface StatefulSetSpecVolumeClaimTemplateSpecSelector extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link StatefulSetSpecVolumeClaimTemplateSpecSelector}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link StatefulSetSpecVolumeClaimTemplateSpecSelector}
     */
    public static final class Builder implements software.amazon.jsii.Builder<StatefulSetSpecVolumeClaimTemplateSpecSelector> {
        java.lang.Object matchExpressions;
        java.util.Map<java.lang.String, java.lang.String> matchLabels;

        /**
         * Sets the value of {@link StatefulSetSpecVolumeClaimTemplateSpecSelector#getMatchExpressions}
         ...
         * @return {@code this}
         */
        public Builder matchExpressions(java.util.List<? extends imports.kubernetes.StatefulSetSpecVolumeClaimTemplateSpecSelectorMatchExpressions> matchExpressions) {
            this.matchExpressions = matchExpressions;
            return this;
        }

        /**
         * Sets the value of {@link StatefulSetSpecVolumeClaimTemplateSpecSelector#getMatchLabels}
         ...
         * @return a new instance of {@link StatefulSetSpecVolumeClaimTemplateSpecSelector}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public StatefulSetSpecVolumeClaimTemplateSpecSelector build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link StatefulSetSpecVolumeClaimTemplateSpecSelector}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements StatefulSetSpecVolumeClaimTemplateSpecSelector {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.StatefulSetSpecVolumeClaimTemplateSpecSelector"));
        ...
        public final boolean equals(final Object o) {
            ...
            StatefulSetSpecVolumeClaimTemplateSpecSelector.Jsii$Proxy that = (StatefulSetSpecVolumeClaimTemplateSpecSelector.Jsii$Proxy) o;
