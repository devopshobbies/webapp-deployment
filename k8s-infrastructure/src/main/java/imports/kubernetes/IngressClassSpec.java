...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.IngressClassSpec")
...
public interface IngressClassSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<IngressClassSpec> {
         ...
         * @return {@code this}
         */
        public Builder parameters(java.util.List<? extends imports.kubernetes.IngressClassSpecParameters> parameters) {
            this.parameters = parameters;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements IngressClassSpec {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.IngressClassSpec"));
