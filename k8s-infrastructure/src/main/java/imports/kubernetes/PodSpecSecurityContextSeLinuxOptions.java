...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PodSpecSecurityContextSeLinuxOptions")
@software.amazon.jsii.Jsii.Proxy(PodSpecSecurityContextSeLinuxOptions.Jsii$Proxy.class)
public interface PodSpecSecurityContextSeLinuxOptions extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link PodSpecSecurityContextSeLinuxOptions}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link PodSpecSecurityContextSeLinuxOptions}
     */
    public static final class Builder implements software.amazon.jsii.Builder<PodSpecSecurityContextSeLinuxOptions> {
        ...
        /**
         * Sets the value of {@link PodSpecSecurityContextSeLinuxOptions#getLevel}
        ...
        /**
         * Sets the value of {@link PodSpecSecurityContextSeLinuxOptions#getRole}
        ...
        /**
         * Sets the value of {@link PodSpecSecurityContextSeLinuxOptions#getType}
        ...
        /**
         * Sets the value of {@link PodSpecSecurityContextSeLinuxOptions#getUser}
         ...
         * @return a new instance of {@link PodSpecSecurityContextSeLinuxOptions}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public PodSpecSecurityContextSeLinuxOptions build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link PodSpecSecurityContextSeLinuxOptions}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodSpecSecurityContextSeLinuxOptions {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.PodSpecSecurityContextSeLinuxOptions"));
        ...
        public final boolean equals(final Object o) {
            ...
            PodSpecSecurityContextSeLinuxOptions.Jsii$Proxy that = (PodSpecSecurityContextSeLinuxOptions.Jsii$Proxy) o;
