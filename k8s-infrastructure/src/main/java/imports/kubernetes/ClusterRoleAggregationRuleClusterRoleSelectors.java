...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.ClusterRoleAggregationRuleClusterRoleSelectors")
@software.amazon.jsii.Jsii.Proxy(ClusterRoleAggregationRuleClusterRoleSelectors.Jsii$Proxy.class)
public interface ClusterRoleAggregationRuleClusterRoleSelectors extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link ClusterRoleAggregationRuleClusterRoleSelectors}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ClusterRoleAggregationRuleClusterRoleSelectors}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ClusterRoleAggregationRuleClusterRoleSelectors> {
        java.lang.Object matchExpressions;
        java.util.Map<java.lang.String, java.lang.String> matchLabels;

        /**
         * Sets the value of {@link ClusterRoleAggregationRuleClusterRoleSelectors#getMatchExpressions}
         ...
         * @return {@code this}
         */
        public Builder matchExpressions(java.util.List<? extends imports.kubernetes.ClusterRoleAggregationRuleClusterRoleSelectorsMatchExpressions> matchExpressions) {
            this.matchExpressions = matchExpressions;
            return this;
        }

        /**
         * Sets the value of {@link ClusterRoleAggregationRuleClusterRoleSelectors#getMatchLabels}
         ...
         * @return a new instance of {@link ClusterRoleAggregationRuleClusterRoleSelectors}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ClusterRoleAggregationRuleClusterRoleSelectors build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link ClusterRoleAggregationRuleClusterRoleSelectors}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ClusterRoleAggregationRuleClusterRoleSelectors {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.ClusterRoleAggregationRuleClusterRoleSelectors"));
        ...
        public final boolean equals(final Object o) {
            ...
            ClusterRoleAggregationRuleClusterRoleSelectors.Jsii$Proxy that = (ClusterRoleAggregationRuleClusterRoleSelectors.Jsii$Proxy) o;
