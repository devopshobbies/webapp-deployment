...
public interface ReplicationControllerSpecTemplateSpecContainerLifecyclePreStop extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerLifecyclePreStopExec getExec() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerLifecyclePreStopHttpGet getHttpGet() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<ReplicationControllerSpecTemplateSpecContainerLifecyclePreStop> {
        imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerLifecyclePreStopExec exec;
        imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerLifecyclePreStopHttpGet httpGet;
         ...
         * @return {@code this}
         */
        public Builder exec(imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerLifecyclePreStopExec exec) {
            this.exec = exec;
            return this;
        }
         ...
         * @return {@code this}
         */
        public Builder httpGet(imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerLifecyclePreStopHttpGet httpGet) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ReplicationControllerSpecTemplateSpecContainerLifecyclePreStop {
        private final imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerLifecyclePreStopExec exec;
        private final imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerLifecyclePreStopHttpGet httpGet;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.exec = software.amazon.jsii.Kernel.get(this, "exec", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerLifecyclePreStopExec.class));
            this.httpGet = software.amazon.jsii.Kernel.get(this, "httpGet", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerLifecyclePreStopHttpGet.class));
        ...
        @Override
        public final imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerLifecyclePreStopExec getExec() {
            return this.exec;
        }

        @Override
        public final imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerLifecyclePreStopHttpGet getHttpGet() {
            return this.httpGet;
        }
