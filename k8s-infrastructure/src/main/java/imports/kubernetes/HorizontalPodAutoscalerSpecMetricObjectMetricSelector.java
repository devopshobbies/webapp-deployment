...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.HorizontalPodAutoscalerSpecMetricObjectMetricSelector")
@software.amazon.jsii.Jsii.Proxy(HorizontalPodAutoscalerSpecMetricObjectMetricSelector.Jsii$Proxy.class)
public interface HorizontalPodAutoscalerSpecMetricObjectMetricSelector extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link HorizontalPodAutoscalerSpecMetricObjectMetricSelector}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link HorizontalPodAutoscalerSpecMetricObjectMetricSelector}
     */
    public static final class Builder implements software.amazon.jsii.Builder<HorizontalPodAutoscalerSpecMetricObjectMetricSelector> {
        java.lang.Object matchExpressions;
        java.util.Map<java.lang.String, java.lang.String> matchLabels;

        /**
         * Sets the value of {@link HorizontalPodAutoscalerSpecMetricObjectMetricSelector#getMatchExpressions}
         ...
         * @return {@code this}
         */
        public Builder matchExpressions(java.util.List<? extends imports.kubernetes.HorizontalPodAutoscalerSpecMetricObjectMetricSelectorMatchExpressions> matchExpressions) {
            this.matchExpressions = matchExpressions;
            return this;
        }

        /**
         * Sets the value of {@link HorizontalPodAutoscalerSpecMetricObjectMetricSelector#getMatchLabels}
         ...
         * @return a new instance of {@link HorizontalPodAutoscalerSpecMetricObjectMetricSelector}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public HorizontalPodAutoscalerSpecMetricObjectMetricSelector build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link HorizontalPodAutoscalerSpecMetricObjectMetricSelector}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements HorizontalPodAutoscalerSpecMetricObjectMetricSelector {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.HorizontalPodAutoscalerSpecMetricObjectMetricSelector"));
        ...
        public final boolean equals(final Object o) {
            ...
            HorizontalPodAutoscalerSpecMetricObjectMetricSelector.Jsii$Proxy that = (HorizontalPodAutoscalerSpecMetricObjectMetricSelector.Jsii$Proxy) o;
