...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PodSpecVolumeProjectedSourcesSecretItemsOutputReference")
public class PodSpecVolumeProjectedSourcesSecretItemsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected PodSpecVolumeProjectedSourcesSecretItemsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected PodSpecVolumeProjectedSourcesSecretItemsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.PodSpecVolumeProjectedSourcesSecretItems value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
