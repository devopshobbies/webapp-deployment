...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:40.383Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PodSpecVolumeCsiOutputReference")
public class PodSpecVolumeCsiOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected PodSpecVolumeCsiOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected PodSpecVolumeCsiOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public PodSpecVolumeCsiOutputReference(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(terraformResource, "terraformResource is required"), java.util.Objects.requireNonNull(terraformAttribute, "terraformAttribute is required") });
    }

    public void putNodePublishSecretRef(final @org.jetbrains.annotations.NotNull imports.kubernetes.PodSpecVolumeCsiNodePublishSecretRef value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.kubernetes.PodSpecVolumeCsiNodePublishSecretRefOutputReference getNodePublishSecretRef() {
        return software.amazon.jsii.Kernel.get(this, "nodePublishSecretRef", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecVolumeCsiNodePublishSecretRefOutputReference.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.kubernetes.PodSpecVolumeCsiNodePublishSecretRef getNodePublishSecretRefInput() {
        return software.amazon.jsii.Kernel.get(this, "nodePublishSecretRefInput", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecVolumeCsiNodePublishSecretRef.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.kubernetes.PodSpecVolumeCsi getInternalValue() {
        return software.amazon.jsii.Kernel.get(this, "internalValue", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecVolumeCsi.class));
    }

    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.PodSpecVolumeCsi value) {
