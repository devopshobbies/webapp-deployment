...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.MutatingWebhookConfigurationWebhookNamespaceSelector")
@software.amazon.jsii.Jsii.Proxy(MutatingWebhookConfigurationWebhookNamespaceSelector.Jsii$Proxy.class)
public interface MutatingWebhookConfigurationWebhookNamespaceSelector extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link MutatingWebhookConfigurationWebhookNamespaceSelector}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link MutatingWebhookConfigurationWebhookNamespaceSelector}
     */
    public static final class Builder implements software.amazon.jsii.Builder<MutatingWebhookConfigurationWebhookNamespaceSelector> {
        ...
        /**
         * Sets the value of {@link MutatingWebhookConfigurationWebhookNamespaceSelector#getMatchExpressions}
         ...
         * @return {@code this}
         */
        public Builder matchExpressions(java.util.List<? extends imports.kubernetes.MutatingWebhookConfigurationWebhookNamespaceSelectorMatchExpressions> matchExpressions) {
            this.matchExpressions = matchExpressions;
            return this;
        }

        /**
         * Sets the value of {@link MutatingWebhookConfigurationWebhookNamespaceSelector#getMatchLabels}
         ...
         * @return a new instance of {@link MutatingWebhookConfigurationWebhookNamespaceSelector}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public MutatingWebhookConfigurationWebhookNamespaceSelector build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link MutatingWebhookConfigurationWebhookNamespaceSelector}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements MutatingWebhookConfigurationWebhookNamespaceSelector {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.MutatingWebhookConfigurationWebhookNamespaceSelector"));
        ...
        public final boolean equals(final Object o) {
            ...
            MutatingWebhookConfigurationWebhookNamespaceSelector.Jsii$Proxy that = (MutatingWebhookConfigurationWebhookNamespaceSelector.Jsii$Proxy) o;
