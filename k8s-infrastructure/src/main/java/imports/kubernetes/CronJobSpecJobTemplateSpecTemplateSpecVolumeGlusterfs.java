...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:38.993Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.CronJobSpecJobTemplateSpecTemplateSpecVolumeGlusterfs")
@software.amazon.jsii.Jsii.Proxy(CronJobSpecJobTemplateSpecTemplateSpecVolumeGlusterfs.Jsii$Proxy.class)
public interface CronJobSpecJobTemplateSpecTemplateSpecVolumeGlusterfs extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link CronJobSpecJobTemplateSpecTemplateSpecVolumeGlusterfs}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link CronJobSpecJobTemplateSpecTemplateSpecVolumeGlusterfs}
     */
    public static final class Builder implements software.amazon.jsii.Builder<CronJobSpecJobTemplateSpecTemplateSpecVolumeGlusterfs> {
        java.lang.String endpointsName;
        java.lang.String path;
        java.lang.Object readOnly;

        /**
         * Sets the value of {@link CronJobSpecJobTemplateSpecTemplateSpecVolumeGlusterfs#getEndpointsName}
        ...
        /**
         * Sets the value of {@link CronJobSpecJobTemplateSpecTemplateSpecVolumeGlusterfs#getPath}
        ...
        /**
         * Sets the value of {@link CronJobSpecJobTemplateSpecTemplateSpecVolumeGlusterfs#getReadOnly}
         ...
         * @return a new instance of {@link CronJobSpecJobTemplateSpecTemplateSpecVolumeGlusterfs}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public CronJobSpecJobTemplateSpecTemplateSpecVolumeGlusterfs build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link CronJobSpecJobTemplateSpecTemplateSpecVolumeGlusterfs}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CronJobSpecJobTemplateSpecTemplateSpecVolumeGlusterfs {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.CronJobSpecJobTemplateSpecTemplateSpecVolumeGlusterfs"));
        ...
        public final boolean equals(final Object o) {
            ...
            CronJobSpecJobTemplateSpecTemplateSpecVolumeGlusterfs.Jsii$Proxy that = (CronJobSpecJobTemplateSpecTemplateSpecVolumeGlusterfs.Jsii$Proxy) o;
