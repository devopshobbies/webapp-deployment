...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.ReplicationControllerSpecTemplateSpecVolumeProjectedSourcesConfigMapList")
public class ReplicationControllerSpecTemplateSpecVolumeProjectedSourcesConfigMapList extends com.hashicorp.cdktf.ComplexList {

    protected ReplicationControllerSpecTemplateSpecVolumeProjectedSourcesConfigMapList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected ReplicationControllerSpecTemplateSpecVolumeProjectedSourcesConfigMapList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.kubernetes.ReplicationControllerSpecTemplateSpecVolumeProjectedSourcesConfigMapOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateSpecVolumeProjectedSourcesConfigMapOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateSpecVolumeProjectedSourcesConfigMap> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
