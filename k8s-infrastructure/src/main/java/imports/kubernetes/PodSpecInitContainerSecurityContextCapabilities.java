...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PodSpecInitContainerSecurityContextCapabilities")
@software.amazon.jsii.Jsii.Proxy(PodSpecInitContainerSecurityContextCapabilities.Jsii$Proxy.class)
public interface PodSpecInitContainerSecurityContextCapabilities extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link PodSpecInitContainerSecurityContextCapabilities}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link PodSpecInitContainerSecurityContextCapabilities}
     */
    public static final class Builder implements software.amazon.jsii.Builder<PodSpecInitContainerSecurityContextCapabilities> {
        java.util.List<java.lang.String> add;
        java.util.List<java.lang.String> drop;

        /**
         * Sets the value of {@link PodSpecInitContainerSecurityContextCapabilities#getAdd}
        ...
        /**
         * Sets the value of {@link PodSpecInitContainerSecurityContextCapabilities#getDrop}
         ...
         * @return a new instance of {@link PodSpecInitContainerSecurityContextCapabilities}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public PodSpecInitContainerSecurityContextCapabilities build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link PodSpecInitContainerSecurityContextCapabilities}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodSpecInitContainerSecurityContextCapabilities {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.PodSpecInitContainerSecurityContextCapabilities"));
        ...
        public final boolean equals(final Object o) {
            ...
            PodSpecInitContainerSecurityContextCapabilities.Jsii$Proxy that = (PodSpecInitContainerSecurityContextCapabilities.Jsii$Proxy) o;
