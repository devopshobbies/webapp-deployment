...
public interface DaemonsetSpecStrategy extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.DaemonsetSpecStrategyRollingUpdate getRollingUpdate() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<DaemonsetSpecStrategy> {
        imports.kubernetes.DaemonsetSpecStrategyRollingUpdate rollingUpdate;
         ...
         * @return {@code this}
         */
        public Builder rollingUpdate(imports.kubernetes.DaemonsetSpecStrategyRollingUpdate rollingUpdate) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DaemonsetSpecStrategy {
        private final imports.kubernetes.DaemonsetSpecStrategyRollingUpdate rollingUpdate;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.rollingUpdate = software.amazon.jsii.Kernel.get(this, "rollingUpdate", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DaemonsetSpecStrategyRollingUpdate.class));
        ...
        @Override
        public final imports.kubernetes.DaemonsetSpecStrategyRollingUpdate getRollingUpdate() {
