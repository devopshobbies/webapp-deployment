...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:39.349Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbe")
@software.amazon.jsii.Jsii.Proxy(DaemonsetSpecTemplateSpecInitContainerReadinessProbe.Jsii$Proxy.class)
public interface DaemonsetSpecTemplateSpecInitContainerReadinessProbe extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeExec getExec() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeHttpGet getHttpGet() {
        return null;
    }
    ...
    /**
     * @return a {@link Builder} of {@link DaemonsetSpecTemplateSpecInitContainerReadinessProbe}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DaemonsetSpecTemplateSpecInitContainerReadinessProbe}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DaemonsetSpecTemplateSpecInitContainerReadinessProbe> {
        imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeExec exec;
        java.lang.Number failureThreshold;
        imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeHttpGet httpGet;
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerReadinessProbe#getExec}
         * @param exec exec block.
         *             Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/daemonset#exec Daemonset#exec}
         * @return {@code this}
         */
        public Builder exec(imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeExec exec) {
            this.exec = exec;
            return this;
        }

        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerReadinessProbe#getFailureThreshold}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerReadinessProbe#getHttpGet}
         * @param httpGet http_get block.
         *                Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/daemonset#http_get Daemonset#http_get}
         * @return {@code this}
         */
        public Builder httpGet(imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeHttpGet httpGet) {
            this.httpGet = httpGet;
            return this;
        }

        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerReadinessProbe#getInitialDelaySeconds}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerReadinessProbe#getPeriodSeconds}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerReadinessProbe#getSuccessThreshold}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerReadinessProbe#getTcpSocket}
         ...
         * @return {@code this}
         */
        public Builder tcpSocket(java.util.List<? extends imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeTcpSocket> tcpSocket) {
            this.tcpSocket = tcpSocket;
            return this;
        }

        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecInitContainerReadinessProbe#getTimeoutSeconds}
         ...
         * @return a new instance of {@link DaemonsetSpecTemplateSpecInitContainerReadinessProbe}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DaemonsetSpecTemplateSpecInitContainerReadinessProbe build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DaemonsetSpecTemplateSpecInitContainerReadinessProbe}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DaemonsetSpecTemplateSpecInitContainerReadinessProbe {
        private final imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeExec exec;
        private final java.lang.Number failureThreshold;
        private final imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeHttpGet httpGet;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.exec = software.amazon.jsii.Kernel.get(this, "exec", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeExec.class));
            ...
            this.httpGet = software.amazon.jsii.Kernel.get(this, "httpGet", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeHttpGet.class));
        ...
        @Override
        public final imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeExec getExec() {
            return this.exec;
        }
        ...
        @Override
        public final imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeHttpGet getHttpGet() {
            return this.httpGet;
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbe"));
        ...
        public final boolean equals(final Object o) {
            ...
            DaemonsetSpecTemplateSpecInitContainerReadinessProbe.Jsii$Proxy that = (DaemonsetSpecTemplateSpecInitContainerReadinessProbe.Jsii$Proxy) o;
