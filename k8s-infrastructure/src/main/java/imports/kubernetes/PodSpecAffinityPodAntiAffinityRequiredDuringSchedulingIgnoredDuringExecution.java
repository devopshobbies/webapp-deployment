...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PodSpecAffinityPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecution")
@software.amazon.jsii.Jsii.Proxy(PodSpecAffinityPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecution.Jsii$Proxy.class)
public interface PodSpecAffinityPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecution extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link PodSpecAffinityPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecution}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link PodSpecAffinityPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecution}
     */
    public static final class Builder implements software.amazon.jsii.Builder<PodSpecAffinityPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecution> {
        java.lang.String topologyKey;
        java.lang.Object labelSelector;
        java.util.List<java.lang.String> namespaces;

        /**
         * Sets the value of {@link PodSpecAffinityPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecution#getTopologyKey}
        ...
        /**
         * Sets the value of {@link PodSpecAffinityPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecution#getLabelSelector}
         ...
         * @return {@code this}
         */
        public Builder labelSelector(java.util.List<? extends imports.kubernetes.PodSpecAffinityPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecutionLabelSelector> labelSelector) {
            this.labelSelector = labelSelector;
            return this;
        }

        /**
         * Sets the value of {@link PodSpecAffinityPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecution#getNamespaces}
         ...
         * @return a new instance of {@link PodSpecAffinityPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecution}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public PodSpecAffinityPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecution build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link PodSpecAffinityPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecution}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodSpecAffinityPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecution {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.PodSpecAffinityPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecution"));
        ...
        public final boolean equals(final Object o) {
            ...
            PodSpecAffinityPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecution.Jsii$Proxy that = (PodSpecAffinityPodAntiAffinityRequiredDuringSchedulingIgnoredDuringExecution.Jsii$Proxy) o;
