...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:39.439Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DataKubernetesPersistentVolumeClaimSpecSelector")
@software.amazon.jsii.Jsii.Proxy(DataKubernetesPersistentVolumeClaimSpecSelector.Jsii$Proxy.class)
public interface DataKubernetesPersistentVolumeClaimSpecSelector extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DataKubernetesPersistentVolumeClaimSpecSelector}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DataKubernetesPersistentVolumeClaimSpecSelector}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DataKubernetesPersistentVolumeClaimSpecSelector> {
        java.lang.Object matchExpressions;
        java.util.Map<java.lang.String, java.lang.String> matchLabels;

        /**
         * Sets the value of {@link DataKubernetesPersistentVolumeClaimSpecSelector#getMatchExpressions}
         ...
         * @return {@code this}
         */
        public Builder matchExpressions(java.util.List<? extends imports.kubernetes.DataKubernetesPersistentVolumeClaimSpecSelectorMatchExpressions> matchExpressions) {
            this.matchExpressions = matchExpressions;
            return this;
        }

        /**
         * Sets the value of {@link DataKubernetesPersistentVolumeClaimSpecSelector#getMatchLabels}
         ...
         * @return a new instance of {@link DataKubernetesPersistentVolumeClaimSpecSelector}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DataKubernetesPersistentVolumeClaimSpecSelector build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DataKubernetesPersistentVolumeClaimSpecSelector}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DataKubernetesPersistentVolumeClaimSpecSelector {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DataKubernetesPersistentVolumeClaimSpecSelector"));
        ...
        public final boolean equals(final Object o) {
            ...
            DataKubernetesPersistentVolumeClaimSpecSelector.Jsii$Proxy that = (DataKubernetesPersistentVolumeClaimSpecSelector.Jsii$Proxy) o;
