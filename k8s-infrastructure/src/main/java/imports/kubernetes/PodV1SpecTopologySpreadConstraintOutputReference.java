...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PodV1SpecTopologySpreadConstraintOutputReference")
public class PodV1SpecTopologySpreadConstraintOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected PodV1SpecTopologySpreadConstraintOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected PodV1SpecTopologySpreadConstraintOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public @org.jetbrains.annotations.NotNull imports.kubernetes.PodV1SpecTopologySpreadConstraintLabelSelectorList getLabelSelector() {
        return software.amazon.jsii.Kernel.get(this, "labelSelector", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodV1SpecTopologySpreadConstraintLabelSelectorList.class));
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.PodV1SpecTopologySpreadConstraint value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
