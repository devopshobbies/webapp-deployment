...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.JobSpecTemplateSpecAffinityPodAffinity")
@software.amazon.jsii.Jsii.Proxy(JobSpecTemplateSpecAffinityPodAffinity.Jsii$Proxy.class)
public interface JobSpecTemplateSpecAffinityPodAffinity extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link JobSpecTemplateSpecAffinityPodAffinity}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link JobSpecTemplateSpecAffinityPodAffinity}
     */
    public static final class Builder implements software.amazon.jsii.Builder<JobSpecTemplateSpecAffinityPodAffinity> {
        ...
        /**
         * Sets the value of {@link JobSpecTemplateSpecAffinityPodAffinity#getPreferredDuringSchedulingIgnoredDuringExecution}
         ...
         * @return {@code this}
         */
        public Builder preferredDuringSchedulingIgnoredDuringExecution(java.util.List<? extends imports.kubernetes.JobSpecTemplateSpecAffinityPodAffinityPreferredDuringSchedulingIgnoredDuringExecution> preferredDuringSchedulingIgnoredDuringExecution) {
            this.preferredDuringSchedulingIgnoredDuringExecution = preferredDuringSchedulingIgnoredDuringExecution;
            return this;
        }

        /**
         * Sets the value of {@link JobSpecTemplateSpecAffinityPodAffinity#getRequiredDuringSchedulingIgnoredDuringExecution}
         ...
         * @return {@code this}
         */
        public Builder requiredDuringSchedulingIgnoredDuringExecution(java.util.List<? extends imports.kubernetes.JobSpecTemplateSpecAffinityPodAffinityRequiredDuringSchedulingIgnoredDuringExecution> requiredDuringSchedulingIgnoredDuringExecution) {
            this.requiredDuringSchedulingIgnoredDuringExecution = requiredDuringSchedulingIgnoredDuringExecution;
            return this;
        }
         ...
         * @return a new instance of {@link JobSpecTemplateSpecAffinityPodAffinity}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public JobSpecTemplateSpecAffinityPodAffinity build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link JobSpecTemplateSpecAffinityPodAffinity}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements JobSpecTemplateSpecAffinityPodAffinity {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.JobSpecTemplateSpecAffinityPodAffinity"));
        ...
        public final boolean equals(final Object o) {
            ...
            JobSpecTemplateSpecAffinityPodAffinity.Jsii$Proxy that = (JobSpecTemplateSpecAffinityPodAffinity.Jsii$Proxy) o;
