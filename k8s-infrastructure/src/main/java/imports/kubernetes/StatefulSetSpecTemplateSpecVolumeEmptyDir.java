...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.StatefulSetSpecTemplateSpecVolumeEmptyDir")
@software.amazon.jsii.Jsii.Proxy(StatefulSetSpecTemplateSpecVolumeEmptyDir.Jsii$Proxy.class)
public interface StatefulSetSpecTemplateSpecVolumeEmptyDir extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link StatefulSetSpecTemplateSpecVolumeEmptyDir}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link StatefulSetSpecTemplateSpecVolumeEmptyDir}
     */
    public static final class Builder implements software.amazon.jsii.Builder<StatefulSetSpecTemplateSpecVolumeEmptyDir> {
        java.lang.String medium;
        java.lang.String sizeLimit;

        /**
         * Sets the value of {@link StatefulSetSpecTemplateSpecVolumeEmptyDir#getMedium}
        ...
        /**
         * Sets the value of {@link StatefulSetSpecTemplateSpecVolumeEmptyDir#getSizeLimit}
         ...
         * @return a new instance of {@link StatefulSetSpecTemplateSpecVolumeEmptyDir}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public StatefulSetSpecTemplateSpecVolumeEmptyDir build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link StatefulSetSpecTemplateSpecVolumeEmptyDir}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements StatefulSetSpecTemplateSpecVolumeEmptyDir {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.StatefulSetSpecTemplateSpecVolumeEmptyDir"));
        ...
        public final boolean equals(final Object o) {
            ...
            StatefulSetSpecTemplateSpecVolumeEmptyDir.Jsii$Proxy that = (StatefulSetSpecTemplateSpecVolumeEmptyDir.Jsii$Proxy) o;
