...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.ResourceQuotaV1SpecScopeSelectorMatchExpressionList")
public class ResourceQuotaV1SpecScopeSelectorMatchExpressionList extends com.hashicorp.cdktf.ComplexList {

    protected ResourceQuotaV1SpecScopeSelectorMatchExpressionList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected ResourceQuotaV1SpecScopeSelectorMatchExpressionList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public ResourceQuotaV1SpecScopeSelectorMatchExpressionList(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.IInterpolatingParent terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.Boolean wrapsSet) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.kubernetes.ResourceQuotaV1SpecScopeSelectorMatchExpressionOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ResourceQuotaV1SpecScopeSelectorMatchExpressionOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.ResourceQuotaV1SpecScopeSelectorMatchExpression> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
