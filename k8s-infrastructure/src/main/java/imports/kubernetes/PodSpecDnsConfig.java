...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PodSpecDnsConfig")
@software.amazon.jsii.Jsii.Proxy(PodSpecDnsConfig.Jsii$Proxy.class)
public interface PodSpecDnsConfig extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link PodSpecDnsConfig}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link PodSpecDnsConfig}
     */
    public static final class Builder implements software.amazon.jsii.Builder<PodSpecDnsConfig> {
        java.util.List<java.lang.String> nameservers;
        java.lang.Object option;
        java.util.List<java.lang.String> searches;

        /**
         * Sets the value of {@link PodSpecDnsConfig#getNameservers}
        ...
        /**
         * Sets the value of {@link PodSpecDnsConfig#getOption}
         ...
         * @return {@code this}
         */
        public Builder option(java.util.List<? extends imports.kubernetes.PodSpecDnsConfigOption> option) {
            this.option = option;
            return this;
        }

        /**
         * Sets the value of {@link PodSpecDnsConfig#getSearches}
         ...
         * @return a new instance of {@link PodSpecDnsConfig}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public PodSpecDnsConfig build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link PodSpecDnsConfig}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodSpecDnsConfig {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.PodSpecDnsConfig"));
        ...
        public final boolean equals(final Object o) {
            ...
            PodSpecDnsConfig.Jsii$Proxy that = (PodSpecDnsConfig.Jsii$Proxy) o;
