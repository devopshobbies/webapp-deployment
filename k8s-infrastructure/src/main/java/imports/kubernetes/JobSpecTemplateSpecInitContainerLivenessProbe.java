...
public interface JobSpecTemplateSpecInitContainerLivenessProbe extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.JobSpecTemplateSpecInitContainerLivenessProbeExec getExec() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.JobSpecTemplateSpecInitContainerLivenessProbeHttpGet getHttpGet() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<JobSpecTemplateSpecInitContainerLivenessProbe> {
        imports.kubernetes.JobSpecTemplateSpecInitContainerLivenessProbeExec exec;
        java.lang.Number failureThreshold;
        imports.kubernetes.JobSpecTemplateSpecInitContainerLivenessProbeHttpGet httpGet;
         ...
         * @return {@code this}
         */
        public Builder exec(imports.kubernetes.JobSpecTemplateSpecInitContainerLivenessProbeExec exec) {
            this.exec = exec;
            return this;
        }
         ...
         * @return {@code this}
         */
        public Builder httpGet(imports.kubernetes.JobSpecTemplateSpecInitContainerLivenessProbeHttpGet httpGet) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements JobSpecTemplateSpecInitContainerLivenessProbe {
        private final imports.kubernetes.JobSpecTemplateSpecInitContainerLivenessProbeExec exec;
        private final java.lang.Number failureThreshold;
        private final imports.kubernetes.JobSpecTemplateSpecInitContainerLivenessProbeHttpGet httpGet;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.exec = software.amazon.jsii.Kernel.get(this, "exec", software.amazon.jsii.NativeType.forClass(imports.kubernetes.JobSpecTemplateSpecInitContainerLivenessProbeExec.class));
            ...
            this.httpGet = software.amazon.jsii.Kernel.get(this, "httpGet", software.amazon.jsii.NativeType.forClass(imports.kubernetes.JobSpecTemplateSpecInitContainerLivenessProbeHttpGet.class));
        ...
        @Override
        public final imports.kubernetes.JobSpecTemplateSpecInitContainerLivenessProbeExec getExec() {
            return this.exec;
        }
        ...
        @Override
        public final imports.kubernetes.JobSpecTemplateSpecInitContainerLivenessProbeHttpGet getHttpGet() {
            return this.httpGet;
        }
