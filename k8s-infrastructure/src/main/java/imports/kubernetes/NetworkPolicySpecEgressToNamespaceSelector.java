...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.NetworkPolicySpecEgressToNamespaceSelector")
@software.amazon.jsii.Jsii.Proxy(NetworkPolicySpecEgressToNamespaceSelector.Jsii$Proxy.class)
public interface NetworkPolicySpecEgressToNamespaceSelector extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link NetworkPolicySpecEgressToNamespaceSelector}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link NetworkPolicySpecEgressToNamespaceSelector}
     */
    public static final class Builder implements software.amazon.jsii.Builder<NetworkPolicySpecEgressToNamespaceSelector> {
        java.lang.Object matchExpressions;
        java.util.Map<java.lang.String, java.lang.String> matchLabels;

        /**
         * Sets the value of {@link NetworkPolicySpecEgressToNamespaceSelector#getMatchExpressions}
         ...
         * @return {@code this}
         */
        public Builder matchExpressions(java.util.List<? extends imports.kubernetes.NetworkPolicySpecEgressToNamespaceSelectorMatchExpressions> matchExpressions) {
            this.matchExpressions = matchExpressions;
            return this;
        }

        /**
         * Sets the value of {@link NetworkPolicySpecEgressToNamespaceSelector#getMatchLabels}
         ...
         * @return a new instance of {@link NetworkPolicySpecEgressToNamespaceSelector}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public NetworkPolicySpecEgressToNamespaceSelector build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link NetworkPolicySpecEgressToNamespaceSelector}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements NetworkPolicySpecEgressToNamespaceSelector {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.NetworkPolicySpecEgressToNamespaceSelector"));
        ...
        public final boolean equals(final Object o) {
            ...
            NetworkPolicySpecEgressToNamespaceSelector.Jsii$Proxy that = (NetworkPolicySpecEgressToNamespaceSelector.Jsii$Proxy) o;
