 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:38.790Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.ConfigMapV1")
public class ConfigMapV1 extends com.hashicorp.cdktf.TerraformResource {

    protected ConfigMapV1(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected ConfigMapV1(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        TF_RESOURCE_TYPE = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.kubernetes.ConfigMapV1.class, "tfResourceType", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
    }
     ...
     */
    public ConfigMapV1(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.kubernetes.ConfigMapV1Config config) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(id, "id is required"), java.util.Objects.requireNonNull(config, "config is required") });
    }

    public void putMetadata(final @org.jetbrains.annotations.NotNull imports.kubernetes.ConfigMapV1Metadata value) {
    ...
    public @org.jetbrains.annotations.NotNull imports.kubernetes.ConfigMapV1MetadataOutputReference getMetadata() {
        return software.amazon.jsii.Kernel.get(this, "metadata", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ConfigMapV1MetadataOutputReference.class));
    }
    ...
    public @org.jetbrains.annotations.Nullable imports.kubernetes.ConfigMapV1Metadata getMetadataInput() {
        return software.amazon.jsii.Kernel.get(this, "metadataInput", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ConfigMapV1Metadata.class));
    }
    ...
    /**
     * A fluent builder for {@link imports.kubernetes.ConfigMapV1}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.kubernetes.ConfigMapV1> {
        /**
        ...
        private final imports.kubernetes.ConfigMapV1Config.Builder config;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.config = new imports.kubernetes.ConfigMapV1Config.Builder();
        }
         ...
         */
        public Builder metadata(final imports.kubernetes.ConfigMapV1Metadata metadata) {
         ...
         * <p>
         * @return {@code this}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/r/config_map_v1#id ConfigMapV1#id}. This parameter is required.
         */
        ...
        /**
         * @returns a newly built instance of {@link imports.kubernetes.ConfigMapV1}.
         */
        @Override
        public imports.kubernetes.ConfigMapV1 build() {
            return new imports.kubernetes.ConfigMapV1(
                this.scope,
                this.id,
                this.config.build()
            );
