...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.JobSpecTemplateSpecHostAliasesOutputReference")
public class JobSpecTemplateSpecHostAliasesOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected JobSpecTemplateSpecHostAliasesOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected JobSpecTemplateSpecHostAliasesOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.JobSpecTemplateSpecHostAliases value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
