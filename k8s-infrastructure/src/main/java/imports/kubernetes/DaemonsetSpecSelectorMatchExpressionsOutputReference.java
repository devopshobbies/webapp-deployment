...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DaemonsetSpecSelectorMatchExpressionsOutputReference")
public class DaemonsetSpecSelectorMatchExpressionsOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected DaemonsetSpecSelectorMatchExpressionsOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DaemonsetSpecSelectorMatchExpressionsOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.DaemonsetSpecSelectorMatchExpressions value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
