...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DeploymentV1SpecTemplateSpecDnsConfig")
@software.amazon.jsii.Jsii.Proxy(DeploymentV1SpecTemplateSpecDnsConfig.Jsii$Proxy.class)
public interface DeploymentV1SpecTemplateSpecDnsConfig extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DeploymentV1SpecTemplateSpecDnsConfig}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DeploymentV1SpecTemplateSpecDnsConfig}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DeploymentV1SpecTemplateSpecDnsConfig> {
        java.util.List<java.lang.String> nameservers;
        java.lang.Object option;
        java.util.List<java.lang.String> searches;

        /**
         * Sets the value of {@link DeploymentV1SpecTemplateSpecDnsConfig#getNameservers}
        ...
        /**
         * Sets the value of {@link DeploymentV1SpecTemplateSpecDnsConfig#getOption}
         ...
         * @return {@code this}
         */
        public Builder option(java.util.List<? extends imports.kubernetes.DeploymentV1SpecTemplateSpecDnsConfigOption> option) {
            this.option = option;
            return this;
        }

        /**
         * Sets the value of {@link DeploymentV1SpecTemplateSpecDnsConfig#getSearches}
         ...
         * @return a new instance of {@link DeploymentV1SpecTemplateSpecDnsConfig}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DeploymentV1SpecTemplateSpecDnsConfig build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DeploymentV1SpecTemplateSpecDnsConfig}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DeploymentV1SpecTemplateSpecDnsConfig {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DeploymentV1SpecTemplateSpecDnsConfig"));
        ...
        public final boolean equals(final Object o) {
            ...
            DeploymentV1SpecTemplateSpecDnsConfig.Jsii$Proxy that = (DeploymentV1SpecTemplateSpecDnsConfig.Jsii$Proxy) o;
