...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.NetworkPolicySpecPodSelector")
@software.amazon.jsii.Jsii.Proxy(NetworkPolicySpecPodSelector.Jsii$Proxy.class)
public interface NetworkPolicySpecPodSelector extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link NetworkPolicySpecPodSelector}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link NetworkPolicySpecPodSelector}
     */
    public static final class Builder implements software.amazon.jsii.Builder<NetworkPolicySpecPodSelector> {
        java.lang.Object matchExpressions;
        java.util.Map<java.lang.String, java.lang.String> matchLabels;

        /**
         * Sets the value of {@link NetworkPolicySpecPodSelector#getMatchExpressions}
         ...
         * @return {@code this}
         */
        public Builder matchExpressions(java.util.List<? extends imports.kubernetes.NetworkPolicySpecPodSelectorMatchExpressions> matchExpressions) {
            this.matchExpressions = matchExpressions;
            return this;
        }

        /**
         * Sets the value of {@link NetworkPolicySpecPodSelector#getMatchLabels}
         ...
         * @return a new instance of {@link NetworkPolicySpecPodSelector}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public NetworkPolicySpecPodSelector build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link NetworkPolicySpecPodSelector}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements NetworkPolicySpecPodSelector {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.NetworkPolicySpecPodSelector"));
        ...
        public final boolean equals(final Object o) {
            ...
            NetworkPolicySpecPodSelector.Jsii$Proxy that = (NetworkPolicySpecPodSelector.Jsii$Proxy) o;
