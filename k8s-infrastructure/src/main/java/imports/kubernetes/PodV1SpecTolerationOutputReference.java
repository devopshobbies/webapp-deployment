...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PodV1SpecTolerationOutputReference")
public class PodV1SpecTolerationOutputReference extends com.hashicorp.cdktf.ComplexObject {

    protected PodV1SpecTolerationOutputReference(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected PodV1SpecTolerationOutputReference(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable imports.kubernetes.PodV1SpecToleration value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
