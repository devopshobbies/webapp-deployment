...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DeploymentSpecTemplateSpecVolumeCinder")
@software.amazon.jsii.Jsii.Proxy(DeploymentSpecTemplateSpecVolumeCinder.Jsii$Proxy.class)
public interface DeploymentSpecTemplateSpecVolumeCinder extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DeploymentSpecTemplateSpecVolumeCinder}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DeploymentSpecTemplateSpecVolumeCinder}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DeploymentSpecTemplateSpecVolumeCinder> {
        java.lang.String volumeId;
        java.lang.String fsType;
        java.lang.Object readOnly;

        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecVolumeCinder#getVolumeId}
        ...
        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecVolumeCinder#getFsType}
        ...
        /**
         * Sets the value of {@link DeploymentSpecTemplateSpecVolumeCinder#getReadOnly}
         ...
         * @return a new instance of {@link DeploymentSpecTemplateSpecVolumeCinder}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DeploymentSpecTemplateSpecVolumeCinder build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DeploymentSpecTemplateSpecVolumeCinder}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DeploymentSpecTemplateSpecVolumeCinder {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DeploymentSpecTemplateSpecVolumeCinder"));
        ...
        public final boolean equals(final Object o) {
            ...
            DeploymentSpecTemplateSpecVolumeCinder.Jsii$Proxy that = (DeploymentSpecTemplateSpecVolumeCinder.Jsii$Proxy) o;
