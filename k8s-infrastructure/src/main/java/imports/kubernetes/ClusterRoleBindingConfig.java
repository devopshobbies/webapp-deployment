...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:38.759Z")
...
public interface ClusterRoleBindingConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
     ...
     */
    @org.jetbrains.annotations.NotNull imports.kubernetes.ClusterRoleBindingMetadata getMetadata();
     ...
     */
    @org.jetbrains.annotations.NotNull imports.kubernetes.ClusterRoleBindingRoleRef getRoleRef();
    ...
    public static final class Builder implements software.amazon.jsii.Builder<ClusterRoleBindingConfig> {
        imports.kubernetes.ClusterRoleBindingMetadata metadata;
        imports.kubernetes.ClusterRoleBindingRoleRef roleRef;
         ...
         * @return {@code this}
         */
        public Builder metadata(imports.kubernetes.ClusterRoleBindingMetadata metadata) {
         ...
         * @return {@code this}
         */
        public Builder roleRef(imports.kubernetes.ClusterRoleBindingRoleRef roleRef) {
        ...
        /**
         * Sets the value of {@link ClusterRoleBindingConfig#getId}
         * @param id Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/r/cluster_role_binding#id ClusterRoleBinding#id}.
         *           Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2.
         *           If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
         * @return {@code this}
         */
        ...
        /**
         * Sets the value of {@link ClusterRoleBindingConfig#getConnection}
        ...
        /**
         * Sets the value of {@link ClusterRoleBindingConfig#getForEach}
        ...
        /**
         * Sets the value of {@link ClusterRoleBindingConfig#getProvisioners}
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ClusterRoleBindingConfig {
        private final imports.kubernetes.ClusterRoleBindingMetadata metadata;
        private final imports.kubernetes.ClusterRoleBindingRoleRef roleRef;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.metadata = software.amazon.jsii.Kernel.get(this, "metadata", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ClusterRoleBindingMetadata.class));
            this.roleRef = software.amazon.jsii.Kernel.get(this, "roleRef", software.amazon.jsii.NativeType.forClass(imports.kubernetes.ClusterRoleBindingRoleRef.class));
        ...
        @Override
        public final imports.kubernetes.ClusterRoleBindingMetadata getMetadata() {
            return this.metadata;
        }

        @Override
        public final imports.kubernetes.ClusterRoleBindingRoleRef getRoleRef() {
            return this.roleRef;
        }
