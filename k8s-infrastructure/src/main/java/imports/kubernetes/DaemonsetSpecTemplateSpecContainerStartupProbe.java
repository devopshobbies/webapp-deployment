...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:39.332Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DaemonsetSpecTemplateSpecContainerStartupProbe")
@software.amazon.jsii.Jsii.Proxy(DaemonsetSpecTemplateSpecContainerStartupProbe.Jsii$Proxy.class)
public interface DaemonsetSpecTemplateSpecContainerStartupProbe extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.DaemonsetSpecTemplateSpecContainerStartupProbeExec getExec() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.kubernetes.DaemonsetSpecTemplateSpecContainerStartupProbeHttpGet getHttpGet() {
        return null;
    }
    ...
    /**
     * @return a {@link Builder} of {@link DaemonsetSpecTemplateSpecContainerStartupProbe}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DaemonsetSpecTemplateSpecContainerStartupProbe}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DaemonsetSpecTemplateSpecContainerStartupProbe> {
        imports.kubernetes.DaemonsetSpecTemplateSpecContainerStartupProbeExec exec;
        java.lang.Number failureThreshold;
        imports.kubernetes.DaemonsetSpecTemplateSpecContainerStartupProbeHttpGet httpGet;
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecContainerStartupProbe#getExec}
         * @param exec exec block.
         *             Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/daemonset#exec Daemonset#exec}
         * @return {@code this}
         */
        public Builder exec(imports.kubernetes.DaemonsetSpecTemplateSpecContainerStartupProbeExec exec) {
            this.exec = exec;
            return this;
        }

        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecContainerStartupProbe#getFailureThreshold}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecContainerStartupProbe#getHttpGet}
         * @param httpGet http_get block.
         *                Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/daemonset#http_get Daemonset#http_get}
         * @return {@code this}
         */
        public Builder httpGet(imports.kubernetes.DaemonsetSpecTemplateSpecContainerStartupProbeHttpGet httpGet) {
            this.httpGet = httpGet;
            return this;
        }

        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecContainerStartupProbe#getInitialDelaySeconds}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecContainerStartupProbe#getPeriodSeconds}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecContainerStartupProbe#getSuccessThreshold}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecContainerStartupProbe#getTcpSocket}
         ...
         * @return {@code this}
         */
        public Builder tcpSocket(java.util.List<? extends imports.kubernetes.DaemonsetSpecTemplateSpecContainerStartupProbeTcpSocket> tcpSocket) {
            this.tcpSocket = tcpSocket;
            return this;
        }

        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecContainerStartupProbe#getTimeoutSeconds}
         ...
         * @return a new instance of {@link DaemonsetSpecTemplateSpecContainerStartupProbe}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DaemonsetSpecTemplateSpecContainerStartupProbe build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DaemonsetSpecTemplateSpecContainerStartupProbe}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DaemonsetSpecTemplateSpecContainerStartupProbe {
        private final imports.kubernetes.DaemonsetSpecTemplateSpecContainerStartupProbeExec exec;
        private final java.lang.Number failureThreshold;
        private final imports.kubernetes.DaemonsetSpecTemplateSpecContainerStartupProbeHttpGet httpGet;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.exec = software.amazon.jsii.Kernel.get(this, "exec", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DaemonsetSpecTemplateSpecContainerStartupProbeExec.class));
            ...
            this.httpGet = software.amazon.jsii.Kernel.get(this, "httpGet", software.amazon.jsii.NativeType.forClass(imports.kubernetes.DaemonsetSpecTemplateSpecContainerStartupProbeHttpGet.class));
        ...
        @Override
        public final imports.kubernetes.DaemonsetSpecTemplateSpecContainerStartupProbeExec getExec() {
            return this.exec;
        }
        ...
        @Override
        public final imports.kubernetes.DaemonsetSpecTemplateSpecContainerStartupProbeHttpGet getHttpGet() {
            return this.httpGet;
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DaemonsetSpecTemplateSpecContainerStartupProbe"));
        ...
        public final boolean equals(final Object o) {
            ...
            DaemonsetSpecTemplateSpecContainerStartupProbe.Jsii$Proxy that = (DaemonsetSpecTemplateSpecContainerStartupProbe.Jsii$Proxy) o;
