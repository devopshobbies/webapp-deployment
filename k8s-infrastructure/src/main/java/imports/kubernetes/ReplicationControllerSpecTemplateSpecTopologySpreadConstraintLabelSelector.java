...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.ReplicationControllerSpecTemplateSpecTopologySpreadConstraintLabelSelector")
@software.amazon.jsii.Jsii.Proxy(ReplicationControllerSpecTemplateSpecTopologySpreadConstraintLabelSelector.Jsii$Proxy.class)
public interface ReplicationControllerSpecTemplateSpecTopologySpreadConstraintLabelSelector extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link ReplicationControllerSpecTemplateSpecTopologySpreadConstraintLabelSelector}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ReplicationControllerSpecTemplateSpecTopologySpreadConstraintLabelSelector}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ReplicationControllerSpecTemplateSpecTopologySpreadConstraintLabelSelector> {
        java.lang.Object matchExpressions;
        java.util.Map<java.lang.String, java.lang.String> matchLabels;

        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateSpecTopologySpreadConstraintLabelSelector#getMatchExpressions}
         ...
         * @return {@code this}
         */
        public Builder matchExpressions(java.util.List<? extends imports.kubernetes.ReplicationControllerSpecTemplateSpecTopologySpreadConstraintLabelSelectorMatchExpressions> matchExpressions) {
            this.matchExpressions = matchExpressions;
            return this;
        }

        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateSpecTopologySpreadConstraintLabelSelector#getMatchLabels}
         ...
         * @return a new instance of {@link ReplicationControllerSpecTemplateSpecTopologySpreadConstraintLabelSelector}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ReplicationControllerSpecTemplateSpecTopologySpreadConstraintLabelSelector build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link ReplicationControllerSpecTemplateSpecTopologySpreadConstraintLabelSelector}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ReplicationControllerSpecTemplateSpecTopologySpreadConstraintLabelSelector {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.ReplicationControllerSpecTemplateSpecTopologySpreadConstraintLabelSelector"));
        ...
        public final boolean equals(final Object o) {
            ...
            ReplicationControllerSpecTemplateSpecTopologySpreadConstraintLabelSelector.Jsii$Proxy that = (ReplicationControllerSpecTemplateSpecTopologySpreadConstraintLabelSelector.Jsii$Proxy) o;
