...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.ValidatingWebhookConfigurationWebhookObjectSelector")
@software.amazon.jsii.Jsii.Proxy(ValidatingWebhookConfigurationWebhookObjectSelector.Jsii$Proxy.class)
public interface ValidatingWebhookConfigurationWebhookObjectSelector extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link ValidatingWebhookConfigurationWebhookObjectSelector}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ValidatingWebhookConfigurationWebhookObjectSelector}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ValidatingWebhookConfigurationWebhookObjectSelector> {
        java.lang.Object matchExpressions;
        java.util.Map<java.lang.String, java.lang.String> matchLabels;

        /**
         * Sets the value of {@link ValidatingWebhookConfigurationWebhookObjectSelector#getMatchExpressions}
         ...
         * @return {@code this}
         */
        public Builder matchExpressions(java.util.List<? extends imports.kubernetes.ValidatingWebhookConfigurationWebhookObjectSelectorMatchExpressions> matchExpressions) {
            this.matchExpressions = matchExpressions;
            return this;
        }

        /**
         * Sets the value of {@link ValidatingWebhookConfigurationWebhookObjectSelector#getMatchLabels}
         ...
         * @return a new instance of {@link ValidatingWebhookConfigurationWebhookObjectSelector}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ValidatingWebhookConfigurationWebhookObjectSelector build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link ValidatingWebhookConfigurationWebhookObjectSelector}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ValidatingWebhookConfigurationWebhookObjectSelector {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.ValidatingWebhookConfigurationWebhookObjectSelector"));
        ...
        public final boolean equals(final Object o) {
            ...
            ValidatingWebhookConfigurationWebhookObjectSelector.Jsii$Proxy that = (ValidatingWebhookConfigurationWebhookObjectSelector.Jsii$Proxy) o;
