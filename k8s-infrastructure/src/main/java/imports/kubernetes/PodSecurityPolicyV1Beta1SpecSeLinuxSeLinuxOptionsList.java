...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.PodSecurityPolicyV1Beta1SpecSeLinuxSeLinuxOptionsList")
public class PodSecurityPolicyV1Beta1SpecSeLinuxSeLinuxOptionsList extends com.hashicorp.cdktf.ComplexList {

    protected PodSecurityPolicyV1Beta1SpecSeLinuxSeLinuxOptionsList(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected PodSecurityPolicyV1Beta1SpecSeLinuxSeLinuxOptionsList(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
     ...
     */
    public @org.jetbrains.annotations.NotNull imports.kubernetes.PodSecurityPolicyV1Beta1SpecSeLinuxSeLinuxOptionsOutputReference get(final @org.jetbrains.annotations.NotNull java.lang.Number index) {
        return software.amazon.jsii.Kernel.call(this, "get", software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSecurityPolicyV1Beta1SpecSeLinuxSeLinuxOptionsOutputReference.class), new Object[] { java.util.Objects.requireNonNull(index, "index is required") });
    }
    ...
    public void setInternalValue(final @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.PodSecurityPolicyV1Beta1SpecSeLinuxSeLinuxOptions> value) {
        software.amazon.jsii.Kernel.set(this, "internalValue", value);
    }
}
