...
@javax.annotation.Generated(value = "jsii-pacmak/1.63.2 (build a8a8833)", date = "2022-11-04T11:35:39.384Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DaemonsetSpecTemplateSpecVolumeCinder")
@software.amazon.jsii.Jsii.Proxy(DaemonsetSpecTemplateSpecVolumeCinder.Jsii$Proxy.class)
public interface DaemonsetSpecTemplateSpecVolumeCinder extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link DaemonsetSpecTemplateSpecVolumeCinder}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link DaemonsetSpecTemplateSpecVolumeCinder}
     */
    public static final class Builder implements software.amazon.jsii.Builder<DaemonsetSpecTemplateSpecVolumeCinder> {
        java.lang.String volumeId;
        java.lang.String fsType;
        java.lang.Object readOnly;

        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecVolumeCinder#getVolumeId}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecVolumeCinder#getFsType}
        ...
        /**
         * Sets the value of {@link DaemonsetSpecTemplateSpecVolumeCinder#getReadOnly}
         ...
         * @return a new instance of {@link DaemonsetSpecTemplateSpecVolumeCinder}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public DaemonsetSpecTemplateSpecVolumeCinder build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link DaemonsetSpecTemplateSpecVolumeCinder}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DaemonsetSpecTemplateSpecVolumeCinder {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.DaemonsetSpecTemplateSpecVolumeCinder"));
        ...
        public final boolean equals(final Object o) {
            ...
            DaemonsetSpecTemplateSpecVolumeCinder.Jsii$Proxy that = (DaemonsetSpecTemplateSpecVolumeCinder.Jsii$Proxy) o;
